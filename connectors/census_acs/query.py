...
sees the Census API's native URL grammar — the two-call detail+subject
join was absorbed at ingest time (:mod:`connectors.census_acs.connector`).
Here the data is already in canonical SQLite tables, so a query is plain
...
def query(
    ...
    *,
    ...
    """Run a uniform query against a registered Census ACS dataset."""
