...
sees openFDA's native paging — that was absorbed at ingest time
(:mod:`connectors.openfda.connector`). Here the data is already in
...
def query(
    ...
    *,
    ...
    """Run a uniform query against a registered openFDA dataset."""
