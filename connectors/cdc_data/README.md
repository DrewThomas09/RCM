...
domain. It connects the **entire catalog** (~1,500 datasets), promotes ten
flagship datasets to first-class canonical tables, and keeps every other
4x4 reachable through a generic on-demand rows table — all behind the same
`/v1` contract as the rest of the RCM connector estate.
