"""Defensive accessors for CMS Coverage records.

CMS Coverage list items are mostly flat dicts, but fields are sometimes
absent across document types (a national NCD has no ``contractor_id``; a
technology assessment may omit ``chapter``). Two rules everywhere
downstream:
