...
sees the NIH RePORTER API's native POST-body paging — that was absorbed
at ingest time (:mod:`connectors.nih_reporter.connector`). Here the data
...
def query(
    ...
    *,
    ...
    """Run a uniform query against a registered NIH RePORTER dataset."""
