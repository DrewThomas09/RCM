...
(:mod:`connectors.qpp.connector`). Here the data is already in the
canonical ``qpp tables`` table, so a query is plain parameterised SQL
...
def query(
    ...
    *,
    ...
    """Run a uniform query against a registered QPP dataset."""
