...
(:mod:`connectors.rxnorm.connector`). Here the data is already in the
canonical RxNorm tables, so a query is plain parameterised SQL
...
def query(
    ...
    *,
    ...
    """Run a uniform query against a registered RxNorm dataset."""
