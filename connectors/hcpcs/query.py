...
(:mod:`connectors.hcpcs.connector`). Here the data is already in the
canonical ``dim_hcpcs_code`` table, so a query is plain parameterised SQL
...
def query(
    ...
    *,
    ...
    """Run a uniform query against a registered HCPCS dataset."""
