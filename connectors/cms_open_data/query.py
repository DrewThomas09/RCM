...
sees the CMS Open Data API's native paging — that was absorbed at ingest
time (:mod:`connectors.cms_open_data.connector`). Here the data is already
...
def query(
    ...
    *,
    ...
    """Run a uniform query against a registered CMS Open Data dataset."""
