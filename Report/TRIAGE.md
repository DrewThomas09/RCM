...
- [ ] HIGH | Report-0259 | `canonical_facade.py` cannot land alone — hard-binds to `infra/exports.canonical_deal_export_path`; partial cherry-pick breaks every report route at module load. Treat as must-land-together pair. | rcm_mc/exports/ + rcm_mc/infra/exports.py (feat/ui-rework-v3) | MR1064
