...
| [HEALTHCARE_VERTICALS_REFERENCE.md](HEALTHCARE_VERTICALS_REFERENCE.md) | Granular operational/clinical/epidemiological reference for every US healthcare vertical — code fingerprints (CPT/HCPCS/ICD-10/CDT/DRG/APC/taxonomy), payment systems, facility/workforce counts, access, benchmarks, and Tier 1–3 data sources |
