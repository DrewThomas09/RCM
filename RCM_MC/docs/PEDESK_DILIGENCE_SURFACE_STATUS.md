...
Data-honesty status for every PEdesk surface. Source of truth: `rcm_mc/diligence/surface_status.py` (the `/tools` index renders the matching circle). Generated by `scripts/gen_surface_status_doc.py` — do not hand-edit; reclassify in the source and re-run. Last generated 2026-05-26 over 345 surfaces.

| Tier | Circle | Meaning | Count |
|---|---|---|---|
| GREEN | 🟢 | Real CMS/public or your own deal/system data | 155 |
