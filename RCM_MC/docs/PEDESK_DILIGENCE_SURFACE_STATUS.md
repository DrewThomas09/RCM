...
Data-honesty status for every PEdesk surface. Source of truth: `rcm_mc/diligence/surface_status.py` (the `/tools` index renders the matching circle). Generated by `scripts/gen_surface_status_doc.py` — do not hand-edit; reclassify in the source and re-run. Last generated 2026-05-25 over 334 surfaces.

| Tier | Circle | Meaning | Count |
|---|---|---|---|
| GREEN | 🟢 | Real CMS/public or your own deal/system data | 144 |
| NAVY | 🔵 | Diligence calculator — computes off your inputs | 64 |
| YELLOW | 🟡 | Realistic figures on the illustrative seed corpus | 56 |
| RED | 🔴 | Entirely synthetic / hardcoded values | 70 |


## RED 🔴 — entirely synthetic (highest priority to fix)  (70)
