...
_RED = frozenset({
    "/mgmt-comp", "/partner-economics", "/provider-retention",
    "/physician-productivity", "/physician-labor", "/phys-comp-plan",
    ...
    "/locum-tracker", "/clinical-ai", "/clinical-outcomes", "/quality-scorecard",
    ...
    "/payer-contracts", "/payer-shift", "/ma-contracts", "/ma-star",
    "/nsa-tracker", "/medicaid-unwinding", "/risk-adjustment", "/risk-matrix",
    "/regulatory-risk", "/revenue-leakage", "/supply-chain", "/gpo-supply",
