...
def correctional_health_deep_dive() -> Dict[str, Any]:
    return _deals_only_dive(
        industry="correctional_health",
        sector_tokens=("correctional_health", "correctional"),
        note=("BJS facility data isn't vendored — geography omitted "
              "rather than fabricated."),
    )


def locum_staffing_deep_dive() -> Dict[str, Any]:
    return _deals_only_dive(
        industry="locum_staffing",
        sector_tokens=("staffing", "locum", "locum_tenens"),
        note=("Staffing is delivered nationally — geography is not "
              "the structure read."),
    )


def crisis_services_deep_dive() -> Dict[str, Any]:
    return _deals_only_dive(
        industry="crisis_services",
        sector_tokens=("crisis_services", "crisis", "behavioral_health"),
        note=("SAMHSA crisis-program rosters aren't vendored — "
              "geography omitted rather than fabricated."),
    )
...
def dental_labs_deep_dive() -> Dict[str, Any]:
    return _deals_only_dive(
        industry="dental_labs",
        sector_tokens=("dental_labs", "dental_lab", "dental"),
        note=("NADL membership rosters aren't public — geography "
              "omitted rather than fabricated. The dental trade "
              "history below is the adjacency read."),
    )


def htm_deep_dive() -> Dict[str, Any]:
    return _deals_only_dive(
        industry="htm_clinical_engineering",
        sector_tokens=("htm", "clinical_engineering",
                       "medical_equipment"),
        note=("Service contracts are private — geography omitted "
              "rather than fabricated."),
    )


def interpretation_deep_dive() -> Dict[str, Any]:
    return _deals_only_dive(
        industry="interpretation",
        sector_tokens=("interpretation", "language_services"),
        note=("Delivered remotely — geography is not the structure "
              "read."),
    )
...
def retail_clinics_deep_dive() -> Dict[str, Any]:
    return _deals_only_dive(
        industry="retail_clinics",
        sector_tokens=("retail_clinics", "retail_health",
                       "convenience_care"),
        note=("The estates are pharmacy-owned — geography omitted "
              "rather than fabricated. The trade history here is a "
              "failure autopsy: read it as one."),
    )


def surgical_assist_deep_dive() -> Dict[str, Any]:
    return _deals_only_dive(
        industry="surgical_assist",
        sector_tokens=("surgical_assist", "first_assist"),
        note=("A micro-niche with no public roster — geography "
              "omitted rather than fabricated."),
    )


def hit_consulting_deep_dive() -> Dict[str, Any]:
    return _deals_only_dive(
        industry="hit_consulting",
        sector_tokens=("hit_consulting", "health_it", "consulting"),
        note=("Delivered nationally — the health-IT trade history "
              "below is the structure read."),
    )
