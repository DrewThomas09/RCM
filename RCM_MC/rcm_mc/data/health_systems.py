...
ACUTE_REGISTRY: Tuple[SystemDef, ...] = (
    ...
    SystemDef(
        ...
        patterns=(
            "^HCA", "^MEDICAL CITY", "^SAINT DAVIDS",
            # TriStar and Parkridge are HCA's Tennessee division brands,
            # not national ones. Unscoped, ^TRISTAR took a California
            # home-health agency and ^PARKRIDGE an Iowa nursing home
            # that belongs to Care Initiatives.
            "TN,KY,GA:^TRISTAR", "TN,GA:^PARKRIDGE",
            "^RESEARCH MEDICAL CENTER", "^MENORAH MEDICAL",
...
MARKET_REGISTRY: Tuple[SystemDef, ...] = (
    ...
    SystemDef(
        "care_initiatives", "Care Initiatives",
        KIND_NONPROFIT, FOCUS_SNF, "IA",
        patterns=("^CARE INITIATIVES", "IA:SPECIALTY CARE"),
        states=("IA",),
    ),
    SystemDef(
        "vetter_brookestone", "Brookestone (Vetter Senior Living)",
        KIND_NONPROFIT, FOCUS_SNF, "NE",
        patterns=("^BROOKESTONE",),
        states=("NE",),
    ),
    SystemDef(
        "monarch_mn", "Monarch Healthcare Management",
        KIND_FOR_PROFIT, FOCUS_SNF, "MN",
        patterns=("^ESTATES AT",),
        states=("MN",),
    ),
    SystemDef(
        "villas_mn", "The Villas (Minnesota)",
        KIND_FOR_PROFIT, FOCUS_SNF, "MN",
        patterns=("^VILLAS AT",),
        states=("MN",),
    ),
    SystemDef(
        "benedictine_hs", "Benedictine Health System",
        KIND_CATHOLIC, FOCUS_SNF, "MN",
        patterns=("^BENEDICTINE",),
        states=("MN", "ND"),
    ),
    SystemDef(
        "adept_nursing_rehab", "Adept Nursing & Rehab",
        KIND_FOR_PROFIT, FOCUS_SNF, "NE",
        patterns=("^ADEPT NURSING",),
        states=("NE",),
    ),
    SystemDef(
        "emerald_nursing_rehab_ne", "Emerald Nursing & Rehab (Nebraska)",
        KIND_FOR_PROFIT, FOCUS_SNF, "NE",
        patterns=("^EMERALD NURSING",),
        states=("NE",),
    ),
    SystemDef(
        "genesis_healthcare", "Genesis HealthCare",
        KIND_FOR_PROFIT, FOCUS_SNF, "PA",
        patterns=("CENTER GENESIS HEALTHCARE",),
    ),
    SystemDef(
        "brown_university_health", "Brown University Health (formerly Lifespan)",
        KIND_ACADEMIC, FOCUS_ACUTE, "RI",
        patterns=("^BROWN UNIVERSITY HEALTH", "RI:^RHODE ISLAND HOSPITAL", "RI:^MIRIAM HOSPITAL", "RI:^NEWPORT HOSPITAL", "RI:BRADLEY HOSPITAL", "RI:DIALYSIS CENTER OF RHODE ISLAND"),
        states=("RI", "MA"),
    ),
    SystemDef(
        "hillcrest_health_ne", "Hillcrest Health Services",
        KIND_FOR_PROFIT, FOCUS_SNF, "NE",
        patterns=("^HILLCREST HEALTH", "^HILLCREST SHADOW LAKE", "^HILLCREST MILLARD", "^HILLCREST FIRETHORN", "^HILLCREST COUNTRY ESTATES", "^HILLCREST HOME CARE", "^HILLCREST HOSPICE"),
        states=("NE",),
    ),
    SystemDef(
        "tabitha", "Tabitha Health Care Services",
        KIND_NONPROFIT, FOCUS_SNF, "NE",
        patterns=("^TABITHA", "^HOSPICE OF TABITHA"),
        states=("NE",),
    ),
    SystemDef(
        "catholic_charities_nh", "Catholic Charities New Hampshire",
        KIND_CATHOLIC, FOCUS_SNF, "NH",
        patterns=("^MOUNT CARMEL REHABILITATION", "^SAINT ANN REHABILITATION", "^SAINT FRANCIS REHABILITATION AND NURSING", "^SAINT TERESA REHABILITATION", "^SAINT VINCENT REHABILITATION", "^SAINT JOSEPH RESIDENCE", "^WARDE HEALTH"),
        states=("NH",),
    ),
    SystemDef(
        "benefis", "Benefis Health System",
        KIND_NONPROFIT, FOCUS_ACUTE, "MT",
        patterns=("^BENEFIS",),
        states=("MT",),
    ),
    SystemDef(
        "ihs", "Indian Health Service",
        KIND_GOVERNMENT, FOCUS_ACUTE, "MD",
        patterns=("NM:^GALLUP INDIAN MEDICAL", "NM:^NORTHERN NAVAJO", "NM:^CROWNPOINT", "NM:^SANTA FE INDIAN HOSPITAL", "NM:^SANTA FE PHS INDIAN", "NM:^MESCALERO INDIAN", "NM:^ACOMA CANONCITO", "NM:^ZUNI COMPREHENSIVE"),
        states=("NM",),
    ),
    SystemDef(
        "care_new_england", "Care New England Health System",
        KIND_NONPROFIT, FOCUS_ACUTE, "RI",
        patterns=("RI:^KENT COUNTY MEMORIAL", "RI:^WOMEN AND INFANTS", "RI:^BUTLER HOSPITAL", "RI:CARE NEW ENGLAND"),
        states=("RI",),
    ),
    SystemDef(
        "cura_mn", "Cura (Minnesota)",
        KIND_NONPROFIT, FOCUS_SNF, "MN",
        patterns=("^CURA OF",),
        states=("MN",),
    ),
    SystemDef(
        "ecumen", "Ecumen",
        KIND_NONPROFIT, FOCUS_MIXED, "MN",
        patterns=("^ECUMEN",),
        states=("MN",),
    ),
    SystemDef(
        "caringedge", "CaringEdge Health Services",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "MN",
        patterns=("^CARINGEDGE",),
        states=("MN", "ND", "WY"),
    ),
    SystemDef(
        "pathways_healthcare_ne", "Pathways Healthcare (New England)",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "MA",
        patterns=("^PATHWAYS HEALTHCARE",),
        states=("MA", "ME", "NH", "RI"),
    ),
    SystemDef(
        "wesleylife", "WesleyLife",
        KIND_NONPROFIT, FOCUS_SNF, "IA",
        patterns=("WESLEYLIFE", "IA:^WESLEY LIFE", "IA:^WESLEY ON GRAND", "IA:^WESLEY PARK CENTRE"),
        states=("IA",),
    ),
    SystemDef(
        "southeastern_renal_ia", "Southeastern Renal Dialysis",
        KIND_FOR_PROFIT, FOCUS_DIALYSIS, "IA",
        patterns=("^SOUTHEASTERN RENAL",),
        states=("IA",),
    ),
    SystemDef(
        "altru", "Altru Health System",
        KIND_NONPROFIT, FOCUS_ACUTE, "ND",
        patterns=("^ALTRU",),
        states=("ND", "MN"),
    ),
    SystemDef(
        "presbyterian_homes_mn", "Presbyterian Homes & Services",
        KIND_NONPROFIT, FOCUS_SNF, "MN",
        patterns=("^PRESBYTERIAN HOMES",),
        states=("MN",),
    ),
    SystemDef(
        "everystep", "EveryStep",
        KIND_NONPROFIT, FOCUS_HOSPICE, "IA",
        patterns=("^EVERYSTEP",),
        states=("IA",),
    ),
    SystemDef(
        "tri_state_dialysis", "Tri-State Dialysis",
        KIND_FOR_PROFIT, FOCUS_DIALYSIS, "IA",
        patterns=("^TRI STATE DIALYSIS",),
        states=("IA", "WI"),
    ),
    SystemDef(
        "open_arms_home_health_ia", "Open Arms Home Health Care",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "IA",
        patterns=("IA:^OPEN ARMS HOME HEALTH",),
        states=("IA",),
    ),
    SystemDef(
        "chartercare_ri", "CharterCARE Health Partners (Prospect Medical)",
        KIND_FOR_PROFIT, FOCUS_ACUTE, "RI",
        patterns=("RI:^ROGER WILLIAMS", "RI:^OUR LADY OF FATIMA", "RI:CHARTERCARE", "RI:^SOUTHERN NEW ENGLAND REHAB"),
        states=("RI",),
    ),
    SystemDef(
        "mn_veterans_homes", "Minnesota Veterans Homes",
        KIND_GOVERNMENT, FOCUS_SNF, "MN",
        patterns=("MN:^MN VETERANS", "MN:^MINNESOTA VETERANS"),
        states=("MN",),
    ),
    SystemDef(
        "nye_health_services", "Nye Health Services",
        KIND_FOR_PROFIT, FOCUS_SNF, "NE",
        patterns=("^NYE",),
        states=("NE",),
    ),
    SystemDef(
        "york_general", "York General Health Care Services",
        KIND_NONPROFIT, FOCUS_MIXED, "NE",
        patterns=("^YORK GENERAL",),
        states=("NE",),
    ),
    SystemDef(
        "faith_regional", "Faith Regional Health Services",
        KIND_NONPROFIT, FOCUS_ACUTE, "NE",
        patterns=("^FAITH REGIONAL", "^FAITH HEALTH HOSPICE"),
        states=("NE",),
    ),
    SystemDef(
        "dialysis_center_lincoln", "Dialysis Center of Lincoln",
        KIND_NONPROFIT, FOCUS_DIALYSIS, "NE",
        patterns=("^DIALYSIS CENTER OF LINCOLN",),
        states=("NE",),
    ),
    SystemDef(
        "covenant_living", "Covenant Living Communities and Services",
        KIND_NONPROFIT, FOCUS_SNF, "IL",
        patterns=("^COVENANT LIVING",),
    ),
    SystemDef(
        "lilycare", "LilyCare Hospice",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "NJ",
        patterns=("^LILYCARE",),
    ),
    SystemDef(
        "st_peters_health_mt", "St. Peter's Health (Helena)",
        KIND_NONPROFIT, FOCUS_ACUTE, "MT",
        patterns=("^SAINT PETERS", "^HOSPICE OF SAINT PETERS"),
        states=("MT",),
    ),
    SystemDef(
        "nm_doh", "New Mexico Department of Health Facilities",
        KIND_GOVERNMENT, FOCUS_MIXED, "NM",
        patterns=("NM:^FORT BAYARD", "NM:^NM BEHAVIORAL HEALTH INSTITUTE", "NM:^NEW MEXICO BEHAVIORAL HEALTH", "NM:^NEW MEXICO STATE VETERANS", "NM:^NEW MEXICO REHABILITATION CENTER"),
        states=("NM",),
    ),
    SystemDef(
        "ambercare", "Ambercare",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "NM",
        patterns=("AMBERCARE",),
        states=("NM",),
    ),
    SystemDef(
        "asante", "Asante",
        KIND_NONPROFIT, FOCUS_ACUTE, "OR",
        patterns=("^ASANTE", "OR:^ROGUE REGIONAL", "OR:^ROGUE VALLEY MEDICAL CENTER"),
        states=("OR",),
    ),
    SystemDef(
        "salem_health", "Salem Health",
        KIND_NONPROFIT, FOCUS_ACUTE, "OR",
        patterns=("^SALEM HOSPITAL", "^SALEM HEALTH"),
        states=("OR",),
    ),
    SystemDef(
        "heart_n_home_hospice", "Heart 'n Home Hospice & Palliative Care",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "ID",
        patterns=("^HEART N HOME",),
        states=("ID", "OR"),
    ),
    SystemDef(
        "iowa_home_care", "Iowa Home Care",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "IA",
        patterns=("^IOWA HOME CARE",),
        states=("IA",),
    ),
    SystemDef(
        "north_memorial", "North Memorial Health",
        KIND_NONPROFIT, FOCUS_ACUTE, "MN",
        patterns=("^NORTH MEMORIAL",),
        states=("MN",),
    ),
    SystemDef(
        "ridgeview_mn", "Ridgeview Medical Center",
        KIND_NONPROFIT, FOCUS_ACUTE, "MN",
        patterns=("^RIDGEVIEW",),
        states=("MN",),
    ),
    SystemDef(
        "childrens_nebraska", "Children's Nebraska",
        KIND_NONPROFIT, FOCUS_CHILDRENS, "NE",
        patterns=("^CHILDRENS",),
        states=("NE",),
    ),
    SystemDef(
        "ambassador_health_ne", "Ambassador Health (Nebraska)",
        KIND_FOR_PROFIT, FOCUS_SNF, "NE",
        patterns=("^AMBASSADOR",),
        states=("NE",),
    ),
    SystemDef(
        "arbor_care_centers_ne", "Arbor Care Centers",
        KIND_FOR_PROFIT, FOCUS_SNF, "NE",
        patterns=("^ARBOR CARE CENTER",),
        states=("NE",),
    ),
    SystemDef(
        "nh_dhhs", "New Hampshire DHHS (State Facilities)",
        KIND_GOVERNMENT, FOCUS_BEHAVIORAL, "NH",
        patterns=("^NEW HAMPSHIRE HOSPITAL", "^HAMPSTEAD HOSPITAL", "^GLENCLIFF"),
        states=("NH",),
    ),
    SystemDef(
        "mt_veterans_homes", "Montana Veterans Homes",
        KIND_GOVERNMENT, FOCUS_SNF, "MT",
        patterns=("^MONTANA VETERANS HOME", "^EASTERN MONTANA VETERANS", "^SOUTHWEST MONTANA VETERANS"),
        states=("MT",),
    ),
    SystemDef(
        "northern_montana_health", "Northern Montana Health Care",
        KIND_NONPROFIT, FOCUS_ACUTE, "MT",
        patterns=("^NORTHERN MONTANA",),
        states=("MT",),
    ),
    SystemDef(
        "st_johns_united_mt", "St. John's United (Billings)",
        KIND_NONPROFIT, FOCUS_SNF, "MT",
        patterns=("^SAINT JOHNS UNITED", "^SAINT JOHNS LUTHERAN HOME"),
        states=("MT",),
    ),
    SystemDef(
        "iowa_specialty_hospital", "Iowa Specialty Hospitals & Clinics",
        KIND_GOVERNMENT, FOCUS_ACUTE, "IA",
        patterns=("^IOWA SPECIALTY HOSPITAL",),
        states=("IA",),
    ),
    SystemDef(
        "hopehealth", "HopeHealth",
        KIND_NONPROFIT, FOCUS_HOSPICE, "RI",
        patterns=("^HOPEHEALTH",),
        states=("RI", "MA"),
    ),
    SystemDef(
        "south_county_health_ri", "South County Health",
        KIND_NONPROFIT, FOCUS_ACUTE, "RI",
        patterns=("RI:^SOUTH COUNTY HOSPITAL", "RI:^SOUTH COUNTY HOME HEALTH"),
        states=("RI",),
    ),
    SystemDef(
        "saint_elizabeth_community_ri", "Saint Elizabeth Community (Rhode Island)",
        KIND_NONPROFIT, FOCUS_SNF, "RI",
        patterns=("RI:^SAINT ELIZABETH",),
        states=("RI",),
    ),
    SystemDef(
        "solutionhealth", "SolutionHealth",
        KIND_NONPROFIT, FOCUS_ACUTE, "NH",
        patterns=("^ELLIOT", "^SOUTHERN NH MEDICAL", "^SOUTHERN NEW HAMPSHIRE MEDICAL"),
        states=("NH",),
    ),
    SystemDef(
        "northeast_montana_health", "Northeast Montana Health Services",
        KIND_NONPROFIT, FOCUS_ACUTE, "MT",
        patterns=("^NORTHEAST MONTANA HEALTH",),
        states=("MT",),
    ),
    SystemDef(
        "mn_direct_care", "Minnesota Direct Care and Treatment",
        KIND_GOVERNMENT, FOCUS_BEHAVIORAL, "MN",
        patterns=("MN:^COMMUNITY BEHAVIORAL HEALTH HOSPITAL", "MN:^ANOKA METRO", "MN:^CHILD AND ADOLESCENT BEHAVIORAL HEALTH"),
        states=("MN",),
    ),
    SystemDef(
        "bozeman_health", "Bozeman Health",
        KIND_NONPROFIT, FOCUS_ACUTE, "MT",
        patterns=("^BOZEMAN HEALTH", "^BOZEMAN DEACONESS"),
        states=("MT",),
    ),
    SystemDef(
        "a_bridge_home", "A Bridge Home",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "ID",
        patterns=("^A BRIDGE HOME",),
        states=("ID",),
    ),
    SystemDef(
        "andwell", "Andwell Health Partners",
        KIND_NONPROFIT, FOCUS_HOME_HEALTH, "ME",
        patterns=("^ANDWELL",),
        states=("ME",),
    ),
    SystemDef(
        "applegate_homecare", "Applegate Homecare & Hospice",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "UT",
        patterns=("UT:^APPLEGATE",),
        states=("UT",),
    ),
    SystemDef(
        "arcadia_hi", "Arcadia Family of Companies (Hawai'i)",
        KIND_NONPROFIT, FOCUS_SNF, "HI",
        patterns=("^ARCADIA RETIREMENT", "^HALE OLA KINO"),
        states=("HI",),
    ),
    SystemDef(
        "aspen_ridge_ut", "Aspen Ridge (Utah)",
        KIND_FOR_PROFIT, FOCUS_MIXED, "UT",
        patterns=("UT:^ASPEN RIDGE",),
        states=("UT",),
    ),
    SystemDef(
        "atlas_homecare_ut", "Atlas Homecare & Hospice (Utah)",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "UT",
        patterns=("UT:^ATLAS HOME", "UT:^ATLAS HOSPICE"),
        states=("UT",),
    ),
    SystemDef(
        "auburn_crest", "Auburn Crest Home Health & Hospice",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "ID",
        patterns=("^AUBURN CREST",),
        states=("ID", "UT"),
    ),
    SystemDef(
        "bethany_fargo", "Bethany Retirement Living",
        KIND_NONPROFIT, FOCUS_SNF, "ND",
        patterns=("^BETHANY ON",),
        states=("ND",),
    ),
    SystemDef(
        "bluebird_id", "Bluebird Home Health & Hospice (Idaho)",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "ID",
        patterns=("^BLUEBIRD",),
        states=("ID",),
    ),
    SystemDef(
        "bridgepoint_healthcare", "BridgePoint Healthcare",
        KIND_FOR_PROFIT, FOCUS_LTACH, "DC",
        patterns=("DC,LA:^BRIDGEPOINT", "DC:^SPECIALTY HOSPITAL OF WASHINGTON", "DC:^SPEC HOSPITAL WASHINGTON"),
        states=("DC", "LA"),
    ),
    SystemDef(
        "campbell_county_health", "Campbell County Health",
        KIND_GOVERNMENT, FOCUS_ACUTE, "WY",
        patterns=("CAMPBELL COUNTY MEMORIAL", "^CAMPBELL COUNTY HEALTH", "^LEGACY LIVING AND REHABILITATION"),
        states=("WY",),
    ),
    SystemDef(
        "capital_caring", "Capital Caring Health",
        KIND_NONPROFIT, FOCUS_HOSPICE, "VA",
        patterns=("DC,VA:^CAPITAL HOSPICE", "MD:^CAPITAL CARING"),
        states=("DC", "MD", "VA"),
    ),
    SystemDef(
        "cascades_healthcare", "Cascades Healthcare",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=("^CASCADES AT",),
        states=("ID", "TX", "UT"),
    ),
    SystemDef(
        "central_maine_healthcare", "Central Maine Healthcare",
        KIND_NONPROFIT, FOCUS_ACUTE, "ME",
        patterns=("^CENTRAL MAINE MEDICAL", "^CENTRAL MAINE REHABILITATION", "^BRIDGTON HOSPITAL", "^RUMFORD HOSPITAL"),
        states=("ME",),
    ),
    SystemDef(
        "chcs_maine", "Community Health & Counseling Services",
        KIND_NONPROFIT, FOCUS_HOME_HEALTH, "ME",
        patterns=("^COMMUNITY HEALTH AND COUNSELING",),
        states=("ME",),
    ),
    SystemDef(
        "cheyenne_regional", "Cheyenne Regional Medical Center",
        KIND_NONPROFIT, FOCUS_ACUTE, "WY",
        patterns=("^CHEYENNE REGIONAL",),
        states=("WY",),
    ),
    SystemDef(
        "cns_utah", "Community Nursing Services (CNS)",
        KIND_NONPROFIT, FOCUS_HOSPICE, "UT",
        patterns=("UT:^CNS COMMUNITY", "UT:^COMMUNITY NURSING SERVICES"),
        states=("UT",),
    ),
    SystemDef(
        "cody_regional_health", "Cody Regional Health",
        KIND_GOVERNMENT, FOCUS_ACUTE, "WY",
        patterns=("^CODY REGIONAL",),
        states=("WY",),
    ),
    SystemDef(
        "covenant_health_ne", "Covenant Health (New England)",
        KIND_CATHOLIC, FOCUS_ACUTE, "MA",
        patterns=("^SAINT MARYS REGIONAL MEDICAL", "^SAINT MARYS DYOUVILLE", "^SAINT ANDRE HEALTH", "^SAINT JOSEPH HOSPITAL", "^SAINT JOSEPH HOMECARE"),
        states=("ME",),
    ),
    SystemDef(
        "crest_hh_id", "Crest Home Health & Hospice",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "ID",
        patterns=("^CREST HOME HEALTH",),
        states=("ID",),
    ),
    SystemDef(
        "crook_county_medical", "Crook County Medical Services District",
        KIND_GOVERNMENT, FOCUS_ACUTE, "WY",
        patterns=("^CROOK COUNTY MEDICAL",),
        states=("WY",),
    ),
    SystemDef(
        "eventide", "Eventide Senior Living Communities",
        KIND_NONPROFIT, FOCUS_SNF, "MN",
        patterns=("^EVENTIDE", "AN EVENTIDE COMMUNITY"),
        states=("ND", "MN", "IA"),
    ),
    SystemDef(
        "foundation_health_partners", "Foundation Health Partners",
        KIND_NONPROFIT, FOCUS_ACUTE, "AK",
        patterns=("AK:^FAIRBANKS MEMORIAL", "AK:^DENALI CENTER"),
        states=("AK",),
    ),
    SystemDef(
        "hale_makua", "Hale Makua Health Services",
        KIND_NONPROFIT, FOCUS_SNF, "HI",
        patterns=("^HALE MAKUA",),
        states=("HI",),
    ),
    SystemDef(
        "harrisons_hope", "Harrison's Hope Hospice",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "ID",
        patterns=("^HARRISONS HOPE",),
        states=("ID",),
    ),
    SystemDef(
        "hawaii_health_systems", "Hawai'i Health Systems Corporation",
        KIND_GOVERNMENT, FOCUS_ACUTE, "HI",
        patterns=("^HILO MEDICAL CENTER", "^HILO BENIOFF", "^KONA COMMUNITY HOSPITAL", "^KOHALA HOSPITAL", "^KAU HOSPITAL", "^HALE HOOLA HAMAKUA", "^HONOKAA HOSPITAL", "^KAUAI VETERANS MEMORIAL", "^SAMUEL MAHELONA", "^LEAHI HOSPITAL", "^MALUHIA"),
        states=("HI",),
    ),
    SystemDef(
        "homestead_hh_id", "Homestead Home Health & Hospice",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "ID",
        patterns=("^HOMESTEAD HOME HEALTH",),
        states=("ID",),
    ),
    SystemDef(
        "horizon_hh_id", "Horizon Home Health & Hospice (Idaho)",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "ID",
        patterns=("^HORIZON HOME HEALTH", "^HORIZON HOSPICE"),
        states=("ID",),
    ),
    SystemDef(
        "idaho_hh_hospice", "Idaho Home Health & Hospice",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "ID",
        patterns=("^IDAHO HOME HEALTH",),
        states=("ID",),
    ),
    SystemDef(
        "idaho_veterans_homes", "Idaho State Veterans Homes",
        KIND_GOVERNMENT, FOCUS_SNF, "ID",
        patterns=("^IDAHO STATE VETERANS HOME",),
        states=("ID",),
    ),
    SystemDef(
        "ingleside_senior", "Ingleside",
        KIND_NONPROFIT, FOCUS_SNF, "DC",
        patterns=("DC,MD:^INGLESIDE AT",),
        states=("DC", "MD"),
    ),
    SystemDef(
        "johnson_county_healthcare_wy", "Johnson County Healthcare Center (WY)",
        KIND_GOVERNMENT, FOCUS_ACUTE, "WY",
        patterns=("^JOHNSON COUNTY HEALTHCARE", "^AMIE HOLT", "^SUSIE BOWLING LAWRENCE"),
        states=("WY",),
    ),
    SystemDef(
        "kidscare_home_health", "KidsCare Home Health",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=("^KIDSCARE",),
        states=("CO", "DC", "ID", "MD", "OR", "SC", "TX", "VA"),
    ),
    SystemDef(
        "kuakini", "Kuakini Health System",
        KIND_NONPROFIT, FOCUS_ACUTE, "HI",
        patterns=("^KUAKINI",),
        states=("HI",),
    ),
    SystemDef(
        "little_sisters_poor", "Little Sisters of the Poor",
        KIND_CATHOLIC, FOCUS_SNF, "IL",
        patterns=("^LITTLE SISTERS", "^JEANNE JUGAN"),
        states=("AL", "DC", "DE", "IL", "KY", "MD", "MN", "MO", "PA", "RI"),
    ),
    SystemDef(
        "maine_veterans_homes", "Maine Veterans' Homes",
        KIND_NONPROFIT, FOCUS_SNF, "ME",
        patterns=("^MAINE VETERANS HOME",),
        states=("ME",),
    ),
    SystemDef(
        "maniilaq", "Maniilaq Association",
        KIND_GOVERNMENT, FOCUS_ACUTE, "AK",
        patterns=("AK:^MANIILAQ", "AK:^UTUQQANAAT"),
        states=("AK",),
    ),
    SystemDef(
        "maui_health", "Maui Health System",
        KIND_NONPROFIT, FOCUS_ACUTE, "HI",
        patterns=("^MAUI MEMORIAL", "^KULA HOSPITAL", "^LANAI COMMUNITY HOSPITAL"),
        states=("HI",),
    ),
    SystemDef(
        "me_dhhs_psychiatric", "Maine DHHS State Psychiatric Centers",
        KIND_GOVERNMENT, FOCUS_BEHAVIORAL, "ME",
        patterns=("^RIVERVIEW PSYCHIATRIC", "^DOROTHEA DIX"),
        states=("ME",),
    ),
    SystemDef(
        "mission_health_services", "Mission Health Services",
        KIND_NONPROFIT, FOCUS_SNF, "UT",
        patterns=("UT,WY:^MISSION AT",),
        states=("UT", "WY"),
    ),
    SystemDef(
        "monument_healthcare_ut", "Monument Healthcare (Utah)",
        KIND_FOR_PROFIT, FOCUS_SNF, "UT",
        patterns=("UT:^MONUMENT HEALTHCARE",),
        states=("UT",),
    ),
    SystemDef(
        "mountain_view_id", "Mountain View Hospital (Idaho Falls)",
        KIND_FOR_PROFIT, FOCUS_ACUTE, "ID",
        patterns=("^MOUNTAIN VIEW HOSPITAL", "^IDAHO FALLS COMMUNITY"),
        states=("ID",),
    ),
    SystemDef(
        "northern_light", "Northern Light Health",
        KIND_NONPROFIT, FOCUS_ACUTE, "ME",
        patterns=("^NORTHERN LIGHT", "^INLAND HOSPITAL", "^AROOSTOOK MEDICAL CENTER"),
        states=("ME",),
    ),
    SystemDef(
        "norton_sound", "Norton Sound Health Corporation",
        KIND_GOVERNMENT, FOCUS_ACUTE, "AK",
        patterns=("AK:^NORTON SOUND", "AK:^QUYANNA"),
        states=("AK",),
    ),
    SystemDef(
        "onesource_id", "OneSource Home Health & Hospice (Idaho)",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "ID",
        patterns=("^ONESOURCE",),
        states=("ID",),
    ),
    SystemDef(
        "pines_nhca", "National Health Care Associates (The Pines)",
        KIND_FOR_PROFIT, FOCUS_SNF, "CT",
        patterns=("CT,NY,VT:^PINES AT",),
        states=("CT", "NY", "VT"),
    ),
    SystemDef(
        "pinnacle_health_rehab_me", "Pinnacle Health & Rehab (Maine)",
        KIND_FOR_PROFIT, FOCUS_SNF, "ME",
        patterns=("^PINNACLE HEALTH AND REHAB",),
        states=("ME",),
    ),
    SystemDef(
        "powell_valley_healthcare", "Powell Valley Healthcare",
        KIND_GOVERNMENT, FOCUS_ACUTE, "WY",
        patterns=("^POWELL VALLEY",),
        states=("WY",),
    ),
    SystemDef(
        "premier_rehab_vt", "Premier Rehab and Healthcare (Vermont)",
        KIND_FOR_PROFIT, FOCUS_SNF, "VT",
        patterns=("VT:^PREMIER REHAB AND HEALTHCARE",),
        states=("VT",),
    ),
    SystemDef(
        "premium_health_at_home", "Premium Health at Home",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "WY",
        patterns=("^PREMIUM HEALTH AT HOME",),
        states=("WY",),
    ),
    SystemDef(
        "prospera_nd", "Prospera (North Dakota)",
        KIND_NONPROFIT, FOCUS_SNF, "ND",
        patterns=("PROSPERA COMMUNITY",),
        states=("ND",),
    ),
    SystemDef(
        "rocky_mountain_care", "Rocky Mountain Care",
        KIND_NONPROFIT, FOCUS_SNF, "UT",
        patterns=("^ROCKY MOUNTAIN CARE",),
        states=("UT", "WY"),
    ),
    SystemDef(
        "searhc", "SouthEast Alaska Regional Health Consortium (SEARHC)",
        KIND_GOVERNMENT, FOCUS_ACUTE, "AK",
        patterns=("^SEARHC", "^SOUTHEAST ALASKA REGIONAL", "AK:^MT EDGECUMBE", "AK:^WRANGELL MEDICAL"),
        states=("AK",),
    ),
    SystemDef(
        "sheridan_memorial_wy", "Sheridan Memorial Hospital (WY)",
        KIND_GOVERNMENT, FOCUS_ACUTE, "WY",
        patterns=("^SHERIDAN MEMORIAL",),
        states=("WY",),
    ),
    SystemDef(
        "smp_health", "SMP Health",
        KIND_CATHOLIC, FOCUS_MIXED, "ND",
        patterns=("^SMP HEALTH",),
        states=("ND",),
    ),
    SystemDef(
        "south_lincoln_medical", "South Lincoln Medical Center",
        KIND_GOVERNMENT, FOCUS_ACUTE, "WY",
        patterns=("^SOUTH LINCOLN",),
        states=("WY",),
    ),
    SystemDef(
        "st_johns_health_wy", "St. John's Health (Jackson, WY)",
        KIND_GOVERNMENT, FOCUS_ACUTE, "WY",
        patterns=("^SAINT JOHNS", "^TETON COUNTY HOSPITAL DISTRICT"),
        states=("WY",),
    ),
    SystemDef(
        "star_valley_health", "Star Valley Health",
        KIND_GOVERNMENT, FOCUS_ACUTE, "WY",
        patterns=("^STAR VALLEY",),
        states=("WY",),
    ),
    SystemDef(
        "stillwater_hospice_west", "Stillwater Hospice (Northern Rockies)",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "MT",
        patterns=("^STILLWATER HOSPICE",),
        states=("MT", "SD", "WY"),
    ),
    SystemDef(
        "stonehenge_ut", "Stonehenge Health & Rehabilitation (Utah)",
        KIND_FOR_PROFIT, FOCUS_SNF, "UT",
        patterns=("UT:^STONEHENGE",),
        states=("UT",),
    ),
    SystemDef(
        "sunterra_springs", "Sunterra Springs",
        KIND_FOR_PROFIT, FOCUS_SNF, "MO",
        patterns=("^SUNTERRA",),
        states=("ID", "MO"),
    ),
    SystemDef(
        "symbii", "Symbii Home Health & Hospice",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "UT",
        patterns=("^SYMBII",),
        states=("ID", "UT", "WY"),
    ),
    SystemDef(
        "terrace_hh_id", "Terrace Home Health & Hospice (Idaho)",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "ID",
        patterns=("^TERRACE HOME HEALTH", "^TERRACE HOSPICE"),
        states=("ID",),
    ),
    SystemDef(
        "trinity_nd", "Trinity Health (Minot, North Dakota)",
        KIND_NONPROFIT, FOCUS_ACUTE, "ND",
        patterns=("^TRINITY",),
        states=("ND",),
    ),
    SystemDef(
        "ut_veterans_homes", "Utah State Veterans Homes (UDVMA)",
        KIND_GOVERNMENT, FOCUS_SNF, "UT",
        patterns=("UT:^GEORGE E WAHLEN", "UT:^SOUTHERN UTAH VETERANS HOME", "UT:^MERVYN SHARP BENNION", "UT:^WILLIAM E CHRISTOFFERSON"),
        states=("UT",),
    ),
    SystemDef(
        "valeo_home_health", "Valeo Home Health & Hospice",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "UT",
        patterns=("UT:^VALEO",),
        states=("UT",),
    ),
    SystemDef(
        "valley_vista_care", "Valley Vista Care",
        KIND_NONPROFIT, FOCUS_SNF, "ID",
        patterns=("^VALLEY VISTA CARE",),
        states=("ID",),
    ),
    SystemDef(
        "weston_county_health", "Weston County Health Services",
        KIND_GOVERNMENT, FOCUS_ACUTE, "WY",
        patterns=("^WESTON COUNTY HEALTH",),
        states=("WY",),
    ),
    SystemDef(
        "wyoming_state_institutions", "Wyoming Department of Health (State Institutions)",
        KIND_GOVERNMENT, FOCUS_MIXED, "WY",
        patterns=("^WYOMING STATE HOSPITAL", "^WYOMING RETIREMENT CENTER", "^WYOMING VETERANS", "^MOUNTAIN VIEW SKILLED NURSING COMMUNITY"),
        states=("WY",),
    ),
    SystemDef(
        "ykhc", "Yukon-Kuskokwim Health Corporation",
        KIND_GOVERNMENT, FOCUS_ACUTE, "AK",
        patterns=("AK:^YUKON KUSKOKWIM", "AK:^YK DELTA"),
        states=("AK",),
    ),

    SystemDef(
        "ahf_ohio", "Ahf Ohio Inc.",
        KIND_NONPROFIT, FOCUS_SNF, "OH",
        patterns=(),
    ),
    SystemDef(
        "anna_maria_of_aurora", "Anna Maria of Aurora, Inc.",
        KIND_FOR_PROFIT, FOCUS_SNF, "OH",
        patterns=(),
    ),
    SystemDef(
        "ballinger_memorial_hospital_district", "Ballinger Memorial Hospital District",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "baylor_county_hospital_district", "Baylor County Hospital District",
        KIND_GOVERNMENT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "bellevue_healthcare_group", "Bellevue Healthcare Group, Llc",
        KIND_FOR_PROFIT, FOCUS_SNF, "OH",
        patterns=(),
    ),
    SystemDef(
        "bexar_county_hospital_district", "Bexar County Hospital District",
        KIND_GOVERNMENT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "booker_hospital_district", "Booker Hospital District",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "brazos_presbyterian_homes", "Brazos Presbyterian Homes Inc",
        KIND_NONPROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "brentwood_healthcare", "Brentwood Healthcare, Ltd",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "brunswick_health_rehabilitation_center", "Brunswick Health & Rehabilitation Center, Inc.",
        KIND_FOR_PROFIT, FOCUS_SNF, "OH",
        patterns=(),
    ),
    SystemDef(
        "buckner_retirement_services", "Buckner Retirement Services, Inc",
        KIND_NONPROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "castle_nursing_homes", "Castle Nursing Homes, Inc.",
        KIND_FOR_PROFIT, FOCUS_SNF, "OH",
        patterns=(),
    ),
    SystemDef(
        "chambers_county_public_hospital", "Chambers County Public Hospital District no 1",
        KIND_GOVERNMENT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "childress_county_hospital_district", "Childress County Hospital District",
        KIND_GOVERNMENT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "chs_lake_erie", "Chs - Lake Erie, Inc",
        KIND_FOR_PROFIT, FOCUS_SNF, "OH",
        patterns=(),
    ),
    SystemDef(
        "chs_pataskala", "Chs - Pataskala, Inc",
        KIND_FOR_PROFIT, FOCUS_SNF, "OH",
        patterns=(),
    ),
    SystemDef(
        "citizens_medical_center_county", "Citizens Medical Center County of Victoria",
        KIND_NONPROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "colonial_senior_services", "Colonial Senior Services Inc",
        KIND_NONPROFIT, FOCUS_SNF, "OH",
        patterns=(),
    ),
    SystemDef(
        "coryell_county_memorial_hospital", "Coryell County Memorial Hospital Authority",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "dallas_county_hospital_district", "Dallas County Hospital District",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "decatur_hospital_authority", "Decatur Hospital Authority",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "dewitt_medical_district", "Dewitt Medical District",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "eastland_memorial_hospital_district", "Eastland Memorial Hospital District",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "eliza_jennings", "Eliza Jennings Inc",
        KIND_NONPROFIT, FOCUS_SNF, "OH",
        patterns=(),
    ),
    SystemDef(
        "fannin_county_hospital_authority", "Fannin County Hospital Authority",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "frio_hospital_district", "Frio Hospital District",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "guadalupe_county_hospital_board", "Guadalupe County Hospital Board",
        KIND_GOVERNMENT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "h_g_nursing_homes", "H & G Nursing Homes Inc",
        KIND_FOR_PROFIT, FOCUS_SNF, "OH",
        patterns=(),
    ),
    SystemDef(
        "hamilton_county_hospital_district", "Hamilton County Hospital District",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "hampton_woods_nursing_center", "Hampton Woods Nursing Center, Inc.",
        KIND_FOR_PROFIT, FOCUS_SNF, "OH",
        patterns=(),
    ),
    SystemDef(
        "hansford_county_hospital_district", "Hansford County Hospital District",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "hcf_of_fox_run", "Hcf of Fox Run, Inc.",
        KIND_FOR_PROFIT, FOCUS_SNF, "OH",
        patterns=(),
    ),
    SystemDef(
        "hemphill_county_hospital_district", "Hemphill County Hospital District",
        KIND_GOVERNMENT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "hopkins_county_hospital_district", "Hopkins County Hospital District",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "levering_management", "Levering Management, Inc.",
        KIND_FOR_PROFIT, FOCUS_SNF, "OH",
        patterns=(),
    ),
    SystemDef(
        "liberty_county_hospital_district", "Liberty County Hospital District no 1",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "macintosh_company", "The Macintosh Company, Llc",
        KIND_FOR_PROFIT, FOCUS_SNF, "OH",
        patterns=(),
    ),
    SystemDef(
        "maple_knoll_communities", "Maple Knoll Communities Inc",
        KIND_NONPROFIT, FOCUS_SNF, "OH",
        patterns=(),
    ),
    SystemDef(
        "maverick_county_hospital_district", "Maverick County Hospital District",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "medina_county_hospital_district", "Medina County Hospital District",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
    ...
    SystemDef(
        "mennonite_memorial_home", "Mennonite Memorial Home",
        KIND_NONPROFIT, FOCUS_SNF, "OH",
        patterns=(),
    ),
    SystemDef(
        "midland_county_hospital_district", "Midland County Hospital District",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "morning_view_delaware", "Morning View Delaware, Inc.",
        KIND_FOR_PROFIT, FOCUS_SNF, "OH",
        patterns=(),
    ),
    SystemDef(
        "nacogdoches_county_hospital_district", "Nacogdoches County Hospital District",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "nocona_hospital_district", "Nocona Hospital District",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "oakbend_medical_center", "Oakbend Medical Center",
        KIND_NONPROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "ohio_masonic_home", "The Ohio Masonic Home",
        KIND_NONPROFIT, FOCUS_SNF, "OH",
        patterns=(),
    ),
    SystemDef(
        "olney_hamilton_hospital_district", "Olney-Hamilton Hospital District",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "omni_manor", "Omni Manor, Inc.",
        KIND_FOR_PROFIT, FOCUS_SNF, "OH",
        patterns=(),
    ),
    SystemDef(
        "palo_pinto_county_hospital", "Palo Pinto County Hospital District",
        KIND_GOVERNMENT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "parker_county_hospital_district", "Parker County Hospital District",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "r_j_investment", "R & J Investment Co Inc",
        KIND_FOR_PROFIT, FOCUS_SNF, "OH",
        patterns=(),
    ),
    SystemDef(
        "san_antonio_health_service", "San Antonio Health Service Corp",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "silsbee_oaks_health_care", "Silsbee Oaks Health Care L L P",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "smithville_hospital_authority", "Smithville Hospital Authority",
        KIND_NONPROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "south_limestone_hospital_district", "South Limestone Hospital District",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "starr_county_hospital_district", "Starr County Hospital District",
        KIND_NONPROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "state_of_texas_veterans", "State of Texas Veterans Land Board",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "stephens_memorial_hospital_district", "Stephens Memorial Hospital District",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "stratford_hospital_district", "Stratford Hospital District",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "sweeny_hospital_district", "Sweeny Hospital District",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "united_church_homes", "United Church Homes, Inc",
        KIND_NONPROFIT, FOCUS_SNF, "OH",
        patterns=(),
    ),
    SystemDef(
        "uvalde_county_hospital_authority", "Uvalde County Hospital Authority",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "val_verde_county_hospital", "Val Verde County Hospital District",
        KIND_GOVERNMENT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "west_coke_county_hospital", "West Coke County Hospital District",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "west_wharton_county_hospital", "West Wharton County Hospital District",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    SystemDef(
        "willow_brook_christian_services", "Willow Brook Christian Services",
        KIND_NONPROFIT, FOCUS_SNF, "OH",
        patterns=(),
    ),
    SystemDef(
        "winnie_stowell_hospital_district", "Winnie-Stowell Hospital District",
        KIND_FOR_PROFIT, FOCUS_SNF, "TX",
        patterns=(),
    ),
    ...
    SystemDef(
        "a_care_home_health", "A-Care Home Health Services of East Houston, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "absolute_hospice", "Absolute Hospice Inc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "OH",
        patterns=(),
    ),
    SystemDef(
        "agape_group", "Agape Group Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "alamo_area_home_hospice", "Alamo Area Home Hospice, Lp",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "allegiance_hospice", "Allegiance Hospice Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "alta_home_health_care", "Alta Home Health Care Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "OH",
        patterns=(),
    ),
    SystemDef(
        "american_star_home_health", "American Star Home Health Care Inc",
        KIND_NONPROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "anarcare_home_health_and", "Anarcare Home Health and Hospice Agency, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "arm_healthcare", "Arm Healthcare Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "at_twilight_hospice_palliative", "At Twilight Hospice & Palliative Care of Tx Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "atwell_home_health_services", "Atwell Home Health Services, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "ayuda_home_health_care", "Ayuda Home Health Care Services, Llc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "bestcare_home_health", "Bestcare Home Health,inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "brite_hospice", "Brite Hospice, Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "cambridge_home_health_care", "Cambridge Home Health Care, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "OH",
        patterns=(),
    ),
    SystemDef(
        "children_s_hospital_medical", "Children's Hospital Medical Center",
        KIND_NONPROFIT, FOCUS_HOSPICE, "OH",
        patterns=(),
    ),
    SystemDef(
        "county_of_putnam_office", "County of Putnam Office of Auditor",
        KIND_GOVERNMENT, FOCUS_HOSPICE, "OH",
        patterns=(),
    ),
    SystemDef(
        "dependable_home_care", "Dependable Home Care, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "direct_health_care", "Direct Health Care, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "edward_s_home_health", "Edward's Home Health, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "exclusive_home_health_and", "Exclusive Home Health and Hospice Inc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "family_nurse_care_of", "Family Nurse Care of Ohio, Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "OH",
        patterns=(),
    ),
    SystemDef(
        "fisher_titus_medical_center", "Fisher-Titus Medical Center",
        KIND_NONPROFIT, FOCUS_SNF, "OH",
        patterns=(),
    ),
    SystemDef(
        "guardian_angel_home_care", "Guardian Angel Home Care and Hospice of Akron",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "OH",
        patterns=(),
    ),
    SystemDef(
    ...
    SystemDef(
        "ims_home_health_care", "Ims Home Health Care, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "integrated_management_solutions", "Integrated Management Solutions, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "lhcg_cxxxvii", "Lhcg Cxxxvii, Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "lhcg_xxxiii", "Lhcg Xxxiii, Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "pathfinder_healthcare", "Pathfinder Healthcare, Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "paz_home_health", "Paz Home Health Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "precious_home_health_care", "Precious Home Health Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "OH",
        patterns=(),
    ),
    SystemDef(
        "valerian_home_health_and", "Valerian Home Health and Hospice Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "west_texas_home_health", "West Texas Home Health, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),

    SystemDef(
        "advanced_hh", "Advanced Hh, Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "ahc_home_health_of", "Ahc Home Health of Cincinnati Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "OH",
        patterns=(),
    ),
    SystemDef(
        "alamo_home_healthcare", "Alamo Home Healthcare, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "all_generations_health_care", "All Generations Health Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "allheal_home_health", "Allheal Home Health, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "american_choice_healthcare", "American Choice Healthcare Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "apc_home_health_service", "Apc Home Health Service, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "arising_healthcare_services", "Arising Healthcare Services, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "avatar_home_health_care", "Avatar Home Health Care Agency, Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "axiom_home_health", "Axiom Home Health Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "ballinger_home_health", "Ballinger Home Health Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "bayside_solutions", "Bayside Solutions, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "best_care_hospice", "Best Care Hospice, Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "calvert_home_health_care", "Calvert Home Health Care, Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "caridad_healthcare", "Caridad Healthcare Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "carrington_hospice_care", "Carrington Hospice Care Inc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "cedar_lake_nursing_services", "Cedar Lake Nursing Services, Inc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "coleman_home_health_and", "Coleman Home Health and Hospice, Inc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "comfort_home_health_care", "Comfort Home Health Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "OH",
        patterns=(),
    ),
    SystemDef(
        "cypress_hospice", "Cypress Hospice Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "OH",
        patterns=(),
    ),
    SystemDef(
        "dos_hermanas_ortiz", "Dos Hermanas Ortiz, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "fortune_healthcare", "Fortune Healthcare, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "guardian_home_care", "Guardian Home Care Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "halcyon_home", "Halcyon Home Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "healthy_choice_homecare", "Healthy Choice Homecare, Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "heavenly_health_care", "Heavenly Health Care, Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "hill_view_retirement_center", "Hill View Retirement Center",
        KIND_NONPROFIT, FOCUS_SNF, "OH",
        patterns=(),
    ),
    SystemDef(
        "hillrise_home_management", "Hillrise Home Management Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "his_grace_home_health", "His Grace Home Health Care Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "OH",
        patterns=(),
    ),
    SystemDef(
        "homestyle_specialty_nursing_care", "Homestyle Specialty Nursing Care, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "hospice_partners_of_america", "Hospice Partners of America Holding, Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "ipr_healthcare_systems", "Ipr Healthcare Systems Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "kdc_healthcare_partners", "Kdc Healthcare Partners",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "kingfisher_health", "Kingfisher Health Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "knox_county_hospital_district", "Knox County Hospital District",
        KIND_GOVERNMENT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "la_esperanza_home_health", "La Esperanza Home Health, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "lagniappe_health_care_investments", "Lagniappe Health Care Investments, Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "laredo_visiting_nurses", "Laredo Visiting Nurses, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "legacy_at_home", "The Legacy at Home, Inc.",
        KIND_NONPROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "legacy_home_health_agency", "Legacy Home Health Agency, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "livingwell_home_health_agency", "Livingwell Home Health Agency Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "lucent_health_group", "Lucent Health Group Lp",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "marietta_home_health_and", "Marietta Home Health and Hospice, L.l.c.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "OH",
        patterns=(),
    ),
    SystemDef(
        "matrix_home_health_services", "Matrix Home Health Services",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "maxus_healthcare_partners", "Maxus Healthcare Partners Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "memorial_family_for_hospice", "Memorial Family For Hospice and Palliative Care, Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "monument_healthcare", "Monument Healthcare, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "morris_infinite_healthcare_services", "Morris Infinite Healthcare Services Incorporated",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "new_age_hospice_palliative", "New Age Hospice Palliative, Llc",
        KIND_GOVERNMENT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "nightingale_hospice_care", "Nightingale Hospice Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "ochiltree_hospital_district", "Ochiltree Hospital District",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "omnix_health_care_services", "Omnix Health Care Services, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "one_new_era_investments", "One New Era Investments Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "regency_ihs_home_care", "Regency Ihs Home Care Services Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "retreat_health_care_services", "Retreat Health Care Services Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "rgv_calidad_home_health", "Rgv Calidad Home Health Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "river_city_hospice_of", "River City Hospice of Texas, Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "rx_home_healthcare", "Rx Home Healthcare Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "OH",
        patterns=(),
    ),
    SystemDef(
        "san_jose_hospice", "San Jose Hospice Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "sghpc_sa", "Sghpc-Sa, Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "sid_peterson_memorial_hospital", "Sid Peterson Memorial Hospital",
        KIND_NONPROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
    ...
    SystemDef(
        "southwest_general_health_center", "Southwest General Health Center",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "OH",
        patterns=(),
    ),
    SystemDef(
        "summit_homecare_services_c", "Summit Homecare Services, L L C",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "sun_city_envision_healthcare", "Sun City Envision Healthcare Services, Inc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "sunglo_home_health_services", "Sunglo Home Health Services, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "sunset_healthcare_services", "Sunset Healthcare Services Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "OH",
        patterns=(),
    ),
    SystemDef(
        "thank_you_nurses", "Thank You Nurses, Ltd.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "trinity_health_group", "Trinity Health Group Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "ultimate_caring_home_health", "Ultimate Caring Home Health Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "venture_i", "Venture I, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "village_home_health_c", "Village Home Health, L.l.c.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),

    SystemDef(
        "1st_choice_home_healthcare", "1st Choice Home Healthcare Fresno Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "american_carequest", "American Carequest, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "angel_care_hospice", "Angel Care Hospice Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "assisted_home_recovery", "Assisted Home Recovery, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "bellevue_hospice_care", "Bellevue Hospice Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "capital_home_health_care", "Capital Home Health Care",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "colusa_medical_center", "Colusa Medical Center Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "committed_home_health_care", "Committed Home Health Care, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "continuum_care_hospice", "Continuum Care Hospice Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "OH",
        patterns=(),
    ),
    SystemDef(
    ...
    SystemDef(
        "direct_hospice_care", "Direct Hospice Care, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "egb_holdings", "Egb Holdings",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "family_friends_home_health", "Family & Friends Home Health Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "good_samaritan_home_health", "Good Samaritan Home Health Care Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "goodwill_healthcare_services", "Goodwill Healthcare Services Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "infinite_care_home_health", "Infinite Care Home Health, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "integrity_home_health_care", "Integrity Home Health Care Services Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "OH",
        patterns=(),
    ),
    SystemDef(
        "joshua_tree_healthcare", "Joshua Tree Healthcare, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "meridian_care", "Meridian Care Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "pioneer_home_health_care", "Pioneer Home Health Care, Inc.",
        KIND_NONPROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "prohealth_home_care", "Prohealth Home Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "valley_home_health", "Valley Home Health, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "vision_home_health_care", "Vision Home Health Care Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "wellspring_home_health_care", "Wellspring Home Health Care, Inc.",
        KIND_NONPROFIT, FOCUS_HOME_HEALTH, "OH",
        patterns=(),
    ),

    SystemDef(
        "a_1_healthcare_management", "A-1 Healthcare Management",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "ace_home_health_care", "Ace Home Health Care & Hospice Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "act_home_health", "Act Home Health, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "akeso_home_health_care", "Akeso Home Health Care, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "OH",
        patterns=(),
    ),
    SystemDef(
        "americare_hospice", "Americare Hospice, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "arden_home_health", "Arden Home Health Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "assisted_home_care", "Assisted Home Care, Inc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "assistive_health_systems", "Assistive Health Systems, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "barton_healthcare_system", "Barton Healthcare System",
        KIND_NONPROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "blue_ribbon_hospice", "Blue Ribbon Hospice Inc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "care_must_hospice", "Care Must Hospice, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "cng_international", "Cng International Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "connect_care_hospice", "Connect Care Hospice Inc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "cvhcare_corporation", "Cvhcare Corporation",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "haven_health_care", "Haven Health Care",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "hep_enterprises", "Hep Enterprises Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "human_touch_home_health", "Human Touch Home Health Care Agency, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "lighthouse_home_health_care", "Lighthouse Home Health Care, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "majestic_hospice_home_health", "Majestic Hospice & Home Health Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "mohave_healthcare", "Mohave Healthcare, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "nurses_on_wheels", "Nurses On Wheels, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "paramount_home_health_care", "Paramount Home Health Care &hospice, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "rancho_bernardo_healthcare", "Rancho Bernardo Healthcare Llc",
        KIND_NONPROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "redlands_community_hospital", "Redlands Community Hospital",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "rx_staffing_and_home", "Rx Staffing and Home Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "sas_home_health_care", "Sas Home Health Care",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "self_help_for_elderly", "Self-Help For the Elderly",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "sunrise_home_health_care", "Sunrise Home Health Care",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "tahoe_forest_hospital_district", "Tahoe Forest Hospital District",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "transition_care_telemetry", "Transition Care Telemetry, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "vina_holdings", "Vina Holdings, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "vital_home_health_care", "Vital Home Health Care, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
    ...
    SystemDef(
        "24_7_team_care", "24/7 Team Care, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "a_plus_home_health", "A Plus Home Health Services, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "advantage_health_systems", "Advantage Health Systems",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "agb_home_health", "Agb Home Health, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "all_care_home_health", "All Care Home Health Provider",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "alliance_health_services", "Alliance Health Services, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "alliance_home_health_hospice", "Alliance Home Health & Hospice Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "amavi_home_health_and", "Amavi Home Health and Hospice Care Services, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "american_hospice_and_home", "American Hospice and Home Health Care Services, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "aura_home_health", "Aura Home Health Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "TX",
        patterns=(),
    ),
    SystemDef(
        "benjamin_healthcare", "Benjamin Healthcare",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "bliss_home_health_care", "Bliss Home Health Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "blize_healthcare_california", "Blize Healthcare California Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "blossom_ridge_home_health", "Blossom Ridge Home Health Agency Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "butte_home_health", "Butte Home Health Inc.",
        KIND_NONPROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "capitol_healthcare", "Capitol Healthcare Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "care_village_hospice", "Care Village Hospice Inc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "central_coast_home_health", "Central Coast Home Health Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "central_coast_vna_hospice", "Central Coast Vna & Hospice, Inc.",
        KIND_NONPROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "cne_home_health_services", "Cne Home Health Services Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "comfort_choice_hospice_care", "Comfort Choice Hospice Care, Inc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "community_hospice", "Community Hospice, Inc.",
        KIND_NONPROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "covenant_home_services", "Covenant Home Services",
        KIND_NONPROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "daian_corporation", "Daian Corporation",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "danny_s_home_health", "Danny's Home Health Care Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "dedicated_home_health_care", "Dedicated Home Health Care, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "diamond_home_health", "Diamond Home Health Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "elixir_home_health_care", "Elixir Home Health Care & Hospice,inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "enloe_medical_center", "Enloe Medical Center",
        KIND_NONPROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "freedom_home_health_and", "Freedom Home Health and Hospice Care Services Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "generations_hospice_and_palliative", "Generations Hospice and Palliative Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "gimag_healthcare", "Gimag Healthcare",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "hdmc_holdings", "Hdmc Holdings, Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "healing_care_hospice", "Healing Care Hospice Inc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "helping_hands_home_health", "Helping Hands Home Health Care & Hospice, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "hospice_care", "Hospice Care, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "hygieia_health_systems", "Hygieia Health Systems, Inc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "ideal_home_health_care", "Ideal Home Health Care, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "OH",
        patterns=(),
    ),
    SystemDef(
        "infinite_home_health", "Infinite Home Health, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "infinity_care_services", "Infinity Care Services, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "integrity_hospice", "Integrity Hospice Inc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "life_of_hope_home", "Life of Hope Home Health",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "livingston_memorial_visiting_nurse", "Livingston Memorial Visiting Nurse Association",
        KIND_NONPROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "mary_s_help_home", "Mary's Help Home Health Services, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "medicalone_health", "Medicalone Health",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "outreach_home_health_services", "Outreach Home Health Services Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "owen_healthcare", "Owen Healthcare, Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "pacific_point_health_care", "Pacific Point Health Care Services Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "pathways_home_health_and", "Pathways Home Health and Hospice",
        KIND_NONPROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "pih_health_whittier_hospital", "Pih Health Whittier Hospital",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "progressive_home_health_and", "Progressive Home Health and Hospice Care, Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "quality_care_hospice", "Quality Care Hospice, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "rehabfocus_home_health", "Rehabfocus Home Health, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
    ...
    SystemDef(
        "sacramento_river_healthcare", "Sacramento River Healthcare Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "saint_rita_home_health", "Saint Rita Home Health Care, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "salus_home_health_and", "Salus Home Health and Hospice, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "solace_healthcare", "Solace Healthcare, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "solid_care_home_health", "Solid Care Home Health , Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "sonder_healthcare", "Sonder Healthcare Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "st_bernardine_care_providers", "St. Bernardine Care Providers Inc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "staff_assistance", "Staff Assistance, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "sunset_hospice", "Sunset Hospice Inc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "TX",
        patterns=(),
    ),
    SystemDef(
        "torrance_memorial_medical_center", "Torrance Memorial Medical Center",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "trinity_home_health_services", "Trinity Home Health Services",
        KIND_NONPROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "true_care_hospice_southern", "True Care Hospice Southern California, Inc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
    ...
    SystemDef(
        "unique_home_health_services", "Unique Home Health Services Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "united_hospice_services", "United Hospice Services, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "vanguard_home_health_care", "Vanguard Home Health Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "OH",
        patterns=(),
    ),
    SystemDef(
        "vida_hospice_services", "Vida Hospice Services, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "visiting_angels_hospice_care", "Visiting Angels Hospice Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "visiting_nurse_and_hospice", "Visiting Nurse and Hospice Care of Santa Barbara",
        KIND_NONPROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "vna_of_greater_los", "Vna of Greater Los Angeles, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "vna_of_orange_county", "Vna of Orange County Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "wecare_hospice_and_palliative", "Wecare Hospice and Palliative Services Inc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),

    SystemDef(
        "aaa_home_health_services", "Aaa Home Health Services, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "absolute_home_health", "Absolute Home Health Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "absolutely_haven", "Absolutely Haven Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "aca_home_health", "Aca Home Health, Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "access_home_health_care", "Access Home Health Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "access_nursecare", "Access Nursecare Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "accurate_care_home_health", "Accurate Care Home Health Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "activa_health_services", "Activa Health Services, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "advance_care_home_health", "Advance Care Home Health Agency Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "advanced_home_health", "Advanced Home Health Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "affinity_home_healthcare", "Affinity Home Healthcare, Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "all_health_care_services", "All Health Care Services, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "all_services_home_health", "All Services Home Health Agency Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "allegiance_home_health", "Allegiance Home Health Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "alliance_health_care_of", "Alliance Health Care of Miami Beach, Llc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "alternative_medical_healthcare_services", "Alternative Medical Healthcare Services, Corp",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "ambassadore_health_care", "Ambassadore Health Care, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "american_home_health_agency", "American Home Health Agency, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "apex_home_healthcare_services", "Apex Home Healthcare Services, Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "atlantic_home_care", "Atlantic Home Care, Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "baycare_home_care", "Baycare Home Care Inc.",
        KIND_NONPROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "best_care_providers", "Best Care Providers Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "breeze_health_care", "Breeze Health Care, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "brooks_skilled_nursing_facility", "Brooks Skilled Nursing Facility A, Inc.",
        KIND_NONPROFIT, FOCUS_SNF, "FL",
        patterns=(),
    ),
    SystemDef(
        "calm_care", "Calm Care Inc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "catholic_home_health_services", "Catholic Home Health Services of Broward Inc",
        KIND_NONPROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "christian_missionary_alliance_foundation", "The Christian & Missionary Alliance Foundation Inc",
        KIND_NONPROFIT, FOCUS_SNF, "FL",
        patterns=(),
    ),
    SystemDef(
        "compassionate_caring_home_care", "Compassionate Caring Home Care, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "confident_care_of_florida", "Confident Care of Florida Corp",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "continental_home_health_care", "Continental Home Health Care, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "covenant_home_health_care", "Covenant Home Health Care, Llc",
        KIND_NONPROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "crown_home_care", "Crown Home Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "crown_home_health_care", "Crown Home Health Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "empathy_care", "Empathy Care Inc",
        KIND_NONPROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "etairos_care_at_home", "Etairos Care at Home Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "etairos_health", "Etairos Health, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "excellent_care_home_health", "Excellent Care Home Health Services, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "faith_home_health", "Faith Home Health, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "first_care_home_services", "First Care Home Services, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "first_choice_home_health", "First Choice Home Health Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "florida_department_of_veterans", "Florida Department of Veterans Affairs",
        KIND_GOVERNMENT, FOCUS_SNF, "FL",
        patterns=(),
    ),
    SystemDef(
        "florida_homecare_specialists_minority", "Florida Homecare Specialists Minority Corp",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "forever_home_health_care", "Forever Home Health Care, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "gentle_care", "Gentle Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "goldencare_home_health_agency", "Goldencare Home Health Agency, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "gtb_home_healthcare_solutions", "Gtb Home Healthcare Solutions, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "health_care_of_south", "Health Care of South Florida Corp",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "healthmax_home_care_services", "Healthmax Home Care Services Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "hh_stuart", "Hh Stuart Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "higher_standard_home_care", "Higher Standard Home Care Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "home_care_plus", "Home Care Plus Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "home_health_care_of", "Home Health Care of Florida",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "home_health_services_of", "Home Health Services of South Florida, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "homewood_home_health", "Homewood Home Health Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "inspire_home_healthcare", "Inspire Home Healthcare Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "jacksonville_rehabilitation_and_nursing", "Jacksonville Rehabilitation and Nursing Center Llc",
        KIND_FOR_PROFIT, FOCUS_SNF, "FL",
        patterns=(),
    ),
    SystemDef(
        "john_knox_village_of", "John Knox Village of Central Florida, Inc",
        KIND_NONPROFIT, FOCUS_SNF, "FL",
        patterns=(),
    ),
    SystemDef(
        "josy_enterprises_ii", "Josy Enterprises Ii Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "jupiter_rehab_and_health", "Jupiter Rehab and Health Center, Llc",
        KIND_FOR_PROFIT, FOCUS_SNF, "FL",
        patterns=(),
    ),
    SystemDef(
        "k_d_home_health", "K & D Home Health Care Corp",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "lakes_home_care", "The Lakes Home Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "lifespace_communities", "Lifespace Communities Inc",
        KIND_NONPROFIT, FOCUS_SNF, "FL",
        patterns=(),
    ),
    SystemDef(
        "matrix_home_care", "Matrix Home Care Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "medcare_home_health_services", "Medcare Home Health Services Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "northport_health_services_of", "Northport Health Services of Florida, Llc",
        KIND_FOR_PROFIT, FOCUS_SNF, "FL",
        patterns=(),
    ),
    SystemDef(
        "omni_home_health_district", "Omni Home Health - District 2, Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "orlando_rehabilitation_group", "Orlando Rehabilitation Group, Inc.",
        KIND_NONPROFIT, FOCUS_SNF, "FL",
        patterns=(),
    ),
    SystemDef(
        "paramount_home_health_services", "Paramount Home Health Services, Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "OH",
        patterns=(),
    ),
    SystemDef(
        "patients_first_home_care", "Patients First Home Care Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "port_charlotte_opco", "Port Charlotte Opco, Llc",
        KIND_FOR_PROFIT, FOCUS_SNF, "FL",
        patterns=(),
    ),
    SystemDef(
        "primary_medical_staffing", "Primary Medical Staffing, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "procare_home_health", "Procare Home Health Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "OH",
        patterns=(),
    ),
    SystemDef(
        "professional_home_health_services", "Professional Home Health Services Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "professional_solutions_home_health", "Professional Solutions Home Health Agency Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "r_g_therapy_services", "R.g. Therapy Services Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "santiago", "Santiago, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "sarasota_home_health_care", "Sarasota Home Health Care Agency, Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "seaside_home_health", "Seaside Home Health Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "southeast_homecare", "Southeast Homecare Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "sovereign_healthcare_of_palm", "Sovereign Healthcare of Palm City, Llc",
        KIND_FOR_PROFIT, FOCUS_SNF, "FL",
        patterns=(),
    ),
    SystemDef(
        "sunshine_home_health_services", "Sunshine Home Health Services Inc",
        KIND_NONPROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "tallahassee_memorial_healthcare", "Tallahassee Memorial Healthcare Inc",
        KIND_NONPROFIT, FOCUS_SNF, "FL",
        patterns=(),
    ),
    SystemDef(
    ...
    SystemDef(
        "tendra_home_health", "Tendra Home Health Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "therapycare_home_health", "Therapycare Home Health Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "tri_county_homecare_of", "Tri-County Homecare of Florida, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "trulife_home_health", "Trulife Home Health Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "ultimate_home_care", "The Ultimate Home Care, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "villa_maria_nursing_rehabilitation", "Villa Maria Nursing & Rehabilitation Center",
        KIND_NONPROFIT, FOCUS_SNF, "FL",
        patterns=(),
    ),
    SystemDef(
        "visiting_nurse_association_of", "Visiting Nurse Association of Florida Inc",
        KIND_NONPROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "waterman_communities", "Waterman Communities Inc",
        KIND_NONPROFIT, FOCUS_SNF, "FL",
        patterns=(),
    ),
    SystemDef(
        "west_florida_pphomehealth", "West Florida Pphomehealth, Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "world_first_class_home", "World First Class Home Health Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),

    SystemDef(
        "abundant_home_health_care", "Abundant Home Health Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "advanced_home_health_services", "Advanced Home Health Services, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "IL",
        patterns=(),
    ),
    SystemDef(
        "adventist_midwest_health", "Adventist Midwest Health",
        KIND_NONPROFIT, FOCUS_HOSPICE, "IL",
        patterns=(),
    ),
    SystemDef(
        "apex_home_health_care", "Apex Home Health Care, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "bond_county_treasurer", "Bond County Treasurer",
        KIND_GOVERNMENT, FOCUS_HOSPICE, "IL",
        patterns=(),
    ),
    SystemDef(
        "breeze_hospice", "Breeze Hospice Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "IL",
        patterns=(),
    ),
    SystemDef(
        "community_home_health_care", "Community Home Health Care Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "IL",
        patterns=(),
    ),
    SystemDef(
        "covenant_health_care_center", "Covenant Health Care Center, Inc",
        KIND_NONPROFIT, FOCUS_SNF, "IL",
        patterns=(),
    ),
    SystemDef(
        "essential_home_care", "Essential Home Care, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "IL",
        patterns=(),
    ),
    SystemDef(
        "family_home_health_services", "Family Home Health Services, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "IL",
        patterns=(),
    ),
    SystemDef(
        "fayette_county", "Fayette County",
        KIND_GOVERNMENT, FOCUS_HOSPICE, "IL",
        patterns=(),
    ),
    SystemDef(
        "first_health_hospice", "First Health Hospice Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "IL",
        patterns=(),
    ),
    SystemDef(
        "franciscan_communities", "Franciscan Communities, Inc.",
        KIND_NONPROFIT, FOCUS_SNF, "IL",
        patterns=(),
    ),
    SystemDef(
        "gold_coast_home_health", "Gold Coast Home Health, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "IL",
        patterns=(),
    ),
    SystemDef(
    ...
    SystemDef(
        "horizon_home_health_care", "Horizon Home Health Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "ideal_care_home_health", "Ideal Care Home Health, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "iroquois_memorial_hospital_and", "Iroquois Memorial Hospital and Resident Home",
        KIND_NONPROFIT, FOCUS_HOSPICE, "IL",
        patterns=(),
    ),
    SystemDef(
        "journeycare", "Journeycare, Inc",
        KIND_NONPROFIT, FOCUS_HOSPICE, "IL",
        patterns=(),
    ),
    SystemDef(
        "lhcg_xxxvii", "Lhcg Xxxvii, Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "IL",
        patterns=(),
    ),
    SystemDef(
        "lifecare_home_health_services", "Lifecare Home Health Services Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "mcdonough_county_hospital_district", "Mcdonough County Hospital District",
        KIND_GOVERNMENT, FOCUS_HOSPICE, "IL",
        patterns=(),
    ),
    SystemDef(
        "metropolitan_home_health_care", "Metropolitan Home Health Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "nexus_home_health", "Nexus Home Health, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "omnicare_home_health", "Omnicare Home Health Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "optimum_home_health_care", "Optimum Home Health Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "IL",
        patterns=(),
    ),
    SystemDef(
        "palos_community_hospital", "Palos Community Hospital",
        KIND_NONPROFIT, FOCUS_HOSPICE, "IL",
        patterns=(),
    ),
    SystemDef(
        "pana_community_hospital_association", "Pana Community Hospital Association",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "IL",
        patterns=(),
    ),
    SystemDef(
        "progressive_home_health_care", "Progressive Home Health Care Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "reliance_home_health_care", "Reliance Home Health Care, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "rest_haven_illiana_christian", "Rest Haven Illiana Christian Convalescent Home",
        KIND_NONPROFIT, FOCUS_HOSPICE, "IL",
        patterns=(),
    ),
    SystemDef(
        "sarah_bush_lincoln_health", "Sarah Bush Lincoln Health Center",
        KIND_NONPROFIT, FOCUS_HOSPICE, "IL",
        patterns=(),
    ),
    SystemDef(
        "star_home_health_services", "Star Home Health Services Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "sterling_home_health_care", "Sterling Home Health Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "IL",
        patterns=(),
    ),
    SystemDef(
        "unlimited_development", "Unlimited Development Inc.",
        KIND_NONPROFIT, FOCUS_SNF, "IL",
        patterns=(),
    ),
    SystemDef(
        "vna_health_care", "Vna Health Care",
        KIND_NONPROFIT, FOCUS_HOSPICE, "IL",
        patterns=(),
    ),
    SystemDef(
        "waukegan_hospice", "Waukegan Hospice, Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "IL",
        patterns=(),
    ),
    SystemDef(
        "wellcare_home_health", "Wellcare Home Health Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "IL",
        patterns=(),
    ),

    SystemDef(
        "365_hospice", "365 Hospice, Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "PA",
        patterns=(),
    ),
    SystemDef(
        "acts_retirement_life_communities", "Acts Retirement-Life Communities Inc",
        KIND_NONPROFIT, FOCUS_SNF, "PA",
        patterns=(),
    ),
    SystemDef(
        "advanced_nursing_care", "Advanced Nursing Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "IL",
        patterns=(),
    ),
    SystemDef(
        "advantage_home_health_services", "Advantage Home Health Services, East, Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "PA",
        patterns=(),
    ),
    SystemDef(
        "ann_s_choice", "Ann's Choice, Inc.",
        KIND_NONPROFIT, FOCUS_SNF, "PA",
        patterns=(),
    ),
    SystemDef(
        "asbury_atlantic", "Asbury Atlantic, Inc",
        KIND_NONPROFIT, FOCUS_SNF, "PA",
        patterns=(),
    ),
    SystemDef(
        "aurora_home_care", "Aurora Home Care, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "PA",
        patterns=(),
    ),
    SystemDef(
        "bsd_care_at_aj", "Bsd Care at Aj, Llc",
        KIND_FOR_PROFIT, FOCUS_SNF, "PA",
        patterns=(),
    ),
    SystemDef(
        "care_first_home_health", "Care First Home Health Inc",
        KIND_GOVERNMENT, FOCUS_HOME_HEALTH, "PA",
        patterns=(),
    ),
    SystemDef(
        "carepine_home_health", "Carepine Home Health",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "PA",
        patterns=(),
    ),
    SystemDef(
        "caresense_health", "Caresense Health Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "PA",
        patterns=(),
    ),
    SystemDef(
        "celtic_healthcare_of_westmoreland", "Celtic Healthcare of Westmoreland Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "PA",
        patterns=(),
    ),
    SystemDef(
        "centre_homecare", "Centre Homecare Inc",
        KIND_NONPROFIT, FOCUS_HOSPICE, "PA",
        patterns=(),
    ),
    SystemDef(
        "chandler_hall_health_services", "Chandler Hall Health Services, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "PA",
        patterns=(),
    ),
    SystemDef(
        "clarion_forest_vna", "Clarion Forest Vna, Inc",
        KIND_NONPROFIT, FOCUS_HOSPICE, "PA",
        patterns=(),
    ),
    SystemDef(
        "community_home_health", "Community Home Health Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "PA",
        patterns=(),
    ),
    SystemDef(
        "community_nursing_services_of", "Community Nursing Services of North East",
        KIND_NONPROFIT, FOCUS_HOSPICE, "PA",
        patterns=(),
    ),
    SystemDef(
        "divine_health_care_services", "Divine Health Care Services, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "PA",
        patterns=(),
    ),
    SystemDef(
        "doylestown_hospital", "Doylestown Hospital",
        KIND_NONPROFIT, FOCUS_HOSPICE, "PA",
        patterns=(),
    ),
    SystemDef(
        "efcc_acquisition", "Efcc Acquisition Corp",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "PA",
        patterns=(),
    ),
    SystemDef(
        "elk_haven_nursing_home", "Elk Haven Nursing Home Association",
        KIND_NONPROFIT, FOCUS_SNF, "PA",
        patterns=(),
    ),
    SystemDef(
        "epeople_health_care", "Epeople Health Care Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "PA",
        patterns=(),
    ),
    SystemDef(
        "epeople_healthcare", "Epeople Healthcare, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "PA",
        patterns=(),
    ),
    SystemDef(
        "fulton_county_medical_center", "Fulton County Medical Center",
        KIND_NONPROFIT, FOCUS_SNF, "PA",
        patterns=(),
    ),
    SystemDef(
        "grand_view_hospital", "Grand View Hospital",
        KIND_NONPROFIT, FOCUS_HOSPICE, "PA",
        patterns=(),
    ),
    SystemDef(
        "grove_manor_corporation", "Grove Manor Corporation",
        KIND_NONPROFIT, FOCUS_SNF, "PA",
        patterns=(),
    ),
    SystemDef(
        "helping_hands_home_care", "Helping Hands Home Care Service Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "PA",
        patterns=(),
    ),
    SystemDef(
    ...
    SystemDef(
        "hhh_senior_specialist", "Hhh Senior Specialist",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "PA",
        patterns=(),
    ),
    SystemDef(
        "highlands_at_wyomissing", "The Highlands at Wyomissing",
        KIND_NONPROFIT, FOCUS_SNF, "PA",
        patterns=(),
    ),
    SystemDef(
        "home_for_friendless", "Home For the Friendless",
        KIND_NONPROFIT, FOCUS_SNF, "PA",
        patterns=(),
    ),
    SystemDef(
        "home_health_care_professionals", "Home Health Care Professionals, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "PA",
        patterns=(),
    ),
    SystemDef(
        "hope_hospice", "Hope Hospice Inc",
        KIND_NONPROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "independent_home_care", "Independent Home Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "OH",
        patterns=(),
    ),
    SystemDef(
        "jewish_association_on_aging", "Jewish Association On Aging",
        KIND_NONPROFIT, FOCUS_HOSPICE, "PA",
        patterns=(),
    ),
    SystemDef(
        "kendal_crosslands_communities", "Kendal-Crosslands Communities",
        KIND_FOR_PROFIT, FOCUS_SNF, "PA",
        patterns=(),
    ),
    SystemDef(
        "lutheran_senior_services_east", "Lutheran Senior Services East",
        KIND_NONPROFIT, FOCUS_SNF, "PA",
        patterns=(),
    ),
    SystemDef(
        "main_line_health_homecare", "Main Line Health Homecare and Hospice",
        KIND_NONPROFIT, FOCUS_HOSPICE, "PA",
        patterns=(),
    ),
    SystemDef(
        "maylath_valley_health_systems", "Maylath Valley Health Systems, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "PA",
        patterns=(),
    ),
    SystemDef(
        "meadowood_corporation", "Meadowood Corporation",
        KIND_NONPROFIT, FOCUS_SNF, "PA",
        patterns=(),
    ),
    SystemDef(
    ...
    SystemDef(
        "menno_haven", "Menno-Haven, Inc.",
        KIND_NONPROFIT, FOCUS_SNF, "PA",
        patterns=(),
    ),
    SystemDef(
        "mercy_home_health", "Mercy Home Health",
        KIND_NONPROFIT, FOCUS_HOME_HEALTH, "PA",
        patterns=(),
    ),
    SystemDef(
        "new_life_home_health", "New Life Home Health Care Agency",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "PA",
        patterns=(),
    ),
    SystemDef(
        "ospta_home", "Ospta Home, Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "PA",
        patterns=(),
    ),
    SystemDef(
        "pathways_healthcare_pennsylvania", "Pathways Healthcare Pennsylvania, Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "PA",
        patterns=(),
    ),
    SystemDef(
        "pennsylvania_ltc", "Pennsylvania Ltc Inc",
        KIND_NONPROFIT, FOCUS_SNF, "PA",
        patterns=(),
    ),
    SystemDef(
        "pinnacle_hospice", "Pinnacle Hospice Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "PA",
        patterns=(),
    ),
    SystemDef(
        "pocono_vna_hospice", "Pocono Vna-Hospice",
        KIND_NONPROFIT, FOCUS_HOSPICE, "PA",
        patterns=(),
    ),
    SystemDef(
        "premier_home_care", "Premier Home Care, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "PA",
        patterns=(),
    ),
    SystemDef(
        "presbyterian_homes", "Presbyterian Homes Inc",
        KIND_NONPROFIT, FOCUS_SNF, "PA",
        patterns=(),
    ),
    SystemDef(
        "presbyterian_homes_in_presbytery", "Presbyterian Homes in the Presbytery of Huntingdon",
        KIND_NONPROFIT, FOCUS_SNF, "PA",
        patterns=(),
    ),
    SystemDef(
        "priority_home_care", "Priority Home Care Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "OH",
        patterns=(),
    ),
    SystemDef(
        "residential_healthcare_of_ne", "Residential Healthcare of Ne Pa, Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "PA",
        patterns=(),
    ),
    SystemDef(
        "revolutionary_home_health", "Revolutionary Home Health Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "PA",
        patterns=(),
    ),
    SystemDef(
        "spring_creek_snf", "Spring Creek Snf Llc",
        KIND_FOR_PROFIT, FOCUS_SNF, "IL",
        patterns=(),
    ),
    SystemDef(
        "traditional_home_health_and", "Traditional Home Health and Hospice Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "PA",
        patterns=(),
    ),
    SystemDef(
        "united_church_of_christ", "United Church of Christ Homes",
        KIND_NONPROFIT, FOCUS_SNF, "PA",
        patterns=(),
    ),
    SystemDef(
        "upmc_home_healthcare_of", "Upmc Home Healthcare of Western Pa",
        KIND_NONPROFIT, FOCUS_HOSPICE, "PA",
        patterns=(),
    ),
    SystemDef(
        "viaquest_hospice", "Viaquest Hospice Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "OH",
        patterns=(),
    ),
    SystemDef(
        "village_at_morrisons_cove", "The Village at Morrisons Cove",
        KIND_NONPROFIT, FOCUS_HOSPICE, "PA",
        patterns=(),
    ),
    SystemDef(
        "visiting_nurse_assn_of", "Visiting Nurse Assn of Hanover & Spring Grove",
        KIND_NONPROFIT, FOCUS_HOSPICE, "PA",
        patterns=(),
    ),
    SystemDef(
        "vna_health_system", "Vna Health System",
        KIND_NONPROFIT, FOCUS_HOSPICE, "PA",
        patterns=(),
    ),
    SystemDef(
        "vna_of_northwest_pa", "Vna of Northwest Pa, Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "PA",
        patterns=(),
    ),
    SystemDef(
        "willow_valley_communities", "Willow Valley Communities",
        KIND_NONPROFIT, FOCUS_SNF, "PA",
        patterns=(),
    ),
    SystemDef(
        "windber_hospital", "Windber Hospital, Inc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "PA",
        patterns=(),
    ),
    SystemDef(
        "wvuhs_home_care", "Wvuhs Home Care, Llc",
        KIND_NONPROFIT, FOCUS_HOME_HEALTH, "PA",
        patterns=(),
    ),

    SystemDef(
        "a_d_health_care", "A & D Health Care Professionals, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "MI",
        patterns=(),
    ),
    SystemDef(
        "absolute_home_health_care", "Absolute Home Health Care, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "MI",
        patterns=(),
    ),
    SystemDef(
        "acute_home_healthcare", "Acute Home Healthcare, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "FL",
        patterns=(),
    ),
    SystemDef(
        "american_home_health_care", "American Home Health Care Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "apollo_home_care", "Apollo Home Care Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "IL",
        patterns=(),
    ),
    SystemDef(
        "arbor_hospice", "Arbor Hospice, Inc.",
        KIND_NONPROFIT, FOCUS_HOSPICE, "MI",
        patterns=(),
    ),
    SystemDef(
        "atlantic_home_health_care", "Atlantic Home Health Care Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "MI",
        patterns=(),
    ),
    SystemDef(
        "atlas_home_health_care", "Atlas Home Health Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "MI",
        patterns=(),
    ),
    SystemDef(
        "atrium_hillcrest", "Atrium Hillcrest Llc",
        KIND_FOR_PROFIT, FOCUS_SNF, "MI",
        patterns=(),
    ),
    SystemDef(
        "baraga_county_memorial_hospital", "Baraga County Memorial Hospital",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "MI",
        patterns=(),
    ),
    SystemDef(
        "bay_nursing", "Bay Nursing, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "MI",
        patterns=(),
    ),
    SystemDef(
        "bayside_wellness", "Bayside Wellness, Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "MI",
        patterns=(),
    ),
    SystemDef(
        "care_one_home_health", "Care One Home Health Services, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "IL",
        patterns=(),
    ),
    SystemDef(
        "care_plus_home_health", "Care Plus Home Health Services Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "MI",
        patterns=(),
    ),
    SystemDef(
    ...
    SystemDef(
        "central_home_health_care", "Central Home Health Care Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "comfort_care_hospice", "Comfort Care Hospice Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "MI",
        patterns=(),
    ),
    SystemDef(
        "complete_home_health_care", "Complete Home Health Care, Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "IL",
        patterns=(),
    ),
    SystemDef(
        "diamond_home_health_care", "Diamond Home Health Care Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "MI",
        patterns=(),
    ),
    SystemDef(
        "diamond_home_health_services", "Diamond Home Health Services, Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "dynamic_home_care_services", "Dynamic Home Care Services Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "MI",
        patterns=(),
    ),
    SystemDef(
        "excellent_home_care", "Excellent Home Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "MI",
        patterns=(),
    ),
    SystemDef(
        "first_home_health_care", "First Home Health Care, Inc .",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "MI",
        patterns=(),
    ),
    SystemDef(
        "fox_run_village", "Fox Run Village, Inc.",
        KIND_NONPROFIT, FOCUS_SNF, "MI",
        patterns=(),
    ),
    SystemDef(
        "franklin_home_health_care", "Franklin Home Health Care Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "MI",
        patterns=(),
    ),
    SystemDef(
        "guidance_home_health_services", "Guidance Home Health Services Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "MI",
        patterns=(),
    ),
    SystemDef(
        "harmony_hospice_care", "Harmony Hospice Care Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "MI",
        patterns=(),
    ),
    SystemDef(
        "hillsdale_community_health_center", "Hillsdale Community Health Center",
        KIND_NONPROFIT, FOCUS_SNF, "MI",
        patterns=(),
    ),
    SystemDef(
        "holland_home", "Holland Home",
        KIND_NONPROFIT, FOCUS_SNF, "MI",
        patterns=(),
    ),
    SystemDef(
        "honest_home_care", "Honest Home Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "MI",
        patterns=(),
    ),
    SystemDef(
        "horizon_home_care", "Horizon Home Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "hospice_of_michigan", "Hospice of Michigan, Inc.",
        KIND_NONPROFIT, FOCUS_HOSPICE, "MI",
        patterns=(),
    ),
    SystemDef(
        "hospice_of_northwest_ohio", "Hospice of Northwest Ohio",
        KIND_NONPROFIT, FOCUS_HOSPICE, "MI",
        patterns=(),
    ),
    SystemDef(
        "m_y_care", "M & Y Care, Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "MI",
        patterns=(),
    ),
    SystemDef(
        "marlette_regional_hospital", "Marlette Regional Hospital",
        KIND_NONPROFIT, FOCUS_HOSPICE, "MI",
        patterns=(),
    ),
    SystemDef(
        "medlife_home_care", "Medlife Home Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "MI",
        patterns=(),
    ),
    SystemDef(
        "millennium_home_health_care", "Millennium Home Health Care Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "nationwide_home_health_care", "Nationwide Home Health Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "new_century_home_health", "New Century Home Health Care Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "MI",
        patterns=(),
    ),
    SystemDef(
        "new_horizon_home_health", "New Horizon Home Health Care Inc.",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "north_woods_home_nursing", "North Woods Home Nursing",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "MI",
        patterns=(),
    ),
    SystemDef(
        "nova_home_health_care", "Nova Home Health Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "MI",
        patterns=(),
    ),
    SystemDef(
    ...
    SystemDef(
        "optimal_care", "Optimal Care, Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "MI",
        patterns=(),
    ),
    SystemDef(
        "platinum_home_care", "Platinum Home Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "MI",
        patterns=(),
    ),
    SystemDef(
        "porter_hills_presbyterian_village", "Porter Hills Presbyterian Village, Inc.",
        KIND_NONPROFIT, FOCUS_SNF, "MI",
        patterns=(),
    ),
    SystemDef(
        "premier_hospice", "Premier Hospice Llc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "MI",
        patterns=(),
    ),
    SystemDef(
        "priority_home_health_care", "Priority Home Health Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "MI",
        patterns=(),
    ),
    SystemDef(
        "priority_one_home_health", "Priority One Home Health Services Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "riverview_medical_investors_limited", "Riverview Medical Investors Limited Partnership",
        KIND_FOR_PROFIT, FOCUS_SNF, "MI",
        patterns=(),
    ),
    SystemDef(
        "royale_home_health_care", "Royale Home Health Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "CA",
        patterns=(),
    ),
    SystemDef(
        "sana_health", "Sana Health Inc",
        KIND_FOR_PROFIT, FOCUS_SNF, "MI",
        patterns=(),
    ),
    SystemDef(
        "schoolcraft_memorial_hospital", "Schoolcraft Memorial Hospital",
        KIND_GOVERNMENT, FOCUS_HOSPICE, "MI",
        patterns=(),
    ),
    SystemDef(
        "state_of_michigan_office", "State of Michigan Office of Financial Management",
        KIND_GOVERNMENT, FOCUS_SNF, "MI",
        patterns=(),
    ),
    SystemDef(
        "superior_care_hospice", "Superior Care Hospice Inc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "MI",
        patterns=(),
    ),
    SystemDef(
        "three_rivers_health_system", "Three Rivers Health System, Inc",
        KIND_GOVERNMENT, FOCUS_HOSPICE, "MI",
        patterns=(),
    ),
    SystemDef(
        "trinity_continuing_care_services", "Trinity Continuing Care Services",
        KIND_NONPROFIT, FOCUS_SNF, "MI",
        patterns=(),
    ),
    SystemDef(
        "visiting_nurse_association_health", "Visiting Nurse Association Health Services",
        KIND_NONPROFIT, FOCUS_HOSPICE, "MI",
        patterns=(),
    ),
    SystemDef(
        "wisdom_home_health_care", "Wisdom Home Health Care Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "MI",
        patterns=(),
    ),

    SystemDef(
        "calvary_hospital", "Calvary Hospital Inc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "NY",
        patterns=(),
    ),
    SystemDef(
        "caregeis", "Caregeis Llc",
        KIND_FOR_PROFIT, FOCUS_SNF, "NY",
        patterns=(),
    ),
    SystemDef(
        "clr_granville", "Clr Granville Llc",
        KIND_FOR_PROFIT, FOCUS_SNF, "NY",
        patterns=(),
    ),
    SystemDef(
        "county_of_cattaraugus", "County of Cattaraugus",
        KIND_GOVERNMENT, FOCUS_SNF, "NY",
        patterns=(),
    ),
    SystemDef(
        "county_of_chemung", "County of Chemung",
        KIND_GOVERNMENT, FOCUS_SNF, "NY",
        patterns=(),
    ),
    SystemDef(
    ...
    SystemDef(
        "fort_tryon_rehabilitation_health", "Fort Tryon Rehabilitation & Health Care Facility Llc",
        KIND_FOR_PROFIT, FOCUS_SNF, "NY",
        patterns=(),
    ),
    SystemDef(
        "fsnr_snf", "Fsnr Snf Llc",
        KIND_FOR_PROFIT, FOCUS_SNF, "NY",
        patterns=(),
    ),
    SystemDef(
        "gerry_homes", "Gerry Homes Inc",
        KIND_NONPROFIT, FOCUS_SNF, "NY",
        patterns=(),
    ),
    SystemDef(
        "hebrew_home_for_aged", "Hebrew Home For the Aged at Riverdale",
        KIND_NONPROFIT, FOCUS_SNF, "NY",
        patterns=(),
    ),
    SystemDef(
        "home_for_aged_of", "Home For the Aged of the Little Sisters of the Poor",
        KIND_NONPROFIT, FOCUS_SNF, "NY",
        patterns=(),
    ),
    SystemDef(
        "lawrence_community_health_services", "Lawrence Community Health Services",
        KIND_NONPROFIT, FOCUS_HOSPICE, "NY",
        patterns=(),
    ),
    SystemDef(
        "lewis_county_general_hospital", "Lewis County General Hospital",
        KIND_GOVERNMENT, FOCUS_HOSPICE, "NY",
        patterns=(),
    ),
    SystemDef(
        "livingston_county", "Livingston County",
        KIND_GOVERNMENT, FOCUS_HOSPICE, "NY",
        patterns=(),
    ),
    SystemDef(
        "new_york_city_health", "New York City Health and Hospitals Corporation",
        KIND_GOVERNMENT, FOCUS_SNF, "NY",
        patterns=(),
    ),
    SystemDef(
        "niagara_hospice", "Niagara Hospice Inc.",
        KIND_NONPROFIT, FOCUS_HOSPICE, "NY",
        patterns=(),
    ),
    SystemDef(
        "our_lady_of_lourdes", "Our Lady of Lourdes Memorial Hospital, Inc",
        KIND_NONPROFIT, FOCUS_HOSPICE, "NY",
        patterns=(),
    ),
    SystemDef(
        "park_house_care_center", "Park House Care Center Llc",
        KIND_FOR_PROFIT, FOCUS_SNF, "NY",
        patterns=(),
    ),
    SystemDef(
        "parker_jewish_institute_for", "Parker Jewish Institute For Health Care and Rehabilitation",
        KIND_NONPROFIT, FOCUS_HOSPICE, "NY",
        patterns=(),
    ),
    SystemDef(
        "royal_care_certified_home", "Royal Care Certified Home Health Care Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "NY",
        patterns=(),
    ),
    SystemDef(
        "split_rock_rehabilitation_health", "Split Rock Rehabilitation & Health Care Center, Llc",
        KIND_FOR_PROFIT, FOCUS_SNF, "NY",
        patterns=(),
    ),
    SystemDef(
        "state_of_new_york", "State of New York Comptrollers Office",
        KIND_GOVERNMENT, FOCUS_SNF, "NY",
        patterns=(),
    ),
    SystemDef(
    ...
    SystemDef(
        "tender_loving_care_health", "Tender Loving Care Health Care Services of Nassau Suffolk, Llc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "NY",
        patterns=(),
    ),
    SystemDef(
        "united_hospice", "United Hospice Inc",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "IL",
        patterns=(),
    ),
    SystemDef(
        "united_odd_fellow_and", "United Odd Fellow and Rebekah Home",
        KIND_NONPROFIT, FOCUS_SNF, "NY",
        patterns=(),
    ),
    SystemDef(
        "ur_medicine_home_care", "Ur Medicine Home Care, Certified Services, Inc.",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "NY",
        patterns=(),
    ),
    SystemDef(
        "visiting_nurse_service_and", "Visiting Nurse Service and Hospice of Suffolk Inc.",
        KIND_NONPROFIT, FOCUS_HOSPICE, "NY",
        patterns=(),
    ),
    SystemDef(
        "woerner", "L Woerner Inc",
        KIND_FOR_PROFIT, FOCUS_HOME_HEALTH, "NY",
        patterns=(),
    ),

    SystemDef(
        "compass_health", "Compass Health Inc",
        KIND_FOR_PROFIT, FOCUS_SNF, "CA",
        patterns=(),
    ),
    SystemDef(
        "congregational_homes", "Congregational Homes",
        KIND_NONPROFIT, FOCUS_SNF, "CA",
        patterns=(),
    ),
    SystemDef(
        "country_villa_east", "Country Villa East L.p.",
        KIND_FOR_PROFIT, FOCUS_SNF, "CA",
        patterns=(),
    ),
    SystemDef(
        "covenant_care_california", "Covenant Care California, Llc",
        KIND_FOR_PROFIT, FOCUS_SNF, "CA",
        patterns=(),
    ),
    SystemDef(
        "front_porch_communities_and", "Front Porch Communities and Services",
        KIND_NONPROFIT, FOCUS_SNF, "CA",
        patterns=(),
    ),
    SystemDef(
        "grancare", "Grancare Llc",
        KIND_FOR_PROFIT, FOCUS_SNF, "CA",
        patterns=(),
    ),
    SystemDef(
        "humangood_norcal", "Humangood Norcal",
        KIND_NONPROFIT, FOCUS_SNF, "CA",
        patterns=(),
    ),
    SystemDef(
        "humangood_socal", "Humangood Socal",
        KIND_NONPROFIT, FOCUS_SNF, "CA",
        patterns=(),
    ),
    SystemDef(
        "mayers_memorial_hospital_district", "Mayers Memorial Hospital District",
        KIND_FOR_PROFIT, FOCUS_HOSPICE, "CA",
        patterns=(),
    ),
    SystemDef(
        "mid_wilshire_health_care", "Mid-Wilshire Health Care Center",
        KIND_FOR_PROFIT, FOCUS_SNF, "CA",
        patterns=(),
    ),
    SystemDef(
        "rady_children_s_hospital", "Rady Children's Hospital - San Diego",
        KIND_NONPROFIT, FOCUS_SNF, "CA",
        patterns=(),
    ),
    SystemDef(
        "sequoia_living", "Sequoia Living Inc",
        KIND_NONPROFIT, FOCUS_SNF, "CA",
        patterns=(),
    ),
    SystemDef(
        "sunbridge_hallmark_health_services", "Sunbridge Hallmark Health Services Llc",
        KIND_FOR_PROFIT, FOCUS_SNF, "CA",
        patterns=(),
    ),
    SystemDef(
        "united_convalescent_facilities", "United Convalescent Facilities, Inc.",
        KIND_FOR_PROFIT, FOCUS_SNF, "CA",
        patterns=(),
    ),
    SystemDef(
        "valley_view_care_center", "Valley View Care Center Llc",
        KIND_FOR_PROFIT, FOCUS_SNF, "MI",
        patterns=(),
    ),
)
...
CCN_OVERRIDES: Dict[str, str] = {
    "055079": "compass_health",
    "056189": "compass_health",
    "055016": "congregational_homes",
    "05A134": "congregational_homes",
    "055119": "country_villa_east",
    "055160": "country_villa_east",
    "055041": "covenant_care_california",
    "055315": "covenant_care_california",
    "055500": "covenant_care_california",
    "056207": "covenant_care_california",
    "555093": "covenant_care_california",
    "555163": "covenant_care_california",
    "555240": "covenant_care_california",
    "055156": "front_porch_communities_and",
    "056496": "front_porch_communities_and",
    "555085": "front_porch_communities_and",
    "555268": "front_porch_communities_and",
    "055288": "grancare",
    "055318": "grancare",
    "055960": "grancare",
    "055210": "humangood_norcal",
    "055733": "humangood_norcal",
    "055914": "humangood_norcal",
    "056096": "humangood_norcal",
    "555116": "humangood_norcal",
    "555146": "humangood_socal",
    "555295": "humangood_socal",
    "051738": "mayers_memorial_hospital_district",
    "056416": "mayers_memorial_hospital_district",
    "056174": "mid_wilshire_health_care",
    "555088": "mid_wilshire_health_care",
    "05A292": "rady_children_s_hospital",
    "557084": "rady_children_s_hospital",
    "055466": "sequoia_living",
    "056071": "sequoia_living",
    "056077": "sequoia_living",
    "055330": "sunbridge_hallmark_health_services",
    "555004": "sunbridge_hallmark_health_services",
    "055036": "united_convalescent_facilities",
    "056206": "united_convalescent_facilities",
    "235377": "valley_view_care_center",
    "555053": "valley_view_care_center",
    "331562": "calvary_hospital",
    "337210": "calvary_hospital",
    "335019": "caregeis",
    "335581": "caregeis",
    "335331": "clr_granville",
    "335711": "clr_granville",
    "335357": "county_of_cattaraugus",
    "335578": "county_of_cattaraugus",
    "335480": "county_of_chemung",
    "337003": "county_of_chemung",
    "335218": "crnc",
    "335392": "crnc",
    "335257": "fort_tryon_rehabilitation_health",
    "337431": "fort_tryon_rehabilitation_health",
    "335673": "fsnr_snf",
    "335720": "fsnr_snf",
    "335142": "gerry_homes",
    "335721": "gerry_homes",
    "335020": "hebrew_home_for_aged",
    "337276": "hebrew_home_for_aged",
    "335606": "home_for_aged_of",
    "395625": "home_for_aged_of",
    "331525": "lawrence_community_health_services",
    "337036": "lawrence_community_health_services",
    "331540": "lewis_county_general_hospital",
    "335428": "lewis_county_general_hospital",
    "337136": "lewis_county_general_hospital",
    "331553": "livingston_county",
    "335562": "livingston_county",
    "335063": "new_york_city_health",
    "335092": "new_york_city_health",
    "335108": "new_york_city_health",
    "335461": "new_york_city_health",
    "335805": "new_york_city_health",
    "337122": "new_york_city_health",
    "331530": "niagara_hospice",
    "B51523": "niagara_hospice",
    "331505": "our_lady_of_lourdes",
    "337415": "our_lady_of_lourdes",
    "335093": "park_house_care_center",
    "335726": "park_house_care_center",
    "331561": "parker_jewish_institute_for",
    "335132": "parker_jewish_institute_for",
    "337213": "parker_jewish_institute_for",
    "337189": "royal_care_certified_home",
    "337456": "royal_care_certified_home",
    "335321": "split_rock_rehabilitation_health",
    "337416": "split_rock_rehabilitation_health",
    "335097": "state_of_new_york",
    "335770": "state_of_new_york",
    "335788": "state_of_new_york",
    "335823": "state_of_new_york",
    "335832": "state_of_new_york",
    "335873": "state_of_new_york",
    "335096": "tcprnc",
    "335462": "tcprnc",
    "337143": "tender_loving_care_health",
    "337260": "tender_loving_care_health",
    "141697": "united_hospice",
    "331522": "united_hospice",
    "335557": "united_odd_fellow_and",
    "337430": "united_odd_fellow_and",
    "331550": "ur_medicine_home_care",
    "337010": "ur_medicine_home_care",
    "331535": "visiting_nurse_service_and",
    "337014": "visiting_nurse_service_and",
    "337024": "woerner",
    "337083": "woerner",
    "337119": "woerner",
    "337257": "woerner",
    "231639": "a_d_health_care",
    "237186": "a_d_health_care",
    "368017": "a_d_health_care",
    "231633": "absolute_home_health_care",
    "237732": "absolute_home_health_care",
    "109032": "acute_home_healthcare",
    "237590": "acute_home_healthcare",
    "059145": "american_home_health_care",
    "239279": "american_home_health_care",
    "148078": "apollo_home_care",
    "239135": "apollo_home_care",
    "231526": "arbor_hospice",
    "A01684": "arbor_hospice",
    "239143": "atlantic_home_health_care",
    "757255": "atlantic_home_health_care",
    "237724": "atlas_home_health_care",
    "368465": "atlas_home_health_care",
    "235522": "atrium_hillcrest",
    "235535": "atrium_hillcrest",
    "231586": "baraga_county_memorial_hospital",
    "237420": "baraga_county_memorial_hospital",
    "231694": "bay_nursing",
    "237272": "bay_nursing",
    "231712": "bayside_wellness",
    "239356": "bayside_wellness",
    "147872": "care_one_home_health",
    "237647": "care_one_home_health",
    "237772": "care_plus_home_health",
    "397710": "care_plus_home_health",
    "235476": "ccla_9",
    "235659": "ccla_9",
    "058273": "central_home_health_care",
    "237180": "central_home_health_care",
    "231725": "comfort_care_hospice",
    "671754": "comfort_care_hospice",
    "148328": "complete_home_health_care",
    "237638": "complete_home_health_care",
    "237529": "diamond_home_health_care",
    "368310": "diamond_home_health_care",
    "059499": "diamond_home_health_services",
    "237493": "diamond_home_health_services",
    "237445": "dynamic_home_care_services",
    "557280": "dynamic_home_care_services",
    "237711": "excellent_home_care",
    "757217": "excellent_home_care",
    "237489": "first_home_health_care",
    "398371": "first_home_health_care",
    "235634": "fox_run_village",
    "237708": "fox_run_village",
    "239250": "franklin_home_health_care",
    "368266": "franklin_home_health_care",
    "237728": "guidance_home_health_services",
    "747875": "guidance_home_health_services",
    "231675": "harmony_hospice_care",
    "361680": "harmony_hospice_care",
    "235567": "hillsdale_community_health_center",
    "237409": "hillsdale_community_health_center",
    "235440": "holland_home",
    "235540": "holland_home",
    "237774": "honest_home_care",
    "757058": "honest_home_care",
    "058085": "horizon_home_care",
    "237469": "horizon_home_care",
    "231501": "hospice_of_michigan",
    "231510": "hospice_of_michigan",
    "231536": "hospice_of_michigan",
    "231556": "hospice_of_michigan",
    "231618": "hospice_of_northwest_ohio",
    "361502": "hospice_of_northwest_ohio",
    "239280": "m_y_care",
    "368460": "m_y_care",
    "231512": "marlette_regional_hospital",
    "235074": "marlette_regional_hospital",
    "237718": "medlife_home_care",
    "757299": "medlife_home_care",
    "059285": "millennium_home_health_care",
    "237449": "millennium_home_health_care",
    "059655": "nationwide_home_health_care",
    "239120": "nationwide_home_health_care",
    "237453": "new_century_home_health",
    "757517": "new_century_home_health",
    "058139": "new_horizon_home_health",
    "237713": "new_horizon_home_health",
    "231558": "north_woods_home_nursing",
    "237182": "north_woods_home_nursing",
    "239244": "nova_home_health_care",
    "757430": "nova_home_health_care",
    "231555": "nyfries",
    "237187": "nyfries",
    "231669": "optimal_care",
    "231698": "optimal_care",
    "237504": "optimal_care",
    "237580": "platinum_home_care",
    "747198": "platinum_home_care",
    "235310": "porter_hills_presbyterian_village",
    "235649": "porter_hills_presbyterian_village",
    "231623": "premier_hospice",
    "741762": "premier_hospice",
    "239298": "priority_home_health_care",
    "753154": "priority_home_health_care",
    "058063": "priority_one_home_health",
    "237463": "priority_one_home_health",
    "235297": "riverview_medical_investors_limited",
    "235516": "riverview_medical_investors_limited",
    "058274": "royale_home_health_care",
    "237525": "royale_home_health_care",
    "235052": "sana_health",
    "235725": "sana_health",
    "231585": "schoolcraft_memorial_hospital",
    "237279": "schoolcraft_memorial_hospital",
    "235728": "state_of_michigan_office",
    "235729": "state_of_michigan_office",
    "231707": "superior_care_hospice",
    "751737": "superior_care_hospice",
    "231533": "three_rivers_health_system",
    "237289": "three_rivers_health_system",
    "235430": "trinity_continuing_care_services",
    "235453": "trinity_continuing_care_services",
    "231543": "visiting_nurse_association_health",
    "237059": "visiting_nurse_association_health",
    "239349": "wisdom_home_health_care",
    "757821": "wisdom_home_health_care",
    "391691": "365_hospice",
    "391706": "365_hospice",
    "391774": "365_hospice",
    "391688": "acts_retirement_life_communities",
    "395496": "acts_retirement_life_communities",
    "395665": "acts_retirement_life_communities",
    "398265": "acts_retirement_life_communities",
    "148404": "advanced_nursing_care",
    "398219": "advanced_nursing_care",
    "391591": "advantage_home_health_services",
    "397129": "advantage_home_health_services",
    "398225": "advantage_home_health_services",
    "396107": "ann_s_choice",
    "398072": "ann_s_choice",
    "395386": "asbury_atlantic",
    "395907": "asbury_atlantic",
    "398110": "aurora_home_care",
    "559175": "aurora_home_care",
    "395537": "bsd_care_at_aj",
    "396070": "bsd_care_at_aj",
    "398298": "care_first_home_health",
    "559459": "care_first_home_health",
    "398216": "carepine_home_health",
    "398255": "carepine_home_health",
    "398385": "carepine_home_health",
    "398220": "caresense_health",
    "398307": "caresense_health",
    "398069": "celtic_healthcare_of_westmoreland",
    "398088": "celtic_healthcare_of_westmoreland",
    "391518": "centre_homecare",
    "397126": "centre_homecare",
    "391502": "chandler_hall_health_services",
    "395305": "chandler_hall_health_services",
    "391576": "clarion_forest_vna",
    "397116": "clarion_forest_vna",
    "397668": "community_home_health",
    "757296": "community_home_health",
    "391645": "community_nursing_services_of",
    "397089": "community_nursing_services_of",
    "398080": "divine_health_care_services",
    "679265": "divine_health_care_services",
    "391546": "doylestown_hospital",
    "397083": "doylestown_hospital",
    "397679": "efcc_acquisition",
    "397743": "efcc_acquisition",
    "397744": "efcc_acquisition",
    "395279": "elk_haven_nursing_home",
    "395341": "elk_haven_nursing_home",
    "398233": "epeople_health_care",
    "398258": "epeople_health_care",
    "398131": "epeople_healthcare",
    "398176": "epeople_healthcare",
    "395387": "fulton_county_medical_center",
    "397698": "fulton_county_medical_center",
    "391557": "grand_view_hospital",
    "397051": "grand_view_hospital",
    "395510": "grove_manor_corporation",
    "395959": "grove_manor_corporation",
    "398338": "helping_hands_home_care",
    "731508": "helping_hands_home_care",
    "395058": "hes",
    "395168": "hes",
    "391759": "hhh_senior_specialist",
    "398179": "hhh_senior_specialist",
    "395800": "highlands_at_wyomissing",
    "731515": "highlands_at_wyomissing",
    "395475": "home_for_friendless",
    "398270": "home_for_friendless",
    "391680": "home_health_care_professionals",
    "397662": "home_health_care_professionals",
    "051601": "hope_hospice",
    "391615": "hope_hospice",
    "368037": "independent_home_care",
    "398090": "independent_home_care",
    "391608": "jewish_association_on_aging",
    "398087": "jewish_association_on_aging",
    "395307": "kendal_crosslands_communities",
    "395388": "kendal_crosslands_communities",
    "395117": "lutheran_senior_services_east",
    "395591": "lutheran_senior_services_east",
    "395876": "lutheran_senior_services_east",
    "391583": "main_line_health_homecare",
    "397012": "main_line_health_homecare",
    "391713": "maylath_valley_health_systems",
    "398041": "maylath_valley_health_systems",
    "395768": "meadowood_corporation",
    "397711": "meadowood_corporation",
    "391552": "memorial_hospital",
    "397474": "memorial_hospital",
    "395012": "menno_haven",
    "395944": "menno_haven",
    "396145": "menno_haven",
    "397015": "mercy_home_health",
    "731519": "mercy_home_health",
    "391723": "new_life_home_health",
    "397795": "new_life_home_health",
    "391766": "ospta_home",
    "397798": "ospta_home",
    "397733": "pathways_healthcare_pennsylvania",
    "398010": "pathways_healthcare_pennsylvania",
    "395717": "pennsylvania_ltc",
    "395757": "pennsylvania_ltc",
    "391697": "pinnacle_hospice",
    "971726": "pinnacle_hospice",
    "391523": "pocono_vna_hospice",
    "397031": "pocono_vna_hospice",
    "398040": "premier_home_care",
    "679696": "premier_home_care",
    "395367": "presbyterian_homes",
    "395375": "presbyterian_homes",
    "395568": "presbyterian_homes",
    "395916": "presbyterian_homes",
    "395530": "presbyterian_homes_in_presbytery",
    "396015": "presbyterian_homes_in_presbytery",
    "368361": "priority_home_care",
    "398202": "priority_home_care",
    "391572": "residential_healthcare_of_ne",
    "397726": "residential_healthcare_of_ne",
    "391764": "revolutionary_home_health",
    "398034": "revolutionary_home_health",
    "398140": "revolutionary_home_health",
    "398241": "revolutionary_home_health",
    "146172": "spring_creek_snf",
    "395074": "spring_creek_snf",
    "391701": "traditional_home_health_and",
    "397774": "traditional_home_health_and",
    "395677": "united_church_of_christ",
    "395802": "united_church_of_christ",
    "395832": "united_church_of_christ",
    "395857": "united_church_of_christ",
    "391605": "upmc_home_healthcare_of",
    "391621": "upmc_home_healthcare_of",
    "397101": "upmc_home_healthcare_of",
    "361660": "viaquest_hospice",
    "391707": "viaquest_hospice",
    "391752": "village_at_morrisons_cove",
    "395563": "village_at_morrisons_cove",
    "398133": "village_at_morrisons_cove",
    "391548": "visiting_nurse_assn_of",
    "397061": "visiting_nurse_assn_of",
    "391566": "vna_health_system",
    "397053": "vna_health_system",
    "391510": "vna_of_northwest_pa",
    "397130": "vna_of_northwest_pa",
    "395771": "willow_valley_communities",
    "395956": "willow_valley_communities",
    "391541": "windber_hospital",
    "397442": "windber_hospital",
    "368439": "wvuhs_home_care",
    "398332": "wvuhs_home_care",
    "731500": "wvuhs_home_care",
    "053130": "abundant_home_health_care",
    "148068": "abundant_home_health_care",
    "147815": "advanced_home_health_services",
    "743135": "advanced_home_health_services",
    "141507": "adventist_midwest_health",
    "147207": "adventist_midwest_health",
    "059011": "apex_home_health_care",
    "147921": "apex_home_health_care",
    "141594": "bond_county_treasurer",
    "147023": "bond_county_treasurer",
    "141659": "breeze_hospice",
    "A91639": "breeze_hospice",
    "148035": "community_home_health_care",
    "369137": "community_home_health_care",
    "145409": "covenant_health_care_center",
    "145527": "covenant_health_care_center",
    "147940": "essential_home_care",
    "457858": "essential_home_care",
    "141622": "family_home_health_services",
    "147712": "family_home_health_services",
    "141607": "fayette_county",
    "147147": "fayette_county",
    "141718": "first_health_hospice",
    "361717": "first_health_hospice",
    "145602": "franciscan_communities",
    "145637": "franciscan_communities",
    "145724": "franciscan_communities",
    "366071": "franciscan_communities",
    "148121": "gold_coast_home_health",
    "757190": "gold_coast_home_health",
    "141631": "henderson_county",
    "147178": "henderson_county",
    "109011": "horizon_home_health_care",
    "147829": "horizon_home_health_care",
    "058378": "ideal_care_home_health",
    "148202": "ideal_care_home_health",
    "141616": "iroquois_memorial_hospital_and",
    "146049": "iroquois_memorial_hospital_and",
    "147586": "iroquois_memorial_hospital_and",
    "141525": "journeycare",
    "141527": "journeycare",
    "147683": "lhcg_xxxvii",
    "147716": "lhcg_xxxvii",
    "147799": "lhcg_xxxvii",
    "058390": "lifecare_home_health_services",
    "147889": "lifecare_home_health_services",
    "141524": "mcdonough_county_hospital_district",
    "147293": "mcdonough_county_hospital_district",
    "058090": "metropolitan_home_health_care",
    "147786": "metropolitan_home_health_care",
    "059454": "nexus_home_health",
    "147920": "nexus_home_health",
    "059688": "omnicare_home_health",
    "147925": "omnicare_home_health",
    "148034": "optimum_home_health_care",
    "457978": "optimum_home_health_care",
    "141591": "palos_community_hospital",
    "147470": "palos_community_hospital",
    "141575": "pana_community_hospital_association",
    "147299": "pana_community_hospital_association",
    "059119": "progressive_home_health_care",
    "147697": "progressive_home_health_care",
    "059675": "reliance_home_health_care",
    "147991": "reliance_home_health_care",
    "141609": "rest_haven_illiana_christian",
    "147559": "rest_haven_illiana_christian",
    "141599": "sarah_bush_lincoln_health",
    "145499": "sarah_bush_lincoln_health",
    "147594": "sarah_bush_lincoln_health",
    "058228": "star_home_health_services",
    "148116": "star_home_health_services",
    "147807": "sterling_home_health_care",
    "747573": "sterling_home_health_care",
    "145441": "unlimited_development",
    "145597": "unlimited_development",
    "145666": "unlimited_development",
    "145733": "unlimited_development",
    "145837": "unlimited_development",
    "145841": "unlimited_development",
    "141553": "vna_health_care",
    "147000": "vna_health_care",
    "141543": "waukegan_hospice",
    "148260": "waukegan_hospice",
    "147835": "wellcare_home_health",
    "367786": "wellcare_home_health",
    "058410": "aaa_home_health_services",
    "108015": "aaa_home_health_services",
    "059447": "absolute_home_health",
    "109098": "absolute_home_health",
    "103153": "absolutely_haven",
    "687116": "absolutely_haven",
    "109034": "aca_home_health",
    "687303": "aca_home_health",
    "058441": "access_home_health_care",
    "683188": "access_home_health_care",
    "109745": "access_nursecare",
    "687382": "access_nursecare",
    "683199": "accurate_care_home_health",
    "687345": "accurate_care_home_health",
    "108113": "activa_health_services",
    "109628": "activa_health_services",
    "109286": "advance_care_home_health",
    "553187": "advance_care_home_health",
    "058426": "advanced_home_health",
    "683148": "advanced_home_health",
    "687055": "affinity_home_healthcare",
    "687064": "affinity_home_healthcare",
    "687072": "affinity_home_healthcare",
    "109712": "all_health_care_services",
    "687312": "all_health_care_services",
    "109715": "all_services_home_health",
    "687165": "all_services_home_health",
    "058253": "allegiance_home_health",
    "687179": "allegiance_home_health",
    "109716": "alliance_health_care_of",
    "687039": "alliance_health_care_of",
    "108491": "alternative_medical_healthcare_services",
    "687253": "alternative_medical_healthcare_services",
    "559599": "ambassadore_health_care",
    "687336": "ambassadore_health_care",
    "108483": "american_home_health_agency",
    "687287": "american_home_health_agency",
    "107593": "apex_home_healthcare_services",
    "108067": "apex_home_healthcare_services",
    "108215": "apex_home_healthcare_services",
    "103185": "atlantic_home_care",
    "687070": "atlantic_home_care",
    "107212": "baycare_home_care",
    "107260": "baycare_home_care",
    "107282": "baycare_home_care",
    "107285": "baycare_home_care",
    "107415": "baycare_home_care",
    "683134": "best_care_providers",
    "687059": "best_care_providers",
    "109405": "breeze_health_care",
    "109561": "breeze_health_care",
    "105645": "brooks_skilled_nursing_facility",
    "105820": "brooks_skilled_nursing_facility",
    "551772": "calm_care",
    "687283": "calm_care",
    "107110": "catholic_home_health_services",
    "107670": "catholic_home_health_services",
    "105966": "christian_missionary_alliance_foundation",
    "687083": "christian_missionary_alliance_foundation",
    "109324": "compassionate_caring_home_care",
    "687392": "compassionate_caring_home_care",
    "108032": "confident_care_of_florida",
    "108044": "confident_care_of_florida",
    "108222": "confident_care_of_florida",
    "108371": "confident_care_of_florida",
    "109077": "continental_home_health_care",
    "368062": "continental_home_health_care",
    "107423": "covenant_home_health_care",
    "687029": "covenant_home_health_care",
    "559419": "crown_home_care",
    "683165": "crown_home_care",
    "683176": "crown_home_health_care",
    "748159": "crown_home_health_care",
    "107654": "empathy_care",
    "757437": "empathy_care",
    "107625": "etairos_care_at_home",
    "107627": "etairos_care_at_home",
    "108448": "etairos_health",
    "109428": "etairos_health",
    "058183": "excellent_care_home_health",
    "109068": "excellent_care_home_health",
    "107636": "faith_home_health",
    "107638": "faith_home_health",
    "109140": "first_care_home_services",
    "687229": "first_care_home_services",
    "108183": "first_choice_home_health",
    "559358": "first_choice_home_health",
    "105840": "florida_department_of_veterans",
    "106006": "florida_department_of_veterans",
    "106038": "florida_department_of_veterans",
    "106056": "florida_department_of_veterans",
    "106059": "florida_department_of_veterans",
    "106088": "florida_department_of_veterans",
    "106151": "florida_department_of_veterans",
    "686128": "florida_department_of_veterans",
    "687073": "florida_homecare_specialists_minority",
    "687080": "florida_homecare_specialists_minority",
    "687081": "florida_homecare_specialists_minority",
    "109663": "forever_home_health_care",
    "757350": "forever_home_health_care",
    "058434": "gentle_care",
    "107711": "gentle_care",
    "107697": "goldencare_home_health_agency",
    "108295": "goldencare_home_health_agency",
    "687049": "gtb_home_healthcare_solutions",
    "687322": "gtb_home_healthcare_solutions",
    "108307": "health_care_of_south",
    "109552": "health_care_of_south",
    "109256": "healthmax_home_care_services",
    "687133": "healthmax_home_care_services",
    "109028": "hh_stuart",
    "109058": "hh_stuart",
    "687299": "higher_standard_home_care",
    "687398": "higher_standard_home_care",
    "109078": "home_care_plus",
    "687150": "home_care_plus",
    "103156": "home_health_care_of",
    "683141": "home_health_care_of",
    "107088": "home_health_services_of",
    "107397": "home_health_services_of",
    "103166": "homewood_home_health",
    "109224": "homewood_home_health",
    "687278": "inspire_home_healthcare",
    "687383": "inspire_home_healthcare",
    "105138": "jacksonville_rehabilitation_and_nursing",
    "105287": "jacksonville_rehabilitation_and_nursing",
    "105374": "john_knox_village_of",
    "107530": "john_knox_village_of",
    "687087": "josy_enterprises_ii",
    "687151": "josy_enterprises_ii",
    "105555": "jupiter_rehab_and_health",
    "106148": "jupiter_rehab_and_health",
    "108375": "k_d_home_health",
    "109518": "k_d_home_health",
    "687364": "lakes_home_care",
    "687369": "lakes_home_care",
    "105404": "lifespace_communities",
    "105411": "lifespace_communities",
    "105556": "lifespace_communities",
    "105598": "lifespace_communities",
    "103161": "matrix_home_care",
    "369268": "matrix_home_care",
    "683103": "matrix_home_care",
    "058221": "medcare_home_health_services",
    "107117": "medcare_home_health_services",
    "105311": "northport_health_services_of",
    "105315": "northport_health_services_of",
    "105317": "northport_health_services_of",
    "105321": "northport_health_services_of",
    "105376": "northport_health_services_of",
    "108120": "omni_home_health_district",
    "109670": "omni_home_health_district",
    "105512": "orlando_rehabilitation_group",
    "105791": "orlando_rehabilitation_group",
    "369321": "paramount_home_health_services",
    "687139": "paramount_home_health_services",
    "108109": "patients_first_home_care",
    "687173": "patients_first_home_care",
    "687176": "patients_first_home_care",
    "105524": "port_charlotte_opco",
    "105982": "port_charlotte_opco",
    "108412": "primary_medical_staffing",
    "109414": "primary_medical_staffing",
    "369381": "procare_home_health",
    "687124": "procare_home_health",
    "687048": "professional_home_health_services",
    "687093": "professional_home_health_services",
    "109172": "professional_solutions_home_health",
    "109468": "professional_solutions_home_health",
    "109458": "r_g_therapy_services",
    "687330": "r_g_therapy_services",
    "108009": "santiago",
    "108092": "santiago",
    "109119": "sarasota_home_health_care",
    "109793": "sarasota_home_health_care",
    "687030": "seaside_home_health",
    "687031": "seaside_home_health",
    "107762": "southeast_homecare",
    "108138": "southeast_homecare",
    "105828": "sovereign_healthcare_of_palm",
    "105831": "sovereign_healthcare_of_palm",
    "058414": "sunshine_home_health_services",
    "103162": "sunshine_home_health_services",
    "105158": "tallahassee_memorial_healthcare",
    "107115": "tallahassee_memorial_healthcare",
    "107704": "tehc",
    "107717": "tehc",
    "107718": "tehc",
    "107773": "tehc",
    "108220": "tendra_home_health",
    "109507": "tendra_home_health",
    "683110": "therapycare_home_health",
    "687228": "therapycare_home_health",
    "108445": "tri_county_homecare_of",
    "687058": "tri_county_homecare_of",
    "687258": "trulife_home_health",
    "687327": "trulife_home_health",
    "757432": "trulife_home_health",
    "108450": "ultimate_home_care",
    "109781": "ultimate_home_care",
    "673167": "ultimate_home_care",
    "105232": "villa_maria_nursing_rehabilitation",
    "106080": "villa_maria_nursing_rehabilitation",
    "107177": "visiting_nurse_association_of",
    "107527": "visiting_nurse_association_of",
    "107609": "visiting_nurse_association_of",
    "107614": "visiting_nurse_association_of",
    "105796": "waterman_communities",
    "109450": "waterman_communities",
    "107120": "west_florida_pphomehealth",
    "107139": "west_florida_pphomehealth",
    "109013": "world_first_class_home",
    "109615": "world_first_class_home",
    "687079": "world_first_class_home",
    "553129": "24_7_team_care",
    "A01540": "24_7_team_care",
    "559793": "a_plus_home_health",
    "559795": "a_plus_home_health",
    "058355": "advantage_health_systems",
    "551686": "advantage_health_systems",
    "058072": "agb_home_health",
    "559707": "agb_home_health",
    "051758": "all_care_home_health",
    "557615": "all_care_home_health",
    "559601": "alliance_health_services",
    "D61510": "alliance_health_services",
    "053153": "alliance_home_health_hospice",
    "921774": "alliance_home_health_hospice",
    "559139": "amavi_home_health_and",
    "751689": "amavi_home_health_and",
    "059510": "american_hospice_and_home",
    "551704": "american_hospice_and_home",
    "748118": "aura_home_health",
    "757121": "aura_home_health",
    "059617": "benjamin_healthcare",
    "751700": "benjamin_healthcare",
    "553132": "bliss_home_health_care",
    "747632": "bliss_home_health_care",
    "059354": "blize_healthcare_california",
    "551751": "blize_healthcare_california",
    "059471": "blossom_ridge_home_health",
    "751577": "blossom_ridge_home_health",
    "051524": "butte_home_health",
    "057679": "butte_home_health",
    "559235": "capitol_healthcare",
    "A11555": "capitol_healthcare",
    "B21681": "care_village_hospice",
    "D61560": "care_village_hospice",
    "059010": "central_coast_home_health",
    "551604": "central_coast_home_health",
    "051713": "central_coast_vna_hospice",
    "057002": "central_coast_vna_hospice",
    "058297": "cne_home_health_services",
    "679456": "cne_home_health_services",
    "A11713": "comfort_choice_hospice_care",
    "B41723": "comfort_choice_hospice_care",
    "051543": "community_hospice",
    "361653": "community_hospice",
    "051614": "covenant_home_services",
    "057571": "covenant_home_services",
    "051611": "daian_corporation",
    "057567": "daian_corporation",
    "053106": "danny_s_home_health",
    "059733": "danny_s_home_health",
    "553128": "danny_s_home_health",
    "559236": "danny_s_home_health",
    "058153": "dedicated_home_health_care",
    "757122": "dedicated_home_health_care",
    "059281": "diamond_home_health",
    "679112": "diamond_home_health",
    "053123": "elixir_home_health_care",
    "921717": "elixir_home_health_care",
    "051666": "enloe_medical_center",
    "057661": "enloe_medical_center",
    "059685": "freedom_home_health_and",
    "751735": "freedom_home_health_and",
    "A01760": "generations_hospice_and_palliative",
    "A91748": "generations_hospice_and_palliative",
    "059787": "gimag_healthcare",
    "A01706": "gimag_healthcare",
    "051728": "hdmc_holdings",
    "057763": "hdmc_holdings",
    "751514": "healing_care_hospice",
    "A91661": "healing_care_hospice",
    "059628": "helping_hands_home_health",
    "A01504": "helping_hands_home_health",
    "B31507": "hospice_care",
    "B41530": "hospice_care",
    "551605": "hygieia_health_systems",
    "B51542": "hygieia_health_systems",
    "368291": "ideal_home_health_care",
    "757742": "ideal_home_health_care",
    "058300": "infinite_home_health",
    "058368": "infinite_home_health",
    "059217": "infinity_care_services",
    "751636": "infinity_care_services",
    "921695": "integrity_hospice",
    "B41735": "integrity_hospice",
    "757424": "life_of_hope_home",
    "757605": "life_of_hope_home",
    "051517": "livingston_memorial_visiting_nurse",
    "057040": "livingston_memorial_visiting_nurse",
    "059143": "mary_s_help_home",
    "B51744": "mary_s_help_home",
    "559474": "medicalone_health",
    "B41714": "medicalone_health",
    "058294": "outreach_home_health_services",
    "367763": "outreach_home_health_services",
    "051689": "owen_healthcare",
    "557796": "owen_healthcare",
    "053148": "pacific_point_health_care",
    "921669": "pacific_point_health_care",
    "051506": "pathways_home_health_and",
    "051580": "pathways_home_health_and",
    "057190": "pathways_home_health_and",
    "051542": "pih_health_whittier_hospital",
    "057187": "pih_health_whittier_hospital",
    "059786": "progressive_home_health_and",
    "921598": "progressive_home_health_and",
    "741519": "quality_care_hospice",
    "921643": "quality_care_hospice",
    "058354": "rehabfocus_home_health",
    "557764": "rehabfocus_home_health",
    "059450": "rosales",
    "921644": "rosales",
    "051721": "sacramento_river_healthcare",
    "B31707": "sacramento_river_healthcare",
    "553134": "saint_rita_home_health",
    "559379": "saint_rita_home_health",
    "058237": "salus_home_health_and",
    "751641": "salus_home_health_and",
    "559478": "solace_healthcare",
    "B21611": "solace_healthcare",
    "559240": "solid_care_home_health",
    "743150": "solid_care_home_health",
    "559201": "sonder_healthcare",
    "A11563": "sonder_healthcare",
    "751519": "st_bernardine_care_providers",
    "753151": "st_bernardine_care_providers",
    "058156": "staff_assistance",
    "557514": "staff_assistance",
    "451762": "sunset_hospice",
    "B41579": "sunset_hospice",
    "051615": "torrance_memorial_medical_center",
    "057788": "torrance_memorial_medical_center",
    "051538": "trinity_home_health_services",
    "057135": "trinity_home_health_services",
    "551608": "true_care_hospice_southern",
    "921593": "true_care_hospice_southern",
    "059349": "truemed",
    "757859": "truemed",
    "557490": "unique_home_health_services",
    "679577": "unique_home_health_services",
    "751535": "united_hospice_services",
    "A01563": "united_hospice_services",
    "369029": "vanguard_home_health_care",
    "559564": "vanguard_home_health_care",
    "751573": "vida_hospice_services",
    "A01517": "vida_hospice_services",
    "921657": "visiting_angels_hospice_care",
    "B21672": "visiting_angels_hospice_care",
    "051540": "visiting_nurse_and_hospice",
    "057163": "visiting_nurse_and_hospice",
    "051548": "vna_of_greater_los",
    "057018": "vna_of_greater_los",
    "051585": "vna_of_orange_county",
    "057021": "vna_of_orange_county",
    "921583": "wecare_hospice_and_palliative",
    "D61508": "wecare_hospice_and_palliative",
    "058416": "a_1_healthcare_management",
    "551726": "a_1_healthcare_management",
    "059461": "ace_home_health_care",
    "551669": "ace_home_health_care",
    "058038": "act_home_health",
    "457965": "act_home_health",
    "368475": "akeso_home_health_care",
    "559355": "akeso_home_health_care",
    "751562": "americare_hospice",
    "B51624": "americare_hospice",
    "553110": "arden_home_health",
    "757238": "arden_home_health",
    "051743": "assisted_home_care",
    "A01649": "assisted_home_care",
    "559057": "assistive_health_systems",
    "B41661": "assistive_health_systems",
    "051711": "barton_healthcare_system",
    "057226": "barton_healthcare_system",
    "A11749": "blue_ribbon_hospice",
    "A91637": "blue_ribbon_hospice",
    "921668": "care_must_hospice",
    "A11784": "care_must_hospice",
    "757369": "cng_international",
    "A11775": "cng_international",
    "A91552": "connect_care_hospice",
    "B31601": "connect_care_hospice",
    "757097": "cvhcare_corporation",
    "757545": "cvhcare_corporation",
    "058121": "haven_health_care",
    "551721": "haven_health_care",
    "757747": "hep_enterprises",
    "921608": "hep_enterprises",
    "059653": "human_touch_home_health",
    "557677": "human_touch_home_health",
    "059590": "lighthouse_home_health_care",
    "757544": "lighthouse_home_health_care",
    "059704": "majestic_hospice_home_health",
    "921685": "majestic_hospice_home_health",
    "059373": "mohave_healthcare",
    "751698": "mohave_healthcare",
    "057447": "nurses_on_wheels",
    "459200": "nurses_on_wheels",
    "053100": "paramount_home_health_care",
    "751786": "paramount_home_health_care",
    "057602": "rancho_bernardo_healthcare",
    "059303": "rancho_bernardo_healthcare",
    "051534": "redlands_community_hospital",
    "057494": "redlands_community_hospital",
    "557690": "rx_staffing_and_home",
    "921539": "rx_staffing_and_home",
    "559506": "sas_home_health_care",
    "757542": "sas_home_health_care",
    "051667": "self_help_for_elderly",
    "057570": "self_help_for_elderly",
    "059627": "sunrise_home_health_care",
    "559500": "sunrise_home_health_care",
    "051732": "tahoe_forest_hospital_district",
    "057200": "tahoe_forest_hospital_district",
    "559718": "transition_care_telemetry",
    "B31545": "transition_care_telemetry",
    "059110": "vina_holdings",
    "751637": "vina_holdings",
    "557423": "vital_home_health_care",
    "747051": "vital_home_health_care",
    "051531": "vnacare",
    "051535": "vnacare",
    "051708": "vnacare",
    "757053": "1st_choice_home_healthcare",
    "D61528": "1st_choice_home_healthcare",
    "058315": "american_carequest",
    "551629": "american_carequest",
    "671638": "angel_care_hospice",
    "B51785": "angel_care_hospice",
    "058324": "assisted_home_recovery",
    "557089": "assisted_home_recovery",
    "A91508": "bellevue_hospice_care",
    "B31577": "bellevue_hospice_care",
    "553152": "capital_home_health_care",
    "753163": "capital_home_health_care",
    "553155": "colusa_medical_center",
    "A01519": "colusa_medical_center",
    "559774": "committed_home_health_care",
    "677809": "committed_home_health_care",
    "361644": "continuum_care_hospice",
    "751626": "continuum_care_hospice",
    "051645": "dignity_health",
    "057205": "dignity_health",
    "971504": "direct_hospice_care",
    "A11729": "direct_hospice_care",
    "059511": "egb_holdings",
    "921732": "egb_holdings",
    "A01600": "egb_holdings",
    "559264": "family_friends_home_health",
    "679780": "family_friends_home_health",
    "679478": "good_samaritan_home_health",
    "757272": "good_samaritan_home_health",
    "747932": "goodwill_healthcare_services",
    "B31736": "goodwill_healthcare_services",
    "559153": "infinite_care_home_health",
    "679431": "infinite_care_home_health",
    "369380": "integrity_home_health_care",
    "559009": "integrity_home_health_care",
    "057252": "joshua_tree_healthcare",
    "557165": "joshua_tree_healthcare",
    "059237": "meridian_care",
    "B31687": "meridian_care",
    "557008": "pioneer_home_health_care",
    "921591": "pioneer_home_health_care",
    "551641": "prohealth_home_care",
    "921588": "prohealth_home_care",
    "458294": "valley_home_health",
    "758040": "valley_home_health",
    "058164": "vision_home_health_care",
    "679023": "vision_home_health_care",
    "369086": "wellspring_home_health_care",
    "757530": "wellspring_home_health_care",
    "677247": "advanced_hh",
    "679671": "advanced_hh",
    "361742": "ahc_home_health_of",
    "369386": "ahc_home_health_of",
    "747024": "alamo_home_healthcare",
    "A91534": "alamo_home_healthcare",
    "747422": "all_generations_health_care",
    "971552": "all_generations_health_care",
    "747314": "allheal_home_health",
    "A91779": "allheal_home_health",
    "747297": "american_choice_healthcare",
    "A91568": "american_choice_healthcare",
    "457146": "apc_home_health_service",
    "457193": "apc_home_health_service",
    "747486": "arising_healthcare_services",
    "971563": "arising_healthcare_services",
    "671692": "avatar_home_health_care",
    "679618": "avatar_home_health_care",
    "679082": "axiom_home_health",
    "747169": "axiom_home_health",
    "457773": "ballinger_home_health",
    "671570": "ballinger_home_health",
    "679617": "bayside_solutions",
    "741643": "bayside_solutions",
    "741558": "best_care_hospice",
    "971580": "best_care_hospice",
    "677078": "calvert_home_health_care",
    "677109": "calvert_home_health_care",
    "747774": "caridad_healthcare",
    "971619": "caridad_healthcare",
    "971506": "carrington_hospice_care",
    "971557": "carrington_hospice_care",
    "451565": "cedar_lake_nursing_services",
    "457582": "cedar_lake_nursing_services",
    "741691": "coleman_home_health_and",
    "747956": "coleman_home_health_and",
    "368281": "comfort_home_health_care",
    "679252": "comfort_home_health_care",
    "361686": "cypress_hospice",
    "A91654": "cypress_hospice",
    "459303": "dos_hermanas_ortiz",
    "971602": "dos_hermanas_ortiz",
    "679727": "fortune_healthcare",
    "741533": "fortune_healthcare",
    "748075": "guardian_home_care",
    "A91701": "guardian_home_care",
    "741538": "halcyon_home",
    "747931": "halcyon_home",
    "747118": "healthy_choice_homecare",
    "A91761": "healthy_choice_homecare",
    "679656": "heavenly_health_care",
    "A91629": "heavenly_health_care",
    "365444": "hill_view_retirement_center",
    "368458": "hill_view_retirement_center",
    "741606": "hillrise_home_management",
    "747491": "hillrise_home_management",
    "369358": "his_grace_home_health",
    "747850": "his_grace_home_health",
    "459488": "homestyle_specialty_nursing_care",
    "679006": "homestyle_specialty_nursing_care",
    "671541": "hospice_partners_of_america",
    "671619": "hospice_partners_of_america",
    "458306": "ipr_healthcare_systems",
    "741755": "ipr_healthcare_systems",
    "458337": "kdc_healthcare_partners",
    "677893": "kdc_healthcare_partners",
    "457094": "kingfisher_health",
    "971605": "kingfisher_health",
    "458324": "knox_county_hospital_district",
    "675061": "knox_county_hospital_district",
    "741774": "la_esperanza_home_health",
    "747307": "la_esperanza_home_health",
    "451614": "lagniappe_health_care_investments",
    "677433": "lagniappe_health_care_investments",
    "671694": "laredo_visiting_nurses",
    "673199": "laredo_visiting_nurses",
    "741795": "legacy_at_home",
    "747734": "legacy_at_home",
    "451786": "legacy_home_health_agency",
    "459433": "legacy_home_health_agency",
    "677956": "livingwell_home_health_agency",
    "747120": "livingwell_home_health_agency",
    "677955": "lucent_health_group",
    "679652": "lucent_health_group",
    "361650": "marietta_home_health_and",
    "368230": "marietta_home_health_and",
    "679217": "matrix_home_health_services",
    "A91630": "matrix_home_health_services",
    "457893": "maxus_healthcare_partners",
    "679677": "maxus_healthcare_partners",
    "747251": "maxus_healthcare_partners",
    "747859": "maxus_healthcare_partners",
    "A91535": "memorial_family_for_hospice",
    "A91708": "memorial_family_for_hospice",
    "671756": "monument_healthcare",
    "743120": "monument_healthcare",
    "741608": "morris_infinite_healthcare_services",
    "747172": "morris_infinite_healthcare_services",
    "671666": "new_age_hospice_palliative",
    "971606": "new_age_hospice_palliative",
    "971643": "nightingale_hospice_care",
    "A91619": "nightingale_hospice_care",
    "451589": "ochiltree_hospital_district",
    "457640": "ochiltree_hospital_district",
    "741677": "omnix_health_care_services",
    "743167": "omnix_health_care_services",
    "748068": "one_new_era_investments",
    "A91502": "one_new_era_investments",
    "678464": "regency_ihs_home_care",
    "679395": "regency_ihs_home_care",
    "677439": "retreat_health_care_services",
    "971618": "retreat_health_care_services",
    "741536": "rgv_calidad_home_health",
    "747168": "rgv_calidad_home_health",
    "671655": "river_city_hospice_of",
    "671716": "river_city_hospice_of",
    "367337": "rx_home_healthcare",
    "368128": "rx_home_healthcare",
    "671769": "san_jose_hospice",
    "971751": "san_jose_hospice",
    "671742": "sghpc_sa",
    "741596": "sghpc_sa",
    "671585": "sid_peterson_memorial_hospital",
    "677052": "sid_peterson_memorial_hospital",
    "671767": "sixrsig",
    "747408": "sixrsig",
    "361530": "southwest_general_health_center",
    "367253": "southwest_general_health_center",
    "457912": "summit_homecare_services_c",
    "971516": "summit_homecare_services_c",
    "671500": "sun_city_envision_healthcare",
    "743117": "sun_city_envision_healthcare",
    "677238": "sunglo_home_health_services",
    "677734": "sunglo_home_health_services",
    "369330": "sunset_healthcare_services",
    "971603": "sunset_healthcare_services",
    "677911": "thank_you_nurses",
    "748128": "thank_you_nurses",
    "748091": "trinity_health_group",
    "971796": "trinity_health_group",
    "741707": "ultimate_caring_home_health",
    "747326": "ultimate_caring_home_health",
    "747006": "venture_i",
    "971671": "venture_i",
    "741781": "village_home_health_c",
    "747755": "village_home_health_c",
    "671682": "a_care_home_health",
    "679329": "a_care_home_health",
    "361683": "absolute_hospice",
    "741680": "absolute_hospice",
    "458154": "agape_group",
    "671683": "agape_group",
    "671540": "alamo_area_home_hospice",
    "671750": "alamo_area_home_hospice",
    "741682": "allegiance_hospice",
    "748116": "allegiance_hospice",
    "368211": "alta_home_health_care",
    "369254": "alta_home_health_care",
    "747506": "american_star_home_health",
    "971523": "american_star_home_health",
    "741789": "anarcare_home_health_and",
    "747996": "anarcare_home_health_and",
    "679522": "arm_healthcare",
    "971561": "arm_healthcare",
    "971554": "at_twilight_hospice_palliative",
    "971632": "at_twilight_hospice_palliative",
    "747740": "atwell_home_health_services",
    "971553": "atwell_home_health_services",
    "741584": "ayuda_home_health_care",
    "747047": "ayuda_home_health_care",
    "459495": "bestcare_home_health",
    "A91700": "bestcare_home_health",
    "741708": "brite_hospice",
    "A91609": "brite_hospice",
    "367428": "cambridge_home_health_care",
    "368155": "cambridge_home_health_care",
    "361601": "children_s_hospital_medical",
    "367569": "children_s_hospital_medical",
    "361594": "county_of_putnam_office",
    "367076": "county_of_putnam_office",
    "679381": "dependable_home_care",
    "747633": "dependable_home_care",
    "671697": "direct_health_care",
    "677264": "direct_health_care",
    "741582": "edward_s_home_health",
    "747789": "edward_s_home_health",
    "451734": "exclusive_home_health_and",
    "458134": "exclusive_home_health_and",
    "368140": "family_nurse_care_of",
    "368210": "family_nurse_care_of",
    "365668": "fisher_titus_medical_center",
    "367400": "fisher_titus_medical_center",
    "361673": "guardian_angel_home_care",
    "368165": "guardian_angel_home_care",
    "367587": "hhcs",
    "368151": "hhcs",
    "678299": "ims_home_health_care",
    "741746": "ims_home_health_care",
    "679027": "integrated_management_solutions",
    "679029": "integrated_management_solutions",
    "457818": "lhcg_cxxxvii",
    "679657": "lhcg_cxxxvii",
    "457575": "lhcg_xxxiii",
    "458444": "lhcg_xxxiii",
    "458396": "pathfinder_healthcare",
    "678058": "pathfinder_healthcare",
    "679334": "pathfinder_healthcare",
    "679579": "paz_home_health",
    "747945": "paz_home_health",
    "369187": "precious_home_health_care",
    "457969": "precious_home_health_care",
    "741521": "valerian_home_health_and",
    "747935": "valerian_home_health_and",
    "457550": "west_texas_home_health",
    "677617": "west_texas_home_health",
    "741580": "west_texas_home_health",
    ...
    "366004": "anna_maria_of_aurora",
    "675614": "ballinger_memorial_hospital_district",
    "676068": "ballinger_memorial_hospital_district",
    "675714": "baylor_county_hospital_district",
    "675835": "baylor_county_hospital_district",
    "366131": "bellevue_healthcare_group",
    "366365": "bellevue_healthcare_group",
    "675947": "bexar_county_hospital_district",
    "676224": "bexar_county_hospital_district",
    "675282": "booker_hospital_district",
    "675291": "booker_hospital_district",
    "675717": "booker_hospital_district",
    "676333": "booker_hospital_district",
    "676282": "brazos_presbyterian_homes",
    "676423": "brazos_presbyterian_homes",
    "675680": "brentwood_healthcare",
    "675702": "brentwood_healthcare",
    "366459": "brunswick_health_rehabilitation_center",
    "725008": "brunswick_health_rehabilitation_center",
    "675777": "buckner_retirement_services",
    "676109": "buckner_retirement_services",
    "676167": "buckner_retirement_services",
    "366024": "castle_nursing_homes",
    "366333": "castle_nursing_homes",
    "455333": "chambers_county_public_hospital",
    "455554": "chambers_county_public_hospital",
    "455855": "chambers_county_public_hospital",
    "455862": "chambers_county_public_hospital",
    "675078": "chambers_county_public_hospital",
    "675112": "chambers_county_public_hospital",
    "675696": "chambers_county_public_hospital",
    "675961": "chambers_county_public_hospital",
    "676026": "chambers_county_public_hospital",
    "676142": "chambers_county_public_hospital",
    "676309": "chambers_county_public_hospital",
    "676344": "chambers_county_public_hospital",
    "676439": "chambers_county_public_hospital",
    "455675": "childress_county_hospital_district",
    "675279": "childress_county_hospital_district",
    "675350": "childress_county_hospital_district",
    "675478": "childress_county_hospital_district",
    "675945": "childress_county_hospital_district",
    "675970": "childress_county_hospital_district",
    "676389": "childress_county_hospital_district",
    "365306": "chs_lake_erie",
    "365575": "chs_lake_erie",
    "366353": "chs_pataskala",
    "366484": "chs_pataskala",
    "455999": "citizens_medical_center_county",
    "675226": "citizens_medical_center_county",
    "675361": "citizens_medical_center_county",
    "366053": "colonial_senior_services",
    "366232": "colonial_senior_services",
    "366450": "colonial_senior_services",
    "455457": "coryell_county_memorial_hospital",
    "455478": "coryell_county_memorial_hospital",
    "455494": "coryell_county_memorial_hospital",
    "455592": "coryell_county_memorial_hospital",
    "455798": "coryell_county_memorial_hospital",
    "455799": "coryell_county_memorial_hospital",
    "675009": "coryell_county_memorial_hospital",
    "675017": "coryell_county_memorial_hospital",
    "675150": "coryell_county_memorial_hospital",
    "675201": "coryell_county_memorial_hospital",
    "675352": "coryell_county_memorial_hospital",
    "675817": "coryell_county_memorial_hospital",
    "675886": "coryell_county_memorial_hospital",
    "675914": "coryell_county_memorial_hospital",
    "675924": "coryell_county_memorial_hospital",
    "675976": "coryell_county_memorial_hospital",
    "676270": "coryell_county_memorial_hospital",
    "676438": "coryell_county_memorial_hospital",
    "675136": "dallas_county_hospital_district",
    "675151": "dallas_county_hospital_district",
    "675756": "dallas_county_hospital_district",
    "676098": "dallas_county_hospital_district",
    "676128": "dallas_county_hospital_district",
    "676146": "dallas_county_hospital_district",
    "676156": "dallas_county_hospital_district",
    "676178": "dallas_county_hospital_district",
    "676197": "dallas_county_hospital_district",
    "676247": "dallas_county_hospital_district",
    "676275": "dallas_county_hospital_district",
    "676276": "dallas_county_hospital_district",
    "676293": "dallas_county_hospital_district",
    "676300": "dallas_county_hospital_district",
    "676315": "dallas_county_hospital_district",
    "676319": "dallas_county_hospital_district",
    "676429": "dallas_county_hospital_district",
    "676464": "dallas_county_hospital_district",
    "675128": "decatur_hospital_authority",
    "675550": "decatur_hospital_authority",
    "675622": "decatur_hospital_authority",
    "675891": "decatur_hospital_authority",
    "676101": "decatur_hospital_authority",
    "676104": "decatur_hospital_authority",
    "676143": "decatur_hospital_authority",
    "676209": "decatur_hospital_authority",
    "676255": "decatur_hospital_authority",
    "455513": "dewitt_medical_district",
    "455703": "dewitt_medical_district",
    "455725": "dewitt_medical_district",
    "675053": "dewitt_medical_district",
    "675071": "dewitt_medical_district",
    "676107": "dewitt_medical_district",
    "676245": "dewitt_medical_district",
    "455576": "eastland_memorial_hospital_district",
    "455637": "eastland_memorial_hospital_district",
    "455934": "eastland_memorial_hospital_district",
    "675004": "eastland_memorial_hospital_district",
    "675111": "eastland_memorial_hospital_district",
    "675272": "eastland_memorial_hospital_district",
    "675579": "eastland_memorial_hospital_district",
    "675593": "eastland_memorial_hospital_district",
    "675597": "eastland_memorial_hospital_district",
    "675611": "eastland_memorial_hospital_district",
    "675703": "eastland_memorial_hospital_district",
    "675972": "eastland_memorial_hospital_district",
    "676023": "eastland_memorial_hospital_district",
    "676029": "eastland_memorial_hospital_district",
    "676039": "eastland_memorial_hospital_district",
    "676161": "eastland_memorial_hospital_district",
    "365759": "eliza_jennings",
    "366379": "eliza_jennings",
    "455463": "fannin_county_hospital_authority",
    "455532": "fannin_county_hospital_authority",
    "455573": "fannin_county_hospital_authority",
    "455586": "fannin_county_hospital_authority",
    "455625": "fannin_county_hospital_authority",
    "455638": "fannin_county_hospital_authority",
    "455651": "fannin_county_hospital_authority",
    "455835": "fannin_county_hospital_authority",
    "455925": "fannin_county_hospital_authority",
    "675105": "fannin_county_hospital_authority",
    "675196": "fannin_county_hospital_authority",
    "675327": "fannin_county_hospital_authority",
    "675329": "fannin_county_hospital_authority",
    "675406": "fannin_county_hospital_authority",
    "675438": "fannin_county_hospital_authority",
    "675444": "fannin_county_hospital_authority",
    "675460": "fannin_county_hospital_authority",
    "675471": "fannin_county_hospital_authority",
    "675496": "fannin_county_hospital_authority",
    "675561": "fannin_county_hospital_authority",
    "675689": "fannin_county_hospital_authority",
    "675755": "fannin_county_hospital_authority",
    "675816": "fannin_county_hospital_authority",
    "675933": "fannin_county_hospital_authority",
    "676042": "fannin_county_hospital_authority",
    "676148": "fannin_county_hospital_authority",
    "676154": "fannin_county_hospital_authority",
    "676190": "fannin_county_hospital_authority",
    "676229": "fannin_county_hospital_authority",
    "676257": "fannin_county_hospital_authority",
    "676385": "fannin_county_hospital_authority",
    "676394": "fannin_county_hospital_authority",
    "676406": "fannin_county_hospital_authority",
    "676478": "fannin_county_hospital_authority",
    "455762": "frio_hospital_district",
    "455815": "frio_hospital_district",
    "675025": "frio_hospital_district",
    "675034": "frio_hospital_district",
    "675109": "frio_hospital_district",
    "675133": "frio_hospital_district",
    "675171": "frio_hospital_district",
    "675532": "frio_hospital_district",
    "675557": "frio_hospital_district",
    "675700": "frio_hospital_district",
    "676025": "frio_hospital_district",
    "676327": "frio_hospital_district",
    "676490": "frio_hospital_district",
    "676497": "frio_hospital_district",
    "745017": "frio_hospital_district",
    "455523": "guadalupe_county_hospital_board",
    "455618": "guadalupe_county_hospital_board",
    "455689": "guadalupe_county_hospital_board",
    "455724": "guadalupe_county_hospital_board",
    "455754": "guadalupe_county_hospital_board",
    "675509": "guadalupe_county_hospital_board",
    "675651": "guadalupe_county_hospital_board",
    "675915": "guadalupe_county_hospital_board",
    "676158": "guadalupe_county_hospital_board",
    "676220": "guadalupe_county_hospital_board",
    "676281": "guadalupe_county_hospital_board",
    "366143": "h_g_nursing_homes",
    "366233": "h_g_nursing_homes",
    "455490": "hamilton_county_hospital_district",
    "455726": "hamilton_county_hospital_district",
    "455731": "hamilton_county_hospital_district",
    "455954": "hamilton_county_hospital_district",
    "455962": "hamilton_county_hospital_district",
    "455986": "hamilton_county_hospital_district",
    "675020": "hamilton_county_hospital_district",
    "675044": "hamilton_county_hospital_district",
    "675134": "hamilton_county_hospital_district",
    "675138": "hamilton_county_hospital_district",
    "675312": "hamilton_county_hospital_district",
    "675388": "hamilton_county_hospital_district",
    "675453": "hamilton_county_hospital_district",
    "675690": "hamilton_county_hospital_district",
    "675806": "hamilton_county_hospital_district",
    "675820": "hamilton_county_hospital_district",
    "675870": "hamilton_county_hospital_district",
    "675883": "hamilton_county_hospital_district",
    "675908": "hamilton_county_hospital_district",
    "675959": "hamilton_county_hospital_district",
    "676007": "hamilton_county_hospital_district",
    "676046": "hamilton_county_hospital_district",
    "676086": "hamilton_county_hospital_district",
    "676095": "hamilton_county_hospital_district",
    "676188": "hamilton_county_hospital_district",
    "676246": "hamilton_county_hospital_district",
    "676267": "hamilton_county_hospital_district",
    "676271": "hamilton_county_hospital_district",
    "676294": "hamilton_county_hospital_district",
    "676352": "hamilton_county_hospital_district",
    "676432": "hamilton_county_hospital_district",
    "676448": "hamilton_county_hospital_district",
    "676471": "hamilton_county_hospital_district",
    "676488": "hamilton_county_hospital_district",
    "366329": "hampton_woods_nursing_center",
    "366442": "hampton_woods_nursing_center",
    "675527": "hansford_county_hospital_district",
    "675853": "hansford_county_hospital_district",
    "676105": "hansford_county_hospital_district",
    "365337": "hcf_of_fox_run",
    "365896": "hcf_of_fox_run",
    "45F603": "hemphill_county_hospital_district",
    "675904": "hemphill_county_hospital_district",
    "455684": "hopkins_county_hospital_district",
    "675330": "hopkins_county_hospital_district",
    "676368": "hopkins_county_hospital_district",
    "676453": "hopkins_county_hospital_district",
    "365676": "levering_management",
    "365911": "levering_management",
    "455423": "liberty_county_hospital_district",
    "455745": "liberty_county_hospital_district",
    "675065": "liberty_county_hospital_district",
    "675132": "liberty_county_hospital_district",
    "675177": "liberty_county_hospital_district",
    "675183": "liberty_county_hospital_district",
    "675220": "liberty_county_hospital_district",
    "675230": "liberty_county_hospital_district",
    "675267": "liberty_county_hospital_district",
    "675358": "liberty_county_hospital_district",
    "675365": "liberty_county_hospital_district",
    "675695": "liberty_county_hospital_district",
    "675743": "liberty_county_hospital_district",
    "675900": "liberty_county_hospital_district",
    "675962": "liberty_county_hospital_district",
    "675998": "liberty_county_hospital_district",
    "676051": "liberty_county_hospital_district",
    "676081": "liberty_county_hospital_district",
    "676108": "liberty_county_hospital_district",
    "676123": "liberty_county_hospital_district",
    "676155": "liberty_county_hospital_district",
    "676194": "liberty_county_hospital_district",
    "676218": "liberty_county_hospital_district",
    "676230": "liberty_county_hospital_district",
    "676251": "liberty_county_hospital_district",
    "676341": "liberty_county_hospital_district",
    "676362": "liberty_county_hospital_district",
    "676455": "liberty_county_hospital_district",
    "365077": "macintosh_company",
    "365556": "macintosh_company",
    "365350": "maple_knoll_communities",
    "366282": "maple_knoll_communities",
    "455608": "maverick_county_hospital_district",
    "455850": "maverick_county_hospital_district",
    "675002": "maverick_county_hospital_district",
    "675030": "maverick_county_hospital_district",
    "675428": "maverick_county_hospital_district",
    "675458": "maverick_county_hospital_district",
    "675502": "maverick_county_hospital_district",
    "675556": "maverick_county_hospital_district",
    "675748": "maverick_county_hospital_district",
    "676332": "maverick_county_hospital_district",
    "676408": "maverick_county_hospital_district",
    "455676": "medina_county_hospital_district",
    "455796": "medina_county_hospital_district",
    "455869": "medina_county_hospital_district",
    "675974": "medina_county_hospital_district",
    "676240": "medina_county_hospital_district",
    "675423": "memorial_medical_center",
    "676097": "memorial_medical_center",
    "676201": "memorial_medical_center",
    "676481": "memorial_medical_center",
    "366144": "mennonite_memorial_home",
    "366402": "mennonite_memorial_home",
    "676348": "midland_county_hospital_district",
    "676430": "midland_county_hospital_district",
    "365776": "morning_view_delaware",
    "366494": "morning_view_delaware",
    "455569": "nacogdoches_county_hospital_district",
    "455673": "nacogdoches_county_hospital_district",
    "675729": "nacogdoches_county_hospital_district",
    "676092": "nacogdoches_county_hospital_district",
    "676187": "nacogdoches_county_hospital_district",
    "455626": "nocona_hospital_district",
    "455653": "nocona_hospital_district",
    "455861": "nocona_hospital_district",
    "675367": "nocona_hospital_district",
    "675447": "nocona_hospital_district",
    "675754": "nocona_hospital_district",
    "676074": "nocona_hospital_district",
    "676144": "nocona_hospital_district",
    "676179": "nocona_hospital_district",
    "676279": "nocona_hospital_district",
    "676390": "nocona_hospital_district",
    "676415": "nocona_hospital_district",
    "676424": "nocona_hospital_district",
    "676485": "nocona_hospital_district",
    "455770": "oakbend_medical_center",
    "455800": "oakbend_medical_center",
    "675277": "oakbend_medical_center",
    "675519": "oakbend_medical_center",
    "675606": "oakbend_medical_center",
    "675799": "oakbend_medical_center",
    "675901": "oakbend_medical_center",
    "676236": "oakbend_medical_center",
    "676258": "oakbend_medical_center",
    "676264": "oakbend_medical_center",
    "676290": "oakbend_medical_center",
    "676298": "oakbend_medical_center",
    "676337": "oakbend_medical_center",
    "676396": "oakbend_medical_center",
    "676495": "oakbend_medical_center",
    "366116": "ohio_masonic_home",
    "366240": "ohio_masonic_home",
    "455416": "olney_hamilton_hospital_district",
    "455965": "olney_hamilton_hospital_district",
    "365433": "omni_manor",
    "365555": "omni_manor",
    "365695": "omni_manor",
    "365715": "omni_manor",
    ...
    "366375": "omni_manor",
    "366460": "omni_manor",
    "455572": "palo_pinto_county_hospital",
    "455957": "palo_pinto_county_hospital",
    "675153": "palo_pinto_county_hospital",
    "675906": "palo_pinto_county_hospital",
    "675988": "parker_county_hospital_district",
    "676212": "parker_county_hospital_district",
    "676365": "parker_county_hospital_district",
    "676499": "parker_county_hospital_district",
    "365762": "r_j_investment",
    "366426": "r_j_investment",
    "45E312": "san_antonio_health_service",
    "45E341": "san_antonio_health_service",
    "675338": "silsbee_oaks_health_care",
    "676008": "silsbee_oaks_health_care",
    "675434": "smithville_hospital_authority",
    "676180": "smithville_hospital_authority",
    "676222": "smithville_hospital_authority",
    "676280": "smithville_hospital_authority",
    "676299": "smithville_hospital_authority",
    "455497": "south_limestone_hospital_district",
    "455910": "south_limestone_hospital_district",
    "675142": "south_limestone_hospital_district",
    "675884": "south_limestone_hospital_district",
    "675903": "south_limestone_hospital_district",
    "675969": "south_limestone_hospital_district",
    "676071": "south_limestone_hospital_district",
    "676096": "south_limestone_hospital_district",
    "676192": "south_limestone_hospital_district",
    "676239": "south_limestone_hospital_district",
    "676349": "south_limestone_hospital_district",
    "676358": "south_limestone_hospital_district",
    "676382": "south_limestone_hospital_district",
    "676386": "south_limestone_hospital_district",
    "676409": "south_limestone_hospital_district",
    "676463": "south_limestone_hospital_district",
    "676037": "starr_county_hospital_district",
    "676119": "starr_county_hospital_district",
    "675857": "state_of_texas_veterans",
    "675863": "state_of_texas_veterans",
    "675873": "state_of_texas_veterans",
    "675874": "state_of_texas_veterans",
    "676060": "state_of_texas_veterans",
    "676063": "state_of_texas_veterans",
    "676157": "state_of_texas_veterans",
    "676311": "state_of_texas_veterans",
    "676479": "state_of_texas_veterans",
    "745057": "state_of_texas_veterans",
    "455727": "stephens_memorial_hospital_district",
    "455733": "stephens_memorial_hospital_district",
    "675666": "stephens_memorial_hospital_district",
    "675888": "stephens_memorial_hospital_district",
    "676458": "stephens_memorial_hospital_district",
    "455551": "stratford_hospital_district",
    "455771": "stratford_hospital_district",
    "675346": "stratford_hospital_district",
    "675498": "stratford_hospital_district",
    "675553": "stratford_hospital_district",
    "675649": "stratford_hospital_district",
    "675716": "stratford_hospital_district",
    "675937": "stratford_hospital_district",
    "675981": "stratford_hospital_district",
    "676010": "stratford_hospital_district",
    "676477": "stratford_hospital_district",
    "455477": "sweeny_hospital_district",
    "675663": "sweeny_hospital_district",
    "675975": "sweeny_hospital_district",
    "675996": "sweeny_hospital_district",
    "676323": "sweeny_hospital_district",
    "365494": "united_church_homes",
    "365669": "united_church_homes",
    "365777": "united_church_homes",
    "365979": "united_church_homes",
    "365997": "united_church_homes",
    "455503": "uvalde_county_hospital_authority",
    "455528": "uvalde_county_hospital_authority",
    "455597": "uvalde_county_hospital_authority",
    "455628": "uvalde_county_hospital_authority",
    "455652": "uvalde_county_hospital_authority",
    "455732": "uvalde_county_hospital_authority",
    "455804": "uvalde_county_hospital_authority",
    "455817": "uvalde_county_hospital_authority",
    "455917": "uvalde_county_hospital_authority",
    "455974": "uvalde_county_hospital_authority",
    "675076": "uvalde_county_hospital_authority",
    "675104": "uvalde_county_hospital_authority",
    "675162": "uvalde_county_hospital_authority",
    "675181": "uvalde_county_hospital_authority",
    "675396": "uvalde_county_hospital_authority",
    "675536": "uvalde_county_hospital_authority",
    "675678": "uvalde_county_hospital_authority",
    "675739": "uvalde_county_hospital_authority",
    "675909": "uvalde_county_hospital_authority",
    "676153": "uvalde_county_hospital_authority",
    "676160": "uvalde_county_hospital_authority",
    "676346": "uvalde_county_hospital_authority",
    "676414": "uvalde_county_hospital_authority",
    "676418": "uvalde_county_hospital_authority",
    "676441": "uvalde_county_hospital_authority",
    "745058": "uvalde_county_hospital_authority",
    "745060": "uvalde_county_hospital_authority",
    "455599": "val_verde_county_hospital",
    "455797": "val_verde_county_hospital",
    "675395": "val_verde_county_hospital",
    "675677": "val_verde_county_hospital",
    "675785": "val_verde_county_hospital",
    "676083": "val_verde_county_hospital",
    "676133": "val_verde_county_hospital",
    "676419": "val_verde_county_hospital",
    "676465": "val_verde_county_hospital",
    "745049": "val_verde_county_hospital",
    "455690": "west_coke_county_hospital",
    "675599": "west_coke_county_hospital",
    "676195": "west_coke_county_hospital",
    "676208": "west_coke_county_hospital",
    "676244": "west_coke_county_hospital",
    "676274": "west_coke_county_hospital",
    "455390": "west_wharton_county_hospital",
    "455509": "west_wharton_county_hospital",
    "455536": "west_wharton_county_hospital",
    "455763": "west_wharton_county_hospital",
    "455840": "west_wharton_county_hospital",
    "455895": "west_wharton_county_hospital",
    "455915": "west_wharton_county_hospital",
    "675028": "west_wharton_county_hospital",
    "675051": "west_wharton_county_hospital",
    "675103": "west_wharton_county_hospital",
    "675118": "west_wharton_county_hospital",
    "675145": "west_wharton_county_hospital",
    "675326": "west_wharton_county_hospital",
    "675402": "west_wharton_county_hospital",
    "675417": "west_wharton_county_hospital",
    "675446": "west_wharton_county_hospital",
    "675479": "west_wharton_county_hospital",
    "675489": "west_wharton_county_hospital",
    "675494": "west_wharton_county_hospital",
    "675525": "west_wharton_county_hospital",
    "675568": "west_wharton_county_hospital",
    "675630": "west_wharton_county_hospital",
    "675709": "west_wharton_county_hospital",
    "675802": "west_wharton_county_hospital",
    "675823": "west_wharton_county_hospital",
    "675856": "west_wharton_county_hospital",
    "675858": "west_wharton_county_hospital",
    "675897": "west_wharton_county_hospital",
    "675899": "west_wharton_county_hospital",
    "675928": "west_wharton_county_hospital",
    "675938": "west_wharton_county_hospital",
    "675944": "west_wharton_county_hospital",
    "675995": "west_wharton_county_hospital",
    "676004": "west_wharton_county_hospital",
    "676012": "west_wharton_county_hospital",
    "676014": "west_wharton_county_hospital",
    "676045": "west_wharton_county_hospital",
    "676117": "west_wharton_county_hospital",
    "676136": "west_wharton_county_hospital",
    "676172": "west_wharton_county_hospital",
    "676186": "west_wharton_county_hospital",
    "676226": "west_wharton_county_hospital",
    "676297": "west_wharton_county_hospital",
    "676325": "west_wharton_county_hospital",
    "676347": "west_wharton_county_hospital",
    "676363": "west_wharton_county_hospital",
    "676372": "west_wharton_county_hospital",
    "676374": "west_wharton_county_hospital",
    "676399": "west_wharton_county_hospital",
    "676442": "west_wharton_county_hospital",
    "676467": "west_wharton_county_hospital",
    "676493": "west_wharton_county_hospital",
    "745056": "west_wharton_county_hospital",
    "365988": "willow_brook_christian_services",
    "366246": "willow_brook_christian_services",
    "455515": "winnie_stowell_hospital_district",
    "455561": "winnie_stowell_hospital_district",
    "455646": "winnie_stowell_hospital_district",
    "455682": "winnie_stowell_hospital_district",
    "455715": "winnie_stowell_hospital_district",
    "455753": "winnie_stowell_hospital_district",
    "455757": "winnie_stowell_hospital_district",
    "455761": "winnie_stowell_hospital_district",
    "455831": "winnie_stowell_hospital_district",
    "455876": "winnie_stowell_hospital_district",
    "455879": "winnie_stowell_hospital_district",
    "455906": "winnie_stowell_hospital_district",
    "455952": "winnie_stowell_hospital_district",
    "675095": "winnie_stowell_hospital_district",
    "675222": "winnie_stowell_hospital_district",
    "675445": "winnie_stowell_hospital_district",
    "675484": "winnie_stowell_hospital_district",
    "675538": "winnie_stowell_hospital_district",
    "675540": "winnie_stowell_hospital_district",
    "675543": "winnie_stowell_hospital_district",
    "675603": "winnie_stowell_hospital_district",
    "675633": "winnie_stowell_hospital_district",
    "675648": "winnie_stowell_hospital_district",
    "675691": "winnie_stowell_hospital_district",
    "675701": "winnie_stowell_hospital_district",
    "675759": "winnie_stowell_hospital_district",
    "675790": "winnie_stowell_hospital_district",
    "675892": "winnie_stowell_hospital_district",
    "675930": "winnie_stowell_hospital_district",
    "676006": "winnie_stowell_hospital_district",
    "676011": "winnie_stowell_hospital_district",
    "676072": "winnie_stowell_hospital_district",
    "676087": "winnie_stowell_hospital_district",
    "676122": "winnie_stowell_hospital_district",
    "676177": "winnie_stowell_hospital_district",
    "676278": "winnie_stowell_hospital_district",
    "676304": "winnie_stowell_hospital_district",
    "676376": "winnie_stowell_hospital_district",
    "676405": "winnie_stowell_hospital_district",
    "676417": "winnie_stowell_hospital_district",
    "676437": "winnie_stowell_hospital_district",
    "676484": "winnie_stowell_hospital_district",
