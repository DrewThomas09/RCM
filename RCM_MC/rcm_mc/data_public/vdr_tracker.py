...
def _build_qa() -> List[QAItem]:
    return [
        ...
        QAItem("QA-007", "OIG inquiry 2024 â background details", "partial", 4, True, "medium"),
        QAItem("QA-008", "Management adjustments in QoE", "thorough", 2, False, "material"),
        QAItem("QA-009", "DOL investigation â any open matters?", "deflected", 6, True, "medium"),
...
def _build_critical_path() -> List[CriticalPath]:
    return [
        ...
        CriticalPath("Phase I environmental (DR-023)", "Facilities (seller)", "—",
        ...
        CriticalPath("Litigation detail (DR-010)", "General Counsel (seller)", "—",
                     "2026-04-25", "in progress", "high - complaint copies still outstanding"),
        CriticalPath("IT architecture (DR-014)", "CIO (seller)", "—",
        ...
        CriticalPath("Compliance audit (DR-011)", "Compliance Officer", "—",
...
def _build_materiality() -> List[MaterialityFlag]:
    return [
        MaterialityFlag("BCBS payer concentration 22% â renewal 2027",
        ...
        MaterialityFlag("Cyber incident Feb 2024 â insufficient disclosure detail",
                        "IT/Cyber", "critical", "Further DD required; R&W insurance exclusion possible", "open"),
        MaterialityFlag("OIG 2024 inquiry â closed with no action",
        ...
        MaterialityFlag("3 pending malpractice â all insured",
                        "Legal", "low", "Standard; within insurance limits", "resolved"),
        MaterialityFlag("Q3 2025 revenue variance â one-time concessions",
                        "Financial", "medium", "QoE normalization accepted", "resolved"),
        MaterialityFlag("Key MD rollover â 2 of 4 top MDs not yet committed",
...
def compute_vdr_tracker() -> VDRResult:
    ...
    return VDRResult(
        deal_name="Project Azalea â GI Network SE",
