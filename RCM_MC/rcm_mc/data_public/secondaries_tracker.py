...
def _build_cv_economics() -> List[CVEconomics]:
    return [
        ...
        CVEconomics("GP Rollover", "Proportional GP interest rolls into CV alongside LPs who choose roll",
                    "Typically 100.0% of GP interest rolls", "Signals alignment"),
        CVEconomics("Fund Fees (Reset)", "New carry clock, typically 20.0% over 8.0% preferred return",
                    "Management fee 1.5-2.0% of NAV", "Lower fee structure than primary funds"),
        CVEconomics("Carry Waterfall", "Standard American waterfall with new 8.0% preferred return",
                    "Catch-up typically 50.0% or 100.0% of distributions after preferred return",
