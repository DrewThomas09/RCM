...
def _build_milestones() -> List[TimelineMilestone]:
    return [
        ...
        TimelineMilestone("Project Cedar — Cardiology", "Dallas — cath lab unification", "2026-06-30", "",
                          "on track", 0),
        TimelineMilestone("Project Willow — Fertility", "Florida — lab consolidation Step 1", "2026-03-31", "2026-04-10",
                          "late", 10),
        ...
        TimelineMilestone("Project Spruce — Radiology", "Midwest Imaging — AI platform rollout", "2026-03-15", "2026-03-15",
                          "on time", 0),
        TimelineMilestone("Project Basil — Dental DSO", "Midwest Dental — PMS migration Step 1", "2026-05-31", "",
                          "on track", 0),
