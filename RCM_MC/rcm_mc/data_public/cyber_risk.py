...
def _build_ransomware() -> List[RansomwarePrep]:
    return [
        ...
        RansomwarePrep("EDR on All Endpoints", "strong", 1, 0, "continuous", "100.0% coverage"),
        RansomwarePrep("Email Security (Phishing Defense)", "strong", 0, 0, "continuous", "Proofpoint + Abnormal"),
        RansomwarePrep("MFA on All Privileged Access", "moderate", 0, 0, "2024-12-08", "85.0% coverage, service accts remaining"),
        RansomwarePrep("Ransomware Tabletop Exercise", "moderate", 0, 0, "2024-10-01", "annually — increase to semi-annual"),
        RansomwarePrep("Cyber Insurance (Ransomware Cov)", "strong", 0, 0, "2025-01-01", "$50.00M aggregate — renewal Q1 2026"),
