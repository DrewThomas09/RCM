...
def _build_searches() -> List[SearchPipeline]:
    return [
        SearchPipeline("CEO", "Project Azalea — GI Network SE", "Gastroenterology",
                       "2026-02-15", "finalist interviews", 5, "2026-06-01", "Spencer Stuart", "$1.8-2.2M + 4.0% equity"),
        SearchPipeline("COO", "Project Meridian — Multi-specialty", "Multi-specialty",
                       "2026-03-10", "candidate sourcing", 8, "2026-07-15", "Russell Reynolds", "$1.0-1.4M + 2.0% equity"),
        ...
        SearchPipeline("CFO", "Project Ridge — Cardiology Services", "Cardiology",
                       "2026-03-20", "early sourcing", 4, "2026-08-15", "Heidrick & Struggles", "$0.7-0.9M + 1.0% equity"),
        SearchPipeline("CEO", "Project Sierra — Home Health Platform", "Home Health",
                       "2026-03-01", "final interviews", 3, "2026-05-15", "Russell Reynolds", "$1.6-1.9M + 3.0% equity"),
...
def _build_comp() -> List[CompensationBench]:
    return [
        ...
        CompensationBench("CFO", "Platform ($500.00M-$1.00B rev)", 550, 750, 1050, 60, 1.5, 4),
