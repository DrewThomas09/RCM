...
def _build_pipeline() -> List[LPPipelineEntry]:
    return [
        LPPipelineEntry("CalPERS", "Public Pension", True, 350.0, 95.0, "hard circled", "2026-03-25",
                        "Sr. Partner", "Confirmed $350.00M across Fund VI + CV. Docs at counsel."),
        ...
        LPPipelineEntry("HOOPP", "Canadian Pension", True, 185.0, 88.0, "due diligence complete", "2026-03-15",
                        "Mgr Director", "Approved pending committee. $185.00M commitment."),
...
def _build_terms() -> List[FundTermsMatrix]:
    return [
        ...
        FundTermsMatrix("Carried Interest", "20.0% over 8.0% hurdle (ILPA catch-up)", "20.0% w/ 7.0-8.0% hurdle",
                        "agreed", "flat"),
        FundTermsMatrix("Hurdle Rate", "8.0% preferred return (compounded)", "7.0-8.0%", "agreed", "slight up"),
        ...
        FundTermsMatrix("Side Letter — MFN", "Full MFN for cornerstones + $500.00M+", "MFN for large LPs", "agreed", "LP favoring"),
