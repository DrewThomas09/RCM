...
DATABASES: List[Dict[str, str]] = [
    ...
    {"id": "brfss", "name": "BRFSS — Behavioral Risk Factor Surveillance System", "agency": "cdc",
     ...
     "relevance": "State/market risk-factor and prevalence estimates."},
    {"id": "cdi", "name": "CDI — U.S. Chronic Disease Indicators", "agency": "cdc",
     "access": "estate", "wired": "cdc_data",
     "url": "https://www.cdc.gov/cdi/",
     "blurb": "Standardized cross-state chronic-disease measure set — diabetes, CVD, cancer, obesity, COPD, mental health, tobacco.",
     "relevance": "State-level chronic-disease burden and prevalence for market sizing and care-management diligence."},
