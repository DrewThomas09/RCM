...
def _landing() -> str:
    ...
    body = (
        ...
        f'<select name="dataset" required aria-label="CCD fixture" style="width:100%;padding:6px 8px;'
        ...
        f'<input name="train_fraction" value="0.7" aria-label="Train fraction (0-1)" '
