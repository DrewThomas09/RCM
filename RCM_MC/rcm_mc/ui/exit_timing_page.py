...
def _scoped_styles() -> str:
    css = """
.et-wrap{{font-family:var(--sc-sans,"Helvetica Neue",Arial,sans-serif);}}
...
def _curve_svg(
    ...
    return (
        ...
        f'font-weight="700" font-family="Inter Tight, system-ui, sans-serif">'
...
def _landing() -> str:
    form = (
        ...
        f'aria-label="Annual EBITDA growth" '
        f'style="width:100%;padding:5px 7px;background:{P["panel_alt"]};'
        f'color:{P["text"]};border:1px solid {P["border"]};'
        f'font-family:\'JetBrains Mono\',monospace;font-size:11px;"></div>'
        f'<div><label style="font-size:9px;color:{P["text_faint"]};'
        ...
        f'aria-label="Peer median multiple (x)" '
        f'style="width:100%;padding:5px 7px;background:{P["panel_alt"]};'
        f'color:{P["text"]};border:1px solid {P["border"]};'
        f'font-family:\'JetBrains Mono\',monospace;font-size:11px;"></div>'
        f'<div><label style="font-size:9px;color:{P["text_faint"]};'
        ...
        f'<select name="sector_sentiment" aria-label="Sector sentiment" '
        f'style="width:100%;padding:5px 7px;'
