...
def render_data_refresh_page(db_path: str) -> str:
    ...
    table = (
        ...
        '<thead><tr>'
        '<th data-col="0">Source</th>'
        '<th data-col="1">Freshness</th>'
        '<th data-col="2" class="wc-hide-sm">Records</th>'
        '<th data-col="3" class="wc-hide-sm">Status</th>'
        '<th data-col="4">Job</th>'
