...
.fa-pill.is-on{border-color:var(--sc-navy,#0b2341);background:var(--sc-bone,#f2ede3);}
...
.fa-tablewrap .ck-data-table thead th{position:sticky;top:0;z-index:1;background:var(--sc-bone,#f2ede3);}
