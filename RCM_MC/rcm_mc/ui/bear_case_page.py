...
"""
    ...
    sketch = (
        ...
        'expected Q3; $4.20M EBITDA at risk under 65bps stress.</div>'
        '</div>'
        ...
        'letter-spacing:0.1em;text-transform:uppercase;">'
        'CREDIT · HIGH</div>'
        '<div style="font-size:13px;">Covenant headroom drops to 8.0% '
        'under a 10.0% denial-rate shock; trip prob 18.0%.</div>'
        '</div>'
        '<div style="font-size:11px;color:var(--sc-text-faint);'
