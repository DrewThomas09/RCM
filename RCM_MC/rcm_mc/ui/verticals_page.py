...
def render_verticals() -> str:
    ...
    body = (
        ...
        f'<p style="font-size:12px;color:{PALETTE["text_muted"]};margin-top:6px;">'
        f'Looking for clinical-specialty profiles (ophthalmology, cardiology, '
        f'urology, oncology, OB-GYN, ...)? See the '
        f'<a href="/clinical-verticals">Clinical Verticals Reference</a> — '
        f'13 specialty verticals with codes, epidemiology, and CY2026 '
        f'reimbursement.</p>'
        f'</div>'
        f'{cards}'
        f'{registry_html}'
