...
_CORPUS_NAV = [
    ...
    {"label": "Thesis Pipeline", "href": "/diligence/thesis-pipeline", "icon": "▶"},
    {"label": "Checklist",       "href": "/diligence/checklist",  "icon": "▣"},
    {"label": "Ingestion",       "href": "/diligence/ingest",     "icon": "▤"},
    {"label": "Benchmarks",      "href": "/diligence/benchmarks", "icon": "▦"},
    {"label": "HCRIS X-Ray",     "href": "/diligence/hcris-xray", "icon": "◎"},
    ...
    {"label": "Deal Autopsy",    "href": "/diligence/deal-autopsy", "icon": "▥"},
    {"label": "Physician Attrition", "href": "/diligence/physician-attrition", "icon": "◉"},
    {"label": "Provider Economics", "href": "/diligence/physician-eu", "icon": "◈"},
    {"label": "Management",      "href": "/diligence/management", "icon": "▣"},
    {"label": "Deal MC",         "href": "/diligence/deal-mc",    "icon": "▦"},
    {"label": "Exit Timing",     "href": "/diligence/exit-timing", "icon": "◉"},
    {"label": "Reg Calendar",    "href": "/diligence/regulatory-calendar", "icon": "▤"},
    {"label": "Covenant Stress", "href": "/diligence/covenant-stress", "icon": "▥"},
    {"label": "Bridge Audit",    "href": "/diligence/bridge-audit", "icon": "◉"},
    {"label": "Bear Case",       "href": "/diligence/bear-case",  "icon": "▣"},
    {"label": "Payer Stress",    "href": "/diligence/payer-stress", "icon": "▤"},
...
_PALETTE_ENTRIES = [
    ...
    ("NAV", "Morning digest preview",   "/digest/morning"),
