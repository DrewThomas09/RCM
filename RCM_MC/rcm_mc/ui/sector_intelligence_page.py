...
_SECTORS: List[Tuple[str, str, str, str, List[Tuple[str, str]]]] = [
    ...
    ("Home Health", "roadmap", "Phase 2",
     "Strong CMS data (Home Health Compare + PUF). Medicare-certified only.",
     []),
    ("Hospice", "roadmap", "Phase 2",
     "Strong CMS data (Hospice Compare + PUF). Medicare hospice only.", []),
