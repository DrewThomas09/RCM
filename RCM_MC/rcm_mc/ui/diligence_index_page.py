...
def render_diligence_index() -> str:
    ...
    css = (
        ...
        '.ck-dil-pillar{background:#fff;border:1px solid var(--sc-rule,#d6cfc3);'
        ...
        'border-bottom:1px solid var(--sc-rule,#d6cfc3);padding-bottom:16px;}'
        ...
        'padding:12px 0;border-bottom:1px solid var(--sc-rule,#d6cfc3);'
        ...
        '.ck-dil-link:hover{background:var(--sc-bone,#ece6db);'
        'padding-left:16px;}'
