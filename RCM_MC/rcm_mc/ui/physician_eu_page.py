...
def render_physician_eu_page(
    ...
    # ck_page_explainer above already discloses the data basis ("synthetic for
    # prototype; wire to actual practice-management system to go live"), so a
    # second stacked box under the title was redundant clunk.
