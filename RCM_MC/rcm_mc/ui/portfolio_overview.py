...
.po-empty-cta a.ghost{background:transparent;
  border:1px solid var(--ink,#16263a);color:var(--ink,#16263a);}
    ...
    table = (
        ...
        f'<th class="num">'
        f'{metric_label_link("Denial", _LABEL_TO_GLOSSARY_KEY["Denial"])}</th>'
        f'<th class="num">'
        f'{metric_label_link("AR", _LABEL_TO_GLOSSARY_KEY["AR"])}</th>'
        f'<th class="num">'
        f'{metric_label_link("NPR", _LABEL_TO_GLOSSARY_KEY["NPR"])}</th>'
        f'<th>Alerts</th>'
