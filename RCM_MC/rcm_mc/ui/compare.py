...
def render_comparison(
    ...
    *,
    ...
    css = (
        ...
        'margin-top:2px;}'
        '.cmp-winner{color:var(--theme-positive,#10b981);font-weight:600;}'
        '.cmp-loser{color:#9ca3af;}'
        '.cmp-delta{font-size:10px;color:#9ca3af;'
        'margin-left:6px;}'
        '.cmp-delta.up{color:var(--theme-positive,#10b981);}'
        '.cmp-delta.down{color:var(--theme-negative,#ef4444);}'
        '.cmp-arrow{margin-right:4px;font-size:10px;}'
        '.cmp-table a{color:var(--theme-accent,#60a5fa);'
