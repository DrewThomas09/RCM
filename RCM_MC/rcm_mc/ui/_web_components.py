...
.wc-table thead th.wc-sorted-asc::after  { content: " ↑"; color: var(--theme-accent,var(--theme-accent,#1f4e78)); }
.wc-table thead th.wc-sorted-desc::after { content: " ↓"; color: var(--theme-accent,var(--theme-accent,#1f4e78)); }
...
.wc-filter:focus { outline: none; border-color: var(--theme-accent,var(--theme-accent,#1f4e78));
...
.wc-cmdk-row:hover, .wc-cmdk-row.wc-cmdk-active {
    background: #f0f6fc; border-left-color: var(--theme-accent,var(--theme-accent,#1f4e78)); }
.wc-cmdk-id { font-family: monospace; color: var(--theme-accent,var(--theme-accent,#1f4e78));
...
.wc-spinner { display: none; width: 16px; height: 16px; border: 2px solid #e5e7eb;
    border-top-color: var(--theme-accent,var(--theme-accent,#1f4e78)); border-radius: 50%;
...
.wc-btn { display: inline-block; padding: 8px 16px; border-radius: 6px;
    ...
    cursor: pointer; border: 1px solid var(--theme-accent,var(--theme-accent,#1f4e78)); transition: background 0.1s; }
.wc-btn-primary { background: var(--theme-accent,var(--theme-accent,#1f4e78)); color: #fff; }
.wc-btn-primary:hover { background: #1a3f61; }
.wc-btn-secondary { background: #fff; color: var(--theme-accent,var(--theme-accent,#1f4e78)); }
        ...
        if (tableId) {
            ...
            if (counter) {
                ...
                if (q && visible !== total) {
                    ...
                    counter.style.color = visible === 0 ? '#991b1b' : 'var(--theme-accent,#1f4e78)';
                } else {
