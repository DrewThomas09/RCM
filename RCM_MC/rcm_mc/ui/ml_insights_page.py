...
def render_ml_insights(hcris_df: pd.DataFrame, ccn: Optional[str] = None) -> str:
    ...
    methodology = (
        ...
        f'against P75 peers with 60.0% gap closure assumption and confidence weighting.</p>'
        f'</div>'
        f'<div>'
        f'<h3 style="font-size:12px;color:var(--cad-accent);margin-bottom:4px;">Conformal Prediction</h3>'
        f'<p style="color:var(--cad-text2);">Distribution-free 90.0% prediction intervals via split conformal '
    ...
    nav = (
        ...
        f'style="text-decoration:none;">Run Regression</a>'
