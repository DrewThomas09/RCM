...
<div class="ck-page-wrap">
  <div class="ck-page-head">
    <h1 class="ck-page-h1">Insurance &amp; Malpractice Tracker</h1>
    <p class="ck-page-sub">Malpractice, D&amp;O, cyber, tail coverage, captive analysis — {r.corpus_deal_count:,} corpus deals</p>
  </div>
  {form}
