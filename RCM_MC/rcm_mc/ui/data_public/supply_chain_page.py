...
def _spend_table(cats) -> str:
    ...
    for i, c in enumerate(cats):
        ...
        cells = [
            ...
            f'<td style="text-align:right;padding:5px 10px;font-variant-numeric:tabular-nums;font-family:JetBrains Mono,monospace;font-size:11px;color:{text_dim}">{c.top_vendor_share * 100:.1f}%</td>',
        ]
