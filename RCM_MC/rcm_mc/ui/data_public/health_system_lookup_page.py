...
def _npi_bridge_panel() -> str:
    ...
    return (table + '<div class="hsl-legend">'
            ...
            '<br><br>A PTAN proves the CCN was enumerated under that NPI. It '
            'does not prove the enumeration is current, and after a change of '
            'ownership the two come apart: CCN 440065 carries its PTAN on '
            'Northcrest Medical Center, last certified 2019, while the d/b/a '
            'matching today&rsquo;s cost-report name sits on Springfield '
            'Health Services (HCA), certified 2025 — the NPI a claim would '
            'actually be billed under. This file keeps the PTAN row, because '
            '&ldquo;which NPI holds this CCN&rdquo; is the question it '
            'answers. Read a PTAN row whose d/b/a disagrees with the cost '
            'report as a change-of-ownership flag, not a stale link. '
            f'<br><br>{summary["conflicting_ccns"]:,} CCNs remain contested and '
