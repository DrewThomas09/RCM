...
_BAND_COLORS = {
    "safe":        PALETTE.get("positive", "var(--theme-positive,#10b981)"),
    "watch":       PALETTE.get("warning", "var(--theme-warning,#f59e0b)"),
    "distressed":  PALETTE.get("negative", "var(--theme-negative,#ef4444)"),
    "critical":    "#7C1D1D",
}
...
def render_distress(
    ...
    table_html = (
        ...
        'title="Composite distress score 0–100 (Altman 35.0%, MERC 30.0%, DCOH 20.0%, AR 15.0%)">Score</th>'
        '<th style="padding:8px;text-align:right;font-size:10px;letter-spacing:0.08em;'
        'text-transform:uppercase;color:#666;" '
    ...
    methodology = (
        ...
        '<p><b>Composite score</b> weights Altman 35.0%, MERC 30.0%, DCOH 20.0%, AR 15.0%. Missing '
