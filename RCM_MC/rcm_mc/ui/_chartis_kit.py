...
_SUB_NAV = {
    ...
    "research": [
        ...
        {"label": "National Data Catalog", "href": "/national-data"},
...
_NAV_DESC = {
    ...
    "/benchmark-reference": "Measure/code/cost benchmark reference",
...
# Margin / occupancy plausibility bands live in core.margins (one source of
# truth shared by UI, ml, finance, intelligence). Re-exported here so the
# many `from ._chartis_kit import margin_is_plausible` call sites keep working.
from ..core.margins import (  # noqa: E402,F401
    MARGIN_PLAUSIBLE_LO, MARGIN_PLAUSIBLE_HI, MARGIN_SUSPECT_HI,
    OCCUPANCY_PLAUSIBLE_HI, margin_is_suspect_high, margin_is_plausible,
    margin_flag, margin_is_plausible_series, occupancy_is_plausible,
)
...
_DEFAULT_PALETTE_MODULES = [
    ...
    {"id": "hc-verticals-ref", "title": "Healthcare Verticals Reference", "route": "/healthcare-verticals-reference"},
    ...
    {"id": "ift-diligence", "title": "Interfacility Transport · diligence question architecture (per-slide question tree, evidence plan & visuals, cross-linked to the answers + connector estate)", "route": "/ift-diligence"},
    {"id": "ift-indepth",   "title": "Interfacility Transport · IN DEPTH — the answered question architecture (all 10 study questions, every subquestion answered or honestly skipped, conclusion-led, 10 framework visuals)", "route": "/ift-indepth"},
    ...
    {"id": "tx-infusion-workforce", "title": "Texas Infusion · employment-by-specialty heatmap + county demand heatmap (true geography)", "route": "/diligence/texas-infusion/workforce"},
    {"id": "tx-infusion-revenue", "title": "Texas Infusion · code-level revenue build (CPT units × rate) + competitor benchmark", "route": "/diligence/texas-infusion/revenue"},
    {"id": "tx-infusion-jcode-bench", "title": "J-code commercial benchmark 2022–2026 · commercial-%-of-Medicare multiples + biosimilar ASP erosion", "route": "/diligence/texas-infusion/jcode-benchmark"},
    ...
    {"id": "national-data", "title": "National Data Catalog · every major U.S. national health database (HCUP/NEDS, CMS, CDC/NHANES, MEPS, SAMHSA, USRDS, SEER) — access model + how to get it", "route": "/national-data"},
    ...
    {"id": "benchmark-reference", "title": "Benchmark Reference · quality-measure weights, CPT/DRG/Part-B frequency, physician comp, hospital cost structure, disease prevalence & NHE spending (CMS/MGMA/CDC/SEER, sourced)", "route": "/benchmark-reference"},
...
_SUB_SECTION_MAP = {
    ...
    "/healthcare-verticals-reference": "library",
    ...
    "/diligence/texas-infusion/workforce": "diligence",
    "/diligence/texas-infusion/revenue": "diligence",
    "/diligence/texas-infusion/jcode-benchmark": "diligence",
