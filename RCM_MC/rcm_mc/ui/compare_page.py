...
def _landing_compare() -> str:
    ...
    body = (
        ...
        f'<select name="left" required aria-label="Left" style="width:100%;padding:6px 8px;'
        ...
        f'<select name="right" required aria-label="Right" style="width:100%;padding:6px 8px;'
        f'background:{P["panel_alt"]};color:{P["text"]};'
        f'border:1px solid {P["border"]};font-family:inherit;">'
        f'<option value="">—</option>{options}</select></div>'
...
def _render_comparison(
    ...
    hero = (
        ...
        # decorative 3px accent stripe in favor of a hairline panel.
        f'<div style="background:{P["panel_alt"]};border:1px solid '
        f'{P["border"]};padding:10px 14px;margin-top:12px;font-size:12px;'
        ...
        f'<div style="background:{P["panel_alt"]};border:1px solid '
        f'{P["border"]};padding:10px 14px;margin-top:8px;font-size:12px;'
        f'color:{P["text_dim"]};line-height:1.6;max-width:880px;'
        f'border-radius:2px;">'
