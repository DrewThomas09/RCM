...
def _map_css_js() -> str:
    ...
    css = (
        ...
        'font-size:12.5px;color:var(--ink-2,#0b2341);}'
        ...
        'color:var(--sc-text-dim,#465366);text-align:center;}'
        ...
        'stroke:var(--sc-teal,#155752);stroke-width:2;}'
        ...
        'border-bottom:2px solid var(--sc-rule,#d6cfc0);}'
        ...
        'border-radius:2px;border:1px solid var(--sc-rule,#d6cfc0);'
        ...
        'background:var(--sc-bone,#ece5d6);overflow:hidden;}'
        ...
        'font-size:12px;background:var(--sc-bone,#ece5d6);'
