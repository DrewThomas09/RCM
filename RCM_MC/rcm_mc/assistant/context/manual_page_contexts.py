...
_CATEGORY_OVERRIDES: Dict[str, PageContextCategory] = {
    ...
    # ── 2026-05-31 batch 3: ~40 more unambiguous mappings. The 'activates
    # on YOUR uploaded X' pages are all PORTFOLIO_LP partner-data trackers;
    # illustrative-overlay calculator pages are DILIGENCE_WORKSPACE; corpus-
    # derived analytics are RESEARCH_BACKTESTING. ──
    #
    # PORTFOLIO_LP (partner-uploaded data trackers + fund/portfolio mgmt)
    "/ai-operating-model": PageContextCategory.PORTFOLIO_LP,
    "/board-governance": PageContextCategory.PORTFOLIO_LP,
    "/capex-budget": PageContextCategory.PORTFOLIO_LP,
    "/capital-call": PageContextCategory.PORTFOLIO_LP,
    "/capital-pacing": PageContextCategory.PORTFOLIO_LP,
    "/capital-schedule": PageContextCategory.PORTFOLIO_LP,
    "/clinical-ai": PageContextCategory.PORTFOLIO_LP,
    "/coinvest-pipeline": PageContextCategory.PORTFOLIO_LP,
    "/compliance-attestation": PageContextCategory.PORTFOLIO_LP,
    "/continuation-vehicle": PageContextCategory.PORTFOLIO_LP,
    "/cyber-risk": PageContextCategory.PORTFOLIO_LP,
    "/deadlines": PageContextCategory.PORTFOLIO_LP,
    "/debt-financing": PageContextCategory.PORTFOLIO_LP,
    "/digital-front-door": PageContextCategory.PORTFOLIO_LP,
    "/diligence-vendors": PageContextCategory.PORTFOLIO_LP,
    "/direct-employer": PageContextCategory.PORTFOLIO_LP,
    "/direct-lending": PageContextCategory.PORTFOLIO_LP,
    "/dividend-recap": PageContextCategory.PORTFOLIO_LP,
    "/dpi-tracker": PageContextCategory.PORTFOLIO_LP,
    "/earnout": PageContextCategory.PORTFOLIO_LP,
    "/escrow-earnout": PageContextCategory.PORTFOLIO_LP,
    "/esg-dashboard": PageContextCategory.PORTFOLIO_LP,
    "/esg-impact": PageContextCategory.PORTFOLIO_LP,
    "/exit-multiple": PageContextCategory.PORTFOLIO_LP,
    "/exit-readiness": PageContextCategory.PORTFOLIO_LP,
    "/exit-timing": PageContextCategory.PORTFOLIO_LP,
    "/fund-attribution": PageContextCategory.PORTFOLIO_LP,
    "/fundraising": PageContextCategory.PORTFOLIO_LP,
    "/hcit-platform": PageContextCategory.PORTFOLIO_LP,
    "/hold": PageContextCategory.PORTFOLIO_LP,
    "/hold-optimizer": PageContextCategory.PORTFOLIO_LP,
    "/hospital-anchor": PageContextCategory.PORTFOLIO_LP,
    "/insurance-tracker": PageContextCategory.PORTFOLIO_LP,
    "/key-person": PageContextCategory.PORTFOLIO_LP,
    "/litigation": PageContextCategory.PORTFOLIO_LP,
    "/lp-reporting": PageContextCategory.PORTFOLIO_LP,
    "/medical-realestate": PageContextCategory.PORTFOLIO_LP,
    "/mgmt-comp": PageContextCategory.PORTFOLIO_LP,
    "/mgmt-fee-tracker": PageContextCategory.PORTFOLIO_LP,
    "/nav-loan-tracker": PageContextCategory.PORTFOLIO_LP,
    "/operating-partners": PageContextCategory.PORTFOLIO_LP,
    "/owners": PageContextCategory.PORTFOLIO_LP,
    "/partner-economics": PageContextCategory.PORTFOLIO_LP,
    "/entry-multiple": PageContextCategory.PORTFOLIO_LP,
    # DILIGENCE_WORKSPACE (illustrative-overlay calculators + IC memo)
    "/benchmarks": PageContextCategory.DILIGENCE_WORKSPACE,
    "/biosimilars": PageContextCategory.DILIGENCE_WORKSPACE,
    "/bolton-analyzer": PageContextCategory.DILIGENCE_WORKSPACE,
    "/cap-structure": PageContextCategory.DILIGENCE_WORKSPACE,
    "/capital-efficiency": PageContextCategory.DILIGENCE_WORKSPACE,
    "/denovo-expansion": PageContextCategory.DILIGENCE_WORKSPACE,
    "/drug-pricing-340b": PageContextCategory.DILIGENCE_WORKSPACE,
    "/drug-shortage": PageContextCategory.DILIGENCE_WORKSPACE,
    "/fraud-detection": PageContextCategory.DILIGENCE_WORKSPACE,
    "/geo-market": PageContextCategory.DILIGENCE_WORKSPACE,
    "/gpo-supply": PageContextCategory.DILIGENCE_WORKSPACE,
    "/growth-runway": PageContextCategory.DILIGENCE_WORKSPACE,
    "/health-equity": PageContextCategory.DILIGENCE_WORKSPACE,
    "/ic-memo": PageContextCategory.DILIGENCE_WORKSPACE,
    "/ic-memo-gen": PageContextCategory.DILIGENCE_WORKSPACE,
    "/locum-tracker": PageContextCategory.DILIGENCE_WORKSPACE,
    "/ma-contracts": PageContextCategory.DILIGENCE_WORKSPACE,
    "/ma-star": PageContextCategory.DILIGENCE_WORKSPACE,
    "/medicaid-unwinding": PageContextCategory.DILIGENCE_WORKSPACE,
    "/msa-concentration": PageContextCategory.DILIGENCE_WORKSPACE,
    "/nsa-tracker": PageContextCategory.DILIGENCE_WORKSPACE,
    "/patient-experience": PageContextCategory.DILIGENCE_WORKSPACE,
    "/payer-concentration": PageContextCategory.DILIGENCE_WORKSPACE,
    "/payer-contracts": PageContextCategory.DILIGENCE_WORKSPACE,
    "/payer-shift": PageContextCategory.DILIGENCE_WORKSPACE,
    "/payer-stress": PageContextCategory.DILIGENCE_WORKSPACE,
    # RESEARCH_BACKTESTING (corpus-derived analytics)
    "/gp-benchmarking": PageContextCategory.RESEARCH_BACKTESTING,
    "/leverage-intel": PageContextCategory.RESEARCH_BACKTESTING,
    "/multiple-decomp": PageContextCategory.RESEARCH_BACKTESTING,
    "/payer-intel": PageContextCategory.RESEARCH_BACKTESTING,
    "/peer-transactions": PageContextCategory.RESEARCH_BACKTESTING,
    # LIBRARY_REFERENCE (reference catalogs / market intelligence)
    "/industry": PageContextCategory.LIBRARY_REFERENCE,
    "/market-data": PageContextCategory.LIBRARY_REFERENCE,
    "/market-intel/geo": PageContextCategory.LIBRARY_REFERENCE,
    "/payer-rate-trends": PageContextCategory.LIBRARY_REFERENCE,
    # ADMIN_SYSTEM
    "/exports": PageContextCategory.ADMIN_SYSTEM,
    # ── 2026-05-31 batch 4 (final): the remaining 59 UNKNOWN pages.
    # Partner-data trackers → PORTFOLIO_LP; illustrative-overlay
    # calculators → DILIGENCE_WORKSPACE; corpus-derived analytics →
    # RESEARCH_BACKTESTING; small library catalog adds.
    #
    # PORTFOLIO_LP (uploaded-data trackers + tax/treasury/value tracking)
    "/platform-maturity": PageContextCategory.PORTFOLIO_LP,
    "/pmi-integration": PageContextCategory.PORTFOLIO_LP,
    "/pmi-playbook": PageContextCategory.PORTFOLIO_LP,
    "/rcm-red-flags": PageContextCategory.PORTFOLIO_LP,
    "/real-estate": PageContextCategory.PORTFOLIO_LP,
    "/redflag-scanner": PageContextCategory.PORTFOLIO_LP,
    "/revenue-leakage": PageContextCategory.PORTFOLIO_LP,
    "/risk-matrix": PageContextCategory.PORTFOLIO_LP,
    "/rw-insurance": PageContextCategory.PORTFOLIO_LP,
    "/secondaries-tracker": PageContextCategory.PORTFOLIO_LP,
    "/sellside-process": PageContextCategory.PORTFOLIO_LP,
    "/tech-stack": PageContextCategory.PORTFOLIO_LP,
    "/transition-services": PageContextCategory.PORTFOLIO_LP,
    "/treasury": PageContextCategory.PORTFOLIO_LP,
    "/value-creation-plan": PageContextCategory.PORTFOLIO_LP,
    "/value-tracker": PageContextCategory.PORTFOLIO_LP,
    "/vcp-tracker": PageContextCategory.PORTFOLIO_LP,
    "/vdr-tracker": PageContextCategory.PORTFOLIO_LP,
    "/zbb-tracker": PageContextCategory.PORTFOLIO_LP,
    "/tax-credits": PageContextCategory.PORTFOLIO_LP,
    "/tax-structure": PageContextCategory.PORTFOLIO_LP,
    "/tax-structure-analyzer": PageContextCategory.PORTFOLIO_LP,
    "/tracker-340b": PageContextCategory.PORTFOLIO_LP,
    # DILIGENCE_WORKSPACE (illustrative-overlay calculators + models)
    "/phys-comp-plan": PageContextCategory.DILIGENCE_WORKSPACE,
    "/provider-network": PageContextCategory.DILIGENCE_WORKSPACE,
    "/provider-retention": PageContextCategory.DILIGENCE_WORKSPACE,
    "/qoe-analyzer": PageContextCategory.DILIGENCE_WORKSPACE,
    "/quality-scorecard": PageContextCategory.DILIGENCE_WORKSPACE,
    "/risk-adjustment": PageContextCategory.DILIGENCE_WORKSPACE,
    "/reit-analyzer": PageContextCategory.DILIGENCE_WORKSPACE,
    "/refi-optimizer": PageContextCategory.DILIGENCE_WORKSPACE,
    "/regulatory-risk": PageContextCategory.DILIGENCE_WORKSPACE,
    "/supply-chain": PageContextCategory.DILIGENCE_WORKSPACE,
    "/telehealth-econ": PageContextCategory.DILIGENCE_WORKSPACE,
    "/trial-site-econ": PageContextCategory.DILIGENCE_WORKSPACE,
    "/workforce-planning": PageContextCategory.DILIGENCE_WORKSPACE,
    "/workforce-retention": PageContextCategory.DILIGENCE_WORKSPACE,
    "/working-capital": PageContextCategory.DILIGENCE_WORKSPACE,
    "/unit-economics": PageContextCategory.DILIGENCE_WORKSPACE,
    "/physician-productivity": PageContextCategory.DILIGENCE_WORKSPACE,
    "/pressure": PageContextCategory.DILIGENCE_WORKSPACE,
    "/surrogate": PageContextCategory.DILIGENCE_WORKSPACE,
    "/underwriting-model": PageContextCategory.DILIGENCE_WORKSPACE,
    "/portfolio-sim": PageContextCategory.DILIGENCE_WORKSPACE,
    "/portfolio-optimizer": PageContextCategory.DILIGENCE_WORKSPACE,
    # RESEARCH_BACKTESTING (corpus-derived analytics)
    "/peer-valuation": PageContextCategory.RESEARCH_BACKTESTING,
    "/physician-labor": PageContextCategory.RESEARCH_BACKTESTING,
    "/reinvestment": PageContextCategory.RESEARCH_BACKTESTING,
    "/return-attribution": PageContextCategory.RESEARCH_BACKTESTING,
    "/rollup-economics": PageContextCategory.RESEARCH_BACKTESTING,
    "/sector-correlation": PageContextCategory.RESEARCH_BACKTESTING,
    "/sector-intel": PageContextCategory.RESEARCH_BACKTESTING,
    "/size-intel": PageContextCategory.RESEARCH_BACKTESTING,
    "/sponsor-heatmap": PageContextCategory.RESEARCH_BACKTESTING,
    "/sponsor-league": PageContextCategory.RESEARCH_BACKTESTING,
    "/vintage-cohorts": PageContextCategory.RESEARCH_BACKTESTING,
    "/vintage-perf": PageContextCategory.RESEARCH_BACKTESTING,
    # LIBRARY_REFERENCE (live public data + benchmark library)
    "/ref-pricing": PageContextCategory.LIBRARY_REFERENCE,
    "/specialty-benchmarks": PageContextCategory.LIBRARY_REFERENCE,
}
for _c in _MANUAL:
...
_METRIC_LINK_EXTEND_2: Dict[str, List[str]] = {
    ...
    # 2026-05-31: /medicaid-unwinding's primary topic — Medicaid
...
_MANUAL.extend([
    ...
    _ctx(
        ...
        common_questions=["What chart tools are there?",
                          ...
                          "Where do I compose a multi-chart slide?",
                          "Which tool should I use for a simple pie?"],
