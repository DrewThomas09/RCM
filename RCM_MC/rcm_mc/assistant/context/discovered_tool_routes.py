...
DISCOVERED_TOOL_ROUTES: List[ToolRouteDefinition] = [
    ...
    ToolRouteDefinition(
        ...
        source_group='Diligence Workspace',
        is_auto_generated=False,
        aliases=['cdd', 'commercial due diligence', 'commercial diligence',
                 'cdd workflow', 'cdd hub', 'market study'],
        source_file=_SOURCE_FILE,
    ),
    ToolRouteDefinition(
        title='Voice of Customer / Survey Evidence',
        route='/voc-survey',
        category=PageContextCategory.DILIGENCE_WORKSPACE,
        source_group='Diligence Workspace',
        is_auto_generated=False,
        aliases=['voc', 'voice of customer', 'survey', 'nps',
                 'customer survey', 'kpc', 'willingness to pay'],
        source_file=_SOURCE_FILE,
    ),
    ToolRouteDefinition(
        ...
        source_group='Diligence Workspace',
        is_auto_generated=False,
        aliases=['win loss', 'win/loss', 'win rate', 'loss reasons',
                 'competitive conversion', 'why do we lose'],
        source_file=_SOURCE_FILE,
    ),
    ToolRouteDefinition(
        ...
        source_group='Diligence Workspace',
        is_auto_generated=False,
        aliases=['pricing power', 'price elasticity', 'price increase',
                 'pricing analysis', 'optimal price', 'price move'],
        source_file=_SOURCE_FILE,
    ),
    ToolRouteDefinition(
        title='Healthcare Labor Market',
        route='/labor-market',
        category=PageContextCategory.RESEARCH_BACKTESTING,
        source_group='Research & Backtesting',
        is_auto_generated=False,
        aliases=['labor market', 'wage inflation', 'nursing wages',
                 'staffing', 'turnover', 'labor cost', 'wage growth'],
        source_file=_SOURCE_FILE,
    ),
    ToolRouteDefinition(
    ...
    ToolRouteDefinition(
        ...
        source_group='Research & Backtesting',
        is_auto_generated=False,
        aliases=['rate environment', 'medicare rates', 'payment updates',
                 'cms rates', 'reimbursement updates', 'rate update',
                 'ipps', 'opps', 'pfs update'],
        source_file=_SOURCE_FILE,
    ),
    ToolRouteDefinition(
        title='Excel Model Templates',
        route='/excel-templates',
        category=PageContextCategory.RESEARCH_BACKTESTING,
        source_group='Research & Backtesting',
        is_auto_generated=False,
        aliases=['excel templates', 'model templates', 'lbo template',
                 'qoe template', 'nwc peg template', '13 week cash',
                 'download model', 'workbook templates'],
        source_file=_SOURCE_FILE,
    ),
    ToolRouteDefinition(
        title='Ingestion',
