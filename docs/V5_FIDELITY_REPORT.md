...
- **42 above threshold** — chartis-grade
- **268 below threshold** — needs editorial cycle
...
| 75 | `rcm_mc/ui/data_public/data_sources_admin_page.py` | 247 | 10 (4.0/100) | high inline-style count: 41; high non-ck-class <div> count: 15 |
...
| 73 | `rcm_mc/ui/data_public/working_capital_page.py` | 297 | 24 (8.1/100) | high inline-style count: 51; high non-ck-class <div> count: 19 |
| 72 | `rcm_mc/ui/data_public/cost_structure_page.py` | 255 | 9 (3.5/100) | high inline-style count: 60; high non-ck-class <div> count: 18 |
| 71 | `rcm_mc/ui/data_public/capital_schedule_page.py` | 291 | 9 (3.1/100) | high inline-style count: 64; high non-ck-class <div> count: 19 |
| 71 | `rcm_mc/ui/data_public/fund_attribution_page.py` | 272 | 9 (3.3/100) | high inline-style count: 62; high non-ck-class <div> count: 16 |
| 71 | `rcm_mc/ui/data_public/zbb_tracker_page.py` | 172 | 33 (19.2/100) | high inline-style count: 58; high non-ck-class <div> count: 23 |
| 70 | `rcm_mc/ui/data_public/drug_shortage_page.py` | 174 | 28 (16.1/100) | high inline-style count: 62; high non-ck-class <div> count: 23 |
...
| Score | File | LOC | Primitives | Notes |
|---|---|---|---|---|
| 69 | `rcm_mc/ui/data_public/biosimilars_opp_page.py` | 160 | 9 (5.6/100) | high inline-style count: 77; high non-ck-class <div> count: 19 |
| 69 | `rcm_mc/ui/data_public/diligence_vendors_page.py` | 160 | 9 (5.6/100) | high inline-style count: 75; high non-ck-class <div> count: 19 |
| 69 | `rcm_mc/ui/data_public/direct_employer_page.py` | 163 | 9 (5.5/100) | high inline-style count: 76; high non-ck-class <div> count: 19 |
| 69 | `rcm_mc/ui/data_public/direct_lending_page.py` | 159 | 9 (5.7/100) | high inline-style count: 73; high non-ck-class <div> count: 19 |
| 69 | `rcm_mc/ui/data_public/dpi_tracker_page.py` | 205 | 39 (19.0/100) | high inline-style count: 68; high non-ck-class <div> count: 22 |
| 69 | `rcm_mc/ui/data_public/hcit_platform_page.py` | 164 | 9 (5.5/100) | high inline-style count: 73; high non-ck-class <div> count: 19 |
| 69 | `rcm_mc/ui/data_public/vcp_tracker_page.py` | 217 | 36 (16.6/100) | high inline-style count: 72; high non-ck-class <div> count: 22 |
| 68 | `rcm_mc/ui/data_public/capital_pacing_page.py` | 206 | 11 (5.3/100) | high inline-style count: 82; high non-ck-class <div> count: 18 |
...
| 58 | `rcm_mc/ui/data_public/module_index_page.py` | 130 | 9 (6.9/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 52; high non-ck-class <div> count: 16 |
...
| 56 | `rcm_mc/ui/data_public/health_equity_page.py` | 137 | 9 (6.6/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 62; high non-ck-class <div> count: 16 |
| 56 | `rcm_mc/ui/data_public/mgmt_comp_page.py` | 266 | 9 (3.4/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 65; high non-ck-class <div> count: 17 |
| 56 | `rcm_mc/ui/data_public/physician_productivity_page.py` | 281 | 9 (3.2/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 65; high non-ck-class <div> count: 19 |
...
| 54 | `rcm_mc/ui/data_public/peer_valuation_page.py` | 259 | 9 (3.5/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 76; high non-ck-class <div> count: 19 |
| 54 | `rcm_mc/ui/data_public/physician_labor_page.py` | 157 | 9 (5.7/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 73; high non-ck-class <div> count: 19 |
| 54 | `rcm_mc/ui/data_public/quality_scorecard_page.py` | 252 | 9 (3.6/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 75; high non-ck-class <div> count: 19 |
| 54 | `rcm_mc/ui/data_public/real_estate_page.py` | 268 | 9 (3.4/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 73; high non-ck-class <div> count: 17 |
| 54 | `rcm_mc/ui/data_public/ref_pricing_page.py` | 284 | 9 (3.2/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 74; high non-ck-class <div> count: 18 |
| 54 | `rcm_mc/ui/data_public/trial_site_econ_page.py` | 157 | 9 (5.7/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 75; high non-ck-class <div> count: 19 |
...
| 53 | `rcm_mc/ui/data_public/cap_structure_page.py` | 315 | 9 (2.9/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 71; high non-ck-class <div> count: 18 |
| 53 | `rcm_mc/ui/data_public/deal_pipeline_page.py` | 267 | 9 (3.4/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 75; high non-ck-class <div> count: 21 |
| 53 | `rcm_mc/ui/data_public/geo_market_page.py` | 288 | 9 (3.1/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 77; high non-ck-class <div> count: 21 |
| 53 | `rcm_mc/ui/data_public/lbo_stress_page.py` | 196 | 9 (4.6/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 76; high non-ck-class <div> count: 21 |
| 53 | `rcm_mc/ui/data_public/msa_concentration_page.py` | 163 | 9 (5.5/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 78; high non-ck-class <div> count: 19 |
| 53 | `rcm_mc/ui/data_public/nsa_tracker_page.py` | 180 | 9 (5.0/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 83; high non-ck-class <div> count: 19 |
...
| 53 | `rcm_mc/ui/data_public/redflag_scanner_page.py` | 189 | 9 (4.8/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 78; high non-ck-class <div> count: 19 |
| 53 | `rcm_mc/ui/data_public/regulatory_risk_page.py` | 271 | 9 (3.3/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 80; high non-ck-class <div> count: 19 |
...
| 52 | `rcm_mc/ui/data_public/competitive_intel_page.py` | 284 | 9 (3.2/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 78; high non-ck-class <div> count: 20 |
| 52 | `rcm_mc/ui/data_public/denovo_expansion_page.py` | 187 | 9 (4.8/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 81; high non-ck-class <div> count: 21 |
| 52 | `rcm_mc/ui/data_public/platform_maturity_page.py` | 159 | 9 (5.7/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 79; high non-ck-class <div> count: 23 |
| 52 | `rcm_mc/ui/data_public/reinvestment_page.py` | 226 | 9 (4.0/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 83; high non-ck-class <div> count: 21 |
| 52 | `rcm_mc/ui/data_public/transition_services_page.py` | 284 | 9 (3.2/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 78; high non-ck-class <div> count: 21 |
| 52 | `rcm_mc/ui/data_public/unit_economics_page.py` | 306 | 9 (2.9/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 74; high non-ck-class <div> count: 22 |
| 52 | `rcm_mc/ui/data_public/value_creation_plan_page.py` | 294 | 9 (3.1/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 79; high non-ck-class <div> count: 21 |
| 51 | `rcm_mc/ui/chartis/home_page.py` | 654 | 9 (1.4/100) | high inline-style count: 74; high non-ck-class <div> count: 44 |
| 51 | `rcm_mc/ui/data_public/aco_economics_page.py` | 205 | 9 (4.4/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 94; high non-ck-class <div> count: 24 |
| 51 | `rcm_mc/ui/data_public/ai_operating_model_page.py` | 175 | 9 (5.1/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 86; high non-ck-class <div> count: 23 |
| 51 | `rcm_mc/ui/data_public/base_rates_page.py` | 262 | 9 (3.4/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 85; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/board_governance_page.py` | 188 | 9 (4.8/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 87; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/capex_budget_page.py` | 205 | 9 (4.4/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 99; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/capital_call_tracker_page.py` | 211 | 9 (4.3/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 101; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/cin_analyzer_page.py` | 208 | 9 (4.3/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 98; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/clinical_ai_tracker_page.py` | 209 | 9 (4.3/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 93; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/clinical_outcomes_page.py` | 285 | 9 (3.2/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 91; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/cms_apm_tracker_page.py` | 197 | 9 (4.6/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 91; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/cms_data_browser_page.py` | 191 | 9 (4.7/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 89; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/coinvest_pipeline_page.py` | 208 | 9 (4.3/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 101; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/compliance_attestation_page.py` | 230 | 9 (3.9/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 99; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/covenant_headroom_page.py` | 199 | 9 (4.5/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 85; high non-ck-class <div> count: 21 |
| 51 | `rcm_mc/ui/data_public/deal_origination_page.py` | 188 | 9 (4.8/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 84; high non-ck-class <div> count: 21 |
...
| 51 | `rcm_mc/ui/data_public/deal_sourcing_page.py` | 199 | 9 (4.5/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 94; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/debt_financing_page.py` | 212 | 9 (4.2/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 100; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/demand_forecast_page.py` | 216 | 9 (4.2/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 87; high non-ck-class <div> count: 24 |
| 51 | `rcm_mc/ui/data_public/digital_front_door_page.py` | 187 | 9 (4.8/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 90; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/drug_pricing_340b_page.py` | 230 | 9 (3.9/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 103; high non-ck-class <div> count: 24 |
| 51 | `rcm_mc/ui/data_public/escrow_earnout_page.py` | 222 | 9 (4.1/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 103; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/esg_dashboard_page.py` | 291 | 9 (3.1/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 81; high non-ck-class <div> count: 26 |
| 51 | `rcm_mc/ui/data_public/exit_readiness_page.py` | 315 | 9 (2.9/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 77; high non-ck-class <div> count: 21 |
| 51 | `rcm_mc/ui/data_public/fundraising_tracker_page.py` | 207 | 9 (4.3/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 96; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/gpo_supply_tracker_page.py` | 210 | 9 (4.3/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 96; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/hospital_anchor_page.py` | 206 | 9 (4.4/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 98; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/insurance_tracker_page.py` | 193 | 9 (4.7/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 90; high non-ck-class <div> count: 21 |
| 51 | `rcm_mc/ui/data_public/litigation_tracker_page.py` | 202 | 9 (4.5/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 99; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/locum_tracker_page.py` | 217 | 9 (4.1/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 94; high non-ck-class <div> count: 21 |
| 51 | `rcm_mc/ui/data_public/lp_reporting_page.py` | 195 | 9 (4.6/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 93; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/ma_contracts_page.py` | 242 | 10 (4.1/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 102; high non-ck-class <div> count: 24 |
| 51 | `rcm_mc/ui/data_public/ma_star_tracker_page.py` | 209 | 9 (4.3/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 95; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/medicaid_unwinding_page.py` | 204 | 9 (4.4/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 97; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/medical_realestate_page.py` | 198 | 9 (4.5/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 94; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/nav_loan_tracker_page.py` | 192 | 9 (4.7/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 95; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/operating_partners_page.py` | 210 | 9 (4.3/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 100; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/partner_economics_page.py` | 225 | 9 (4.0/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 106; high non-ck-class <div> count: 24 |
| 51 | `rcm_mc/ui/data_public/patient_experience_page.py` | 224 | 9 (4.0/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 89; high non-ck-class <div> count: 24 |
| 51 | `rcm_mc/ui/data_public/payer_concentration_page.py` | 213 | 9 (4.2/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 86; high non-ck-class <div> count: 21 |
| 51 | `rcm_mc/ui/data_public/payer_contracts_page.py` | 209 | 9 (4.3/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 98; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/peer_transactions_page.py` | 199 | 9 (4.5/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 96; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/phys_comp_plan_page.py` | 217 | 9 (4.1/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 92; high non-ck-class <div> count: 21 |
| 51 | `rcm_mc/ui/data_public/pmi_integration_page.py` | 213 | 9 (4.2/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 99; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/pmi_playbook_page.py` | 176 | 10 (5.7/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 84; high non-ck-class <div> count: 23 |
| 51 | `rcm_mc/ui/data_public/provider_retention_page.py` | 234 | 9 (3.8/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 98; high non-ck-class <div> count: 24 |
| 51 | `rcm_mc/ui/data_public/reit_analyzer_page.py` | 212 | 9 (4.2/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 90; high non-ck-class <div> count: 21 |
| 51 | `rcm_mc/ui/data_public/revenue_leakage_page.py` | 301 | 9 (3.0/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 79; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/risk_adjustment_page.py` | 202 | 9 (4.5/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 95; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/rw_insurance_page.py` | 203 | 9 (4.4/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 99; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/scenario_mc_page.py` | 320 | 9 (2.8/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 76; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/secondaries_tracker_page.py` | 179 | 9 (5.0/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 84; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/sellside_process_page.py` | 215 | 9 (4.2/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 102; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/specialty_benchmarks_page.py` | 186 | 9 (4.8/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 93; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/sponsor_heatmap_page.py` | 245 | 9 (3.7/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 91; high non-ck-class <div> count: 21 |
| 51 | `rcm_mc/ui/data_public/supply_chain_page.py` | 229 | 9 (3.9/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 96; high non-ck-class <div> count: 24 |
| 51 | `rcm_mc/ui/data_public/tax_credits_page.py` | 202 | 9 (4.5/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 98; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/telehealth_econ_page.py` | 170 | 9 (5.3/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 85; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/tracker_340b_page.py` | 196 | 9 (4.6/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 94; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/treasury_tracker_page.py` | 201 | 9 (4.5/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 96; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/vdr_tracker_page.py` | 224 | 9 (4.0/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 93; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/vintage_cohorts_page.py` | 213 | 9 (4.2/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 99; high non-ck-class <div> count: 22 |
| 51 | `rcm_mc/ui/data_public/workforce_planning_page.py` | 298 | 9 (3.0/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 85; high non-ck-class <div> count: 21 |
| 51 | `rcm_mc/ui/data_public/workforce_retention_page.py` | 194 | 9 (4.6/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 92; high non-ck-class <div> count: 22 |
...
| 50 | `rcm_mc/ui/data_public/dividend_recap_page.py` | 319 | 9 (2.8/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 83; high non-ck-class <div> count: 21 |
| 50 | `rcm_mc/ui/data_public/earnout_page.py` | 309 | 9 (2.9/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 85; high non-ck-class <div> count: 24 |
...
| 50 | `rcm_mc/ui/data_public/key_person_page.py` | 307 | 9 (2.9/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 86; high non-ck-class <div> count: 21 |
...
| 50 | `rcm_mc/ui/data_public/tech_stack_page.py` | 302 | 9 (3.0/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 84; high non-ck-class <div> count: 21 |
| 49 | `rcm_mc/ui/data_public/bolton_analyzer_page.py` | 363 | 9 (2.5/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 75; high non-ck-class <div> count: 18 |
| 49 | `rcm_mc/ui/data_public/concentration_risk_page.py` | 130 | 2 (1.5/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 28; high non-ck-class <div> count: 16 |
| 49 | `rcm_mc/ui/data_public/continuation_vehicle_page.py` | 323 | 9 (2.8/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 90; high non-ck-class <div> count: 24 |
...
| 49 | `rcm_mc/ui/data_public/payer_shift_page.py` | 343 | 9 (2.6/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 76; high non-ck-class <div> count: 23 |
| 48 | `rcm_mc/ui/data_public/growth_runway_page.py` | 349 | 9 (2.6/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 82; high non-ck-class <div> count: 24 |
| 48 | `rcm_mc/ui/data_public/sector_momentum_page.py` | 168 | 2 (1.2/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 30 |
...
| 47 | `rcm_mc/ui/data_public/debt_service_page.py` | 353 | 9 (2.5/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 97; high non-ck-class <div> count: 24 |
...
| 46 | `rcm_mc/ui/data_public/payer_rate_trends_page.py` | 230 | 2 (0.9/100) | low ck_* primitive density (0.9/100LOC); no italic-serif highlight (chartis cadence missing); high inline-style count: 23; high non-ck-class <div> count: 14 |
| 46 | `rcm_mc/ui/data_public/return_attribution_page.py` | 179 | 2 (1.1/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 34; high non-ck-class <div> count: 11 |
...
| 45 | `rcm_mc/ui/data_public/entry_multiple_page.py` | 197 | 2 (1.0/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 30; high non-ck-class <div> count: 15 |
| 45 | `rcm_mc/ui/data_public/irr_dispersion_page.py` | 194 | 2 (1.0/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 30; high non-ck-class <div> count: 15 |
...
| 43 | `rcm_mc/ui/data_public/gp_benchmarking_page.py` | 190 | 2 (1.1/100) | no italic-serif highlight (chartis cadence missing); high inline-style count: 42; high non-ck-class <div> count: 16 |
...
| 42 | `rcm_mc/ui/data_public/corpus_coverage_page.py` | 210 | 2 (1.0/100) | low ck_* primitive density (1.0/100LOC); no italic-serif highlight (chartis cadence missing); high inline-style count: 43; high non-ck-class <div> count: 16 |
...
| 41 | `rcm_mc/ui/data_public/hold_analysis_page.py` | 233 | 2 (0.9/100) | low ck_* primitive density (0.9/100LOC); no italic-serif highlight (chartis cadence missing); high inline-style count: 47; high non-ck-class <div> count: 16 |
...
| 38 | `rcm_mc/ui/data_public/find_comps_page.py` | 314 | 2 (0.6/100) | low ck_* primitive density (0.6/100LOC); no italic-serif highlight (chartis cadence missing); high inline-style count: 60; high non-ck-class <div> count: 13 |
...
| 37 | `rcm_mc/ui/data_public/rcm_red_flags_page.py` | 312 | 2 (0.6/100) | low ck_* primitive density (0.6/100LOC); no italic-serif highlight (chartis cadence missing); high inline-style count: 58; high non-ck-class <div> count: 19 |
...
| 36 | `rcm_mc/ui/data_public/ic_memo_page.py` | 350 | 3 (0.9/100) | low ck_* primitive density (0.9/100LOC); no italic-serif highlight (chartis cadence missing); high inline-style count: 68; high non-ck-class <div> count: 24 |
